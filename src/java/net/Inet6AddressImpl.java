...
class Inet6AddressImpl implements java.net.InetAddressImpl {
    ...
    public native java.net.InetAddress[] lookupAllHostAddr(String hostname)
    ...
    public boolean isReachable(java.net.InetAddress addr, int timeout,
    ...
    public synchronized java.net.InetAddress anyLocalAddress() {
        if (anyLocalAddress == null) {
            if (java.net.InetAddress.preferIPv6Address == PREFER_IPV6_VALUE ||
                java.net.InetAddress.preferIPv6Address == PREFER_SYSTEM_VALUE) {
