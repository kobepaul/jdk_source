...
public class URLClassLoader extends SecureClassLoader implements Closeable {
    ...
    URLClassLoader(String name, java.net.URL[] urls, ClassLoader parent,
     ...
     * @spec JPMS
     */
    public URLClassLoader(String name, java.net.URL[] urls, ClassLoader parent,
                          URLStreamHandlerFactory factory) {
        super(name, parent);
        // this is to make the stack depth consistent with 1.1
        SecurityManager security = System.getSecurityManager();
...
final class FactoryURLClassLoader extends URLClassLoader {
    ...
    FactoryURLClassLoader(String name, java.net.URL[] urls, ClassLoader parent,
                          AccessControlContext acc) {
