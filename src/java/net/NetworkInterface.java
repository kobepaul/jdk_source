...
public final class NetworkInterface {
     ...
     * @since 9
     */
    public Stream<java.net.InetAddress> inetAddresses() {
        return streamFromArray(getCheckedInetAddresses());
    }

    private java.net.InetAddress[] getCheckedInetAddresses() {
        java.net.InetAddress[] local_addrs = new java.net.InetAddress[addrs.length];
    ...
    public static Enumeration<NetworkInterface> getNetworkInterfaces()
        ...
        if (netifs != null && netifs.length > 0) {
            ...
            throw new java.net.SocketException("No network interfaces configured");
        }
    }
    ...
    private static native NetworkInterface getByInetAddress0(java.net.InetAddress addr)
        throws java.net.SocketException;
    ...
    private static native boolean isUp0(String name, int ind) throws java.net.SocketException;
    private static native boolean isLoopback0(String name, int ind) throws java.net.SocketException;
    private static native boolean supportsMulticast0(String name, int ind) throws java.net.SocketException;
    private static native boolean isP2P0(String name, int ind) throws java.net.SocketException;
    private static native byte[] getMacAddr0(byte[] inAddr, String name, int ind) throws java.net.SocketException;
