...
class DatagramSocket implements java.io.Closeable {
    ...
    public synchronized void setSoTimeout(int timeout) throws SocketException {
        if (isClosed())
            throw new SocketException("Socket is closed");
        getImpl().setOption(java.net.SocketOptions.SO_TIMEOUT, timeout);
    }
    ...
    throws SocketException{
        ...
        if (isClosed())
            throw new SocketException("Socket is closed");
        getImpl().setOption(java.net.SocketOptions.SO_SNDBUF, size);
    }
    ...
    throws SocketException{
        ...
        if (isClosed())
            throw new SocketException("Socket is closed");
        getImpl().setOption(java.net.SocketOptions.SO_RCVBUF, size);
    }
    ...
    public synchronized void setReuseAddress(boolean on) throws SocketException {
        ...
        if (oldImpl)
            getImpl().setOption(java.net.SocketOptions.SO_REUSEADDR, on?-1:0);
        else
     ...
     * @since 9
     */
    public <T> DatagramSocket setOption(java.net.SocketOption<T> name, T value)
        throws IOException
    {
    ...
    private static Set<java.net.SocketOption<?>> options;
