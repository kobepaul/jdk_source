...
class ServerSocket implements java.io.Closeable {
    ...
    public Set<SocketOption<?>> supportedOptions() {
        synchronized (ServerSocket.class) {
            ...
            try {
                java.net.SocketImpl impl = getImpl();
    ...
    static {
        SharedSecrets.setJavaNetSocketAccess(
            new JavaNetSocketAccess() {
                @Override
                public ServerSocket newServerSocket(java.net.SocketImpl impl) {
                    return new ServerSocket(impl);
                }

                @Override
                public java.net.SocketImpl newSocketImpl(Class<? extends java.net.SocketImpl> implClass) {
                    try {
