 ...
 *     {@link java.net.URL#openConnection() openConnection} method on a URL.
...
public abstract class URLConnection {
    ...
    */
    ...
    public static java.net.FileNameMap getFileNameMap() {
        java.net.FileNameMap map = fileNameMap;

        if (map == null) {
            fileNameMap = map = new java.net.FileNameMap() {
                private java.net.FileNameMap internalMap =
