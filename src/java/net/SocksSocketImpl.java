...
class SocksSocketImpl extends PlainSocketImpl implements java.net.SocksConsts {
    ...
    private static boolean useV4(java.net.Proxy proxy) {
                    ...
                    AccessController.doPrivileged(
                        new PrivilegedExceptionAction<>() {
                            public Void run() throws Exception {
                                cmdsock = new java.net.Socket(new PlainSocketImpl());
