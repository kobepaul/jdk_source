...
public abstract class ProxySelector {
     ...
     */
    public abstract List<java.net.Proxy> select(java.net.URI uri);
     ...
     */
    public abstract void connectFailed(java.net.URI uri, SocketAddress sa, IOException ioe);
    ...
    static class StaticProxySelector extends ProxySelector {
        private static final List<java.net.Proxy> NO_PROXY_LIST = List.of(java.net.Proxy.NO_PROXY);
        ...
        @Override
        public void connectFailed(java.net.URI uri, SocketAddress sa, IOException e) {
            /* ignore */
        }
