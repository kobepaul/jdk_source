...
public abstract class DatagramSocketImpl implements java.net.SocketOptions {
    ...
    protected <T> void setOption(java.net.SocketOption<T> name, T value) throws IOException {
        if (name == StandardSocketOptions.SO_SNDBUF) {
            ...
            setOption(java.net.SocketOptions.SO_REUSEPORT, value);
    ...
    protected <T> T getOption(java.net.SocketOption<T> name) throws IOException {
        if (name == StandardSocketOptions.SO_SNDBUF) {
            ...
            supportedOptions().contains(name)) {
            return (T) getOption(java.net.SocketOptions.SO_REUSEPORT);
        } else if (name == StandardSocketOptions.IP_TOS) {
    ...
    private static final Set<java.net.SocketOption<?>> dgSocketOptions;

    private static final Set<java.net.SocketOption<?>> mcSocketOptions;
