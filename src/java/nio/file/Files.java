...
public final class Files {
        ...
        throws IOException
    {
        ...
        DirectoryStream.Filter<java.nio.file.Path> filter = new DirectoryStream.Filter<>() {
            @Override
     ...
     * @since 1.8
     */
    public static BufferedWriter newBufferedWriter(java.nio.file.Path path, OpenOption... options)
        throws IOException
    {
     ...
     * @since 11
     */
    public static String readString(java.nio.file.Path path) throws IOException {
     ...
     * @since 11
     */
    public static String readString(java.nio.file.Path path, Charset cs) throws IOException {
     ...
     * @since 11
     */
    public static java.nio.file.Path writeString(java.nio.file.Path path, CharSequence csq, OpenOption... options)
            throws IOException
    {
     ...
     * @since 11
     */
    public static java.nio.file.Path writeString(java.nio.file.Path path, CharSequence csq, Charset cs, OpenOption... options)
            throws IOException
    {
    ...
    public static Stream<java.nio.file.Path> list(java.nio.file.Path dir) throws IOException {
        ...
        try {
            ...
            Iterator<java.nio.file.Path> iterator = new Iterator<>() {
                @Override
            ...
            Spliterator<java.nio.file.Path> spliterator =
