...
public final class Paths {
     ...
     *
     * @implSpec
     * This method simply invokes {@link java.nio.file.Path#of(String,String...)
     ...
     * @see java.nio.file.Path#of(String,String...)
     */
    public static java.nio.file.Path get(String first, String... more) {
        return java.nio.file.Path.of(first, more);
    }
     ...
     *
     * @implSpec
     * This method simply invokes {@link java.nio.file.Path#of(URI) * Path.of(URI)} with the given parameter.
     *
     * @param   uri
     *          the URI to convert
     *
     ...
     *
     * @see java.nio.file.Path#of(URI)
     */
    public static java.nio.file.Path get(URI uri) {
        return Path.of(uri);
    }
}
