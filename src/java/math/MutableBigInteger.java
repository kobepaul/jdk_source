...
class MutableBigInteger {
    ...
    MutableBigInteger sqrt() {
        ...
        if (bitLength() <= 63) {
            ...
            long v = new java.math.BigInteger(this.value, 1).longValueExact();
            ...
            double d = new java.math.BigInteger(xk.value, 1).doubleValue();
            java.math.BigInteger bi = BigInteger.valueOf((long)Math.ceil(Math.sqrt(d)));
