...
public class AlgorithmParameterGenerator {
     ...
     * {@link java.security.Security#getProperty(String) Security} property to determine
     ...
     *
     * @throws java.security.NoSuchAlgorithmException if no {@code Provider} supports an
     ...
     *         or empty
     *
     * @throws java.security.NoSuchAlgorithmException if an
