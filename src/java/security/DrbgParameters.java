 ...
 * {@link java.security.SecureRandom#getInstance}, which we will call a
 ...
 * {@link java.security.SecureRandom#reseed()} is equivalent to calling
 * {@link java.security.SecureRandom#reseed(SecureRandomParameters)} with the effective
 * instantiated prediction resistance flag (as returned by
 * {@link java.security.SecureRandom#getParameters()}) with no additional input.
 * <p>
 ...
 * {@link java.security.SecureRandom#nextBytes(byte[])} is equivalent to calling
 ...
 * (as returned by {@link java.security.SecureRandom#getParameters()}) with no
 * additional input.
 * <p>
 ...
 * parameters. Its {@link java.security.SecureRandom#getParameters()} must always return a
 ...
 * the result of {@link java.security.SecureRandom#getParameters()} has its
 ...
 * is called. If implemented this way, its {@link java.security.SecureRandom#getParameters()}
 ...
 * <p>
 * Calling {@link java.security.SecureRandom#generateSeed(int)} will directly read
...
public class DrbgParameters {
     ...
     * {@link java.security.SecureRandom#getParameters()} method, it means the effective
