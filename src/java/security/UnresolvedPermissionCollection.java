...
implements java.io.Serializable
{
     ...
     */
    private transient ConcurrentHashMap<String, List<java.security.UnresolvedPermission>> perms;
    ...
    public void add(java.security.Permission permission) {
        ...
        perms.compute(up.getName(),
            new java.util.function.BiFunction<>() {
                @Override
                public List<java.security.UnresolvedPermission> apply(String key,
                                                                      List<java.security.UnresolvedPermission> oldValue) {
                    if (oldValue == null) {
    ...
    private void writeObject(ObjectOutputStream out) throws IOException {
        ...
        for (Map.Entry<String, List<java.security.UnresolvedPermission>> e : set) {
            ...
            Vector<java.security.UnresolvedPermission> vec = new Vector<>(list);
