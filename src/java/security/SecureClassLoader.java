...
public class SecureClassLoader extends ClassLoader {
     ...
     * permissions.
     */
    private final Map<CodeSourceKey, java.security.ProtectionDomain> pdcache
    ...
    private java.security.ProtectionDomain getProtectionDomain(java.security.CodeSource cs) {
        ...
        return pdcache.computeIfAbsent(key, new Function<>() {
            @Override
            public java.security.ProtectionDomain apply(CodeSourceKey key /* not used */) {
                PermissionCollection perms
                        = SecureClassLoader.this.getPermissions(cs);
                java.security.ProtectionDomain pd = new ProtectionDomain(
