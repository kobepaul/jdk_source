...
public class FieldPosition {
     ...
     * @since 1.4
     */
    public FieldPosition(java.text.Format.Field attribute, int fieldID) {
     ...
     */
    private boolean matchesField(java.text.Format.Field attribute) {
     ...
     */
    private boolean matchesField(java.text.Format.Field attribute, int field) {
        if (this.attribute != null) {
            return this.attribute.equals(attribute);
        }
     ...
     * the FieldPosition.
     */
    private class Delegate implements java.text.Format.FieldDelegate {
        /**
