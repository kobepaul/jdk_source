 ...
 *     java.text.DateFormat#getCalendar() getCalendar()}.{@link
...
public class SimpleDateFormat extends java.text.DateFormat {
     ...
     */
    private static final ConcurrentMap<Locale, java.text.NumberFormat> cachedNumberFormatData
    ...
    public SimpleDateFormat(String pattern, Locale locale)
    {
        ...
        this.formatData = getInstanceRef(locale);
        this.locale = locale;
        initialize(locale);
    }
    ...
    private void initialize(Locale loc) {
        ...
        if (numberFormat == null) { /* cache miss */
            numberFormat = java.text.NumberFormat.getIntegerInstance(loc);
     ...
     * is {@link java.text.DateFormat#YEAR_FIELD}, the begin index and end index of
     ...
     * {@link java.text.DateFormat#TIMEZONE_FIELD}, the begin index and end index of
    ...
    private void zeroPaddingNumber(int value, int minDigits, int maxDigits, StringBuffer buffer)
    {
        ...
        try {
            if (zeroDigit == 0) {
                zeroDigit = ((java.text.DecimalFormat)numberFormat).getDecimalFormatSymbols().getZeroDigit();
            }
            if (value >= 0) {
    ...
    private int subParse(String text, int start, int patternCharIndex, int count,
                         ...
                         java.text.ParsePosition origPos,
    ...
    private void checkNegativeNumberExpression() {
        if ((numberFormat instanceof java.text.DecimalFormat) &&
            ...
            String numberPattern = ((java.text.DecimalFormat)numberFormat).toPattern();
