 ...
 *       <th scope="row" style="text-weight: normal"><i>(none)</i>
 *       <td>{@link java.text.NumberFormat#getInstance(Locale) NumberFormat.getInstance}{@code (getLocale())}
 *    <tr>
 *       <th scope="row" style="text-weight: normal">{@code integer}
 *       <td>{@link java.text.NumberFormat#getIntegerInstance(Locale) NumberFormat.getIntegerInstance}{@code (getLocale())}
 *    <tr>
 *       <th scope="row" style="text-weight: normal">{@code currency}
 *       <td>{@link java.text.NumberFormat#getCurrencyInstance(Locale) NumberFormat.getCurrencyInstance}{@code (getLocale())}
 *    <tr>
 *       <th scope="row" style="text-weight: normal">{@code percent}
 *       <td>{@link java.text.NumberFormat#getPercentInstance(Locale) NumberFormat.getPercentInstance}{@code (getLocale())}
 *    <tr>
 ...
 *       <th scope="row" style="text-weight: normal"><i>(none)</i>
 *       <td>{@link java.text.DateFormat#getDateInstance(int,Locale) DateFormat.getDateInstance}{@code (}{@link java.text.DateFormat#DEFAULT}{@code , getLocale())}
 *    <tr>
 *       <th scope="row" style="text-weight: normal">{@code short}
 *       <td>{@link java.text.DateFormat#getDateInstance(int,Locale) DateFormat.getDateInstance}{@code (}{@link java.text.DateFormat#SHORT}{@code , getLocale())}
 *    <tr>
 *       <th scope="row" style="text-weight: normal">{@code medium}
 *       <td>{@link java.text.DateFormat#getDateInstance(int,Locale) DateFormat.getDateInstance}{@code (}{@link java.text.DateFormat#DEFAULT}{@code , getLocale())}
 *    <tr>
 *       <th scope="row" style="text-weight: normal">{@code long}
 *       <td>{@link java.text.DateFormat#getDateInstance(int,Locale) DateFormat.getDateInstance}{@code (}{@link java.text.DateFormat#LONG}{@code , getLocale())}
 *    <tr>
 *       <th scope="row" style="text-weight: normal">{@code full}
 *       <td>{@link java.text.DateFormat#getDateInstance(int,Locale) DateFormat.getDateInstance}{@code (}{@link java.text.DateFormat#FULL}{@code , getLocale())}
 *    <tr>
 *       <th scope="row" style="text-weight: normal"><i>SubformatPattern</i>
 ...
 *       <th scope="row" style="text-weight: normal"><i>(none)</i>
 *       <td>{@link java.text.DateFormat#getTimeInstance(int,Locale) DateFormat.getTimeInstance}{@code (}{@link java.text.DateFormat#DEFAULT}{@code , getLocale())}
 *    <tr>
 *       <th scope="row" style="text-weight: normal">{@code short}
 *       <td>{@link java.text.DateFormat#getTimeInstance(int,Locale) DateFormat.getTimeInstance}{@code (}{@link java.text.DateFormat#SHORT}{@code , getLocale())}
 *    <tr>
 *       <th scope="row" style="text-weight: normal">{@code medium}
 *       <td>{@link java.text.DateFormat#getTimeInstance(int,Locale) DateFormat.getTimeInstance}{@code (}{@link java.text.DateFormat#DEFAULT}{@code , getLocale())}
 *    <tr>
 *       <th scope="row" style="text-weight: normal">{@code long}
 *       <td>{@link java.text.DateFormat#getTimeInstance(int,Locale) DateFormat.getTimeInstance}{@code (}{@link java.text.DateFormat#LONG}{@code , getLocale())}
 *    <tr>
 *       <th scope="row" style="text-weight: normal">{@code full}
 *       <td>{@link java.text.DateFormat#getTimeInstance(int,Locale) DateFormat.getTimeInstance}{@code (}{@link java.text.DateFormat#FULL}{@code , getLocale())}
 *    <tr>
 *       <th scope="row" style="text-weight: normal"><i>SubformatPattern</i>
 *       <td>{@code new} {@link SimpleDateFormat#SimpleDateFormat(String,Locale) SimpleDateFormat}{@code (subformatPattern, getLocale())}
 *    <tr>
 ...
 *       <th scope="row" style="text-weight: normal"><i>SubformatPattern</i>
 *       <td>{@code new} {@link java.text.ChoiceFormat#ChoiceFormat(String) ChoiceFormat}{@code (subformatPattern)}
 * </tbody>
 * </table>
 *
...
public class MessageFormat extends java.text.Format {
    ...
    public String toPattern() {
        ...
        for (int i = 0; i <= maxOffset; ++i) {
            ...
            java.text.Format fmt = formats[i];
            if (fmt == null) {
                // do nothing, string format
            } else if (fmt instanceof java.text.NumberFormat) {
                if (fmt.equals(java.text.NumberFormat.getInstance(locale))) {
                    result.append(",number");
                } else if (fmt.equals(java.text.NumberFormat.getCurrencyInstance(locale))) {
                    result.append(",number,currency");
                } else if (fmt.equals(java.text.NumberFormat.getPercentInstance(locale))) {
                    result.append(",number,percent");
                } else if (fmt.equals(java.text.NumberFormat.getIntegerInstance(locale))) {
                    result.append(",number,integer");
                } else {
                    if (fmt instanceof DecimalFormat) {
                        result.append(",number,").append(((DecimalFormat)fmt).toPattern());
                    } else if (fmt instanceof java.text.ChoiceFormat) {
                        result.append(",choice,").append(((java.text.ChoiceFormat)fmt).toPattern());
                    } else {
                        // UNKNOWN
                    }
                }
            } else if (fmt instanceof java.text.DateFormat) {
                int index;
                for (index = MODIFIER_DEFAULT; index < DATE_TIME_MODIFIERS.length; index++) {
                    java.text.DateFormat df = java.text.DateFormat.getDateInstance(DATE_TIME_MODIFIERS[index],
                                                               locale);
                    if (fmt.equals(df)) {
                        result.append(",date");
                        break;
                    }
                    df = java.text.DateFormat.getTimeInstance(DATE_TIME_MODIFIERS[index],
                                                    locale);
                    if (fmt.equals(df)) {
                        result.append(",time");
                        break;
    ...
    public java.text.Format[] getFormatsByArgumentIndex() {
        ...
        java.text.Format[] resultArray = new java.text.Format[maximumArgumentNumber + 1];
        for (int i = 0; i <= maxOffset; i++) {
    ...
    public java.text.Format[] getFormats() {
        java.text.Format[] resultArray = new java.text.Format[maxOffset + 1];
     ...
     * <blockquote>
     *     <code>(new {@link #MessageFormat(String) MessageFormat}(pattern)).{@link #format(Object[], StringBuffer, java.text.FieldPosition) format}(arguments, new StringBuffer(), null).toString()</code>
     * </blockquote>
     *
     ...
     * <blockquote>
     *     <code>{@link #format(Object[], StringBuffer, java.text.FieldPosition) format}((Object[]) arguments, result, pos)</code>
     * </blockquote>
     *
     * @param arguments an array of objects to be formatted and substituted.
     * @param result where text is appended.
     ...
     * <blockquote>
     *     <code>{@link #format(Object[], StringBuffer, java.text.FieldPosition) format}(arguments, new StringBuffer(), null).toString()</code>
     * </blockquote>
     * <p>
    ...
    public Object clone() {
        ...
        for (int i = 0; i < formats.length; ++i) {
            if (formats[i] != null)
                other.formats[i] = (java.text.Format)formats[i].clone();
        }
     ...
     * @serial
     */
    private java.text.Format[] formats = new java.text.Format[INITIAL_FORMATS];
    ...
    private StringBuffer subformat(Object[] arguments, StringBuffer result,
        ...
        for (int i = 0; i <= maxOffset; ++i) {
            ...
            if (false) { // if (argRecursion == 3){
                ...
                String arg = null;
                java.text.Format subFormatter = null;
                if (obj == null) {
                    arg = "null";
                } else if (formats[i] != null) {
                    subFormatter = formats[i];
                    if (subFormatter instanceof java.text.ChoiceFormat) {
                    ...
                    subFormatter = java.text.NumberFormat.getInstance(locale);
                } else if (obj instanceof Date) {
                    // format a Date if can
                    subFormatter = java.text.DateFormat.getDateTimeInstance(
                             java.text.DateFormat.SHORT, java.text.DateFormat.SHORT, locale);//fix
                            ...
                            StringBuilder[] textSegments)
    {
        ...
        if (offsetNumber >= formats.length) {
            ...
            java.text.Format[] newFormats = new java.text.Format[newLength];
        ...
        if (segments[SEG_TYPE].length() != 0) {
            ...
            case TYPE_NUMBER:
                ...
                case MODIFIER_DEFAULT:
                    newFormat = java.text.NumberFormat.getInstance(locale);
                    break;
                case MODIFIER_CURRENCY:
                    newFormat = java.text.NumberFormat.getCurrencyInstance(locale);
                    break;
                case MODIFIER_PERCENT:
                    newFormat = java.text.NumberFormat.getPercentInstance(locale);
                    break;
            ...
            case TYPE_TIME:
                ...
                if (mod >= 0 && mod < DATE_TIME_MODIFIER_KEYWORDS.length) {
                    if (type == TYPE_DATE) {
                        newFormat = java.text.DateFormat.getDateInstance(DATE_TIME_MODIFIERS[mod],
                                                               locale);
                    } else {
