...
final class RuleBasedCollationKey extends java.text.CollationKey {
    /**
    ...
    public int compareTo(CollationKey target)
    {
        ...
        if (result <= java.text.Collator.LESS)
            return java.text.Collator.LESS;
        else if (result >= java.text.Collator.GREATER)
            return java.text.Collator.GREATER;
