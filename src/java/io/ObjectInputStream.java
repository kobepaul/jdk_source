 ...
 * If a {@linkplain #setObjectInputFilter(java.io.ObjectInputFilter) filter is set}
 * on an ObjectInputStream, the {@link java.io.ObjectInputFilter} can check that
 ...
 * A {@linkplain java.io.ObjectInputFilter.Config#setSerialFilter(java.io.ObjectInputFilter) process-wide filter}
 * can be configured that is applied to each {@code ObjectInputStream} unless replaced
 * using {@link #setObjectInputFilter(java.io.ObjectInputFilter) setObjectInputFilter}.
 *
    ...
    extends java.io.InputStream implements ObjectInput, ObjectStreamConstants
{
     ...
     * {@linkplain java.io.ObjectInputFilter.Config#getSerialFilter() the process-wide filter}.
     *
    ...
    public ObjectInputStream(java.io.InputStream in) throws java.io.IOException {
        ...
        serialFilter = java.io.ObjectInputFilter.Config.getSerialFilter();
     ...
     * See {@link #setObjectInputFilter(java.io.ObjectInputFilter) setObjectInputFilter} for details.
     *
     ...
     * {@link java.io.ObjectInputFilter.Config#getSerialFilter() ObjectInputFilter.Config.getSerialFilter}.
     *
     ...
     * The filter's {@link java.io.ObjectInputFilter#checkInput checkInput} method is called
     ...
     * not primitives.
     * <p>
     * If the filter returns {@link java.io.ObjectInputFilter.Status#REJECTED Status.REJECTED},
     ...
     * </ul>
     *
     * When the {@link java.io.ObjectInputFilter#checkInput checkInput} method is invoked
     ...
     * @since 9
     */
    public final void setObjectInputFilter(java.io.ObjectInputFilter filter) {
        SecurityManager sm = System.getSecurityManager();
        if (sm != null) {
    ...
    private void filterCheck(Class<?> clazz, int arrayLength)
        ...
        if (serialFilter != null) {
            ...
            java.io.ObjectInputFilter.Status status;
            ...
            try {
                ...
                status = java.io.ObjectInputFilter.Status.REJECTED;
                ex = e;
            }
            if (Logging.filterLogger != null) {
                // Debug logging of filter checks that fail; Tracing for those that succeed
                Logging.filterLogger.log(status == null || status == java.io.ObjectInputFilter.Status.REJECTED
                                ? Logger.Level.DEBUG
                                : Logger.Level.TRACE,
