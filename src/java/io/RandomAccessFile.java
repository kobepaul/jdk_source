...
public class RandomAccessFile implements DataOutput, DataInput, java.io.Closeable {
    ...
    private RandomAccessFile(java.io.File file, String mode, boolean openAndDelete)
        throws FileNotFoundException
    {
        ...
        path = name;
        open(name, imode);
        java.io.FileCleanable.register(fd);   // open sets the fd, register the cleanup
    }
     ...
     * @throws java.io.EOFException  if this file reaches the end before reading
     *              all the bytes.
