...
public final class String
    ...
    private static java.lang.Void rangeCheck(char[] value, int offset, int count) {
    ...
    public String replace(CharSequence target, CharSequence replacement) {
        ...
        int tgtLen1 = java.lang.Math.max(tgtLen, 1);
        int thisLen = length();
     ...
     * disambiguating it against other (public) constructors.
     */
    String(AbstractStringBuilder asb, java.lang.Void sig) {
