...
public class Runtime {
     ...
     * method prints the exception's stack trace to {@link java.lang.System#err} and
     ...
     *
     * @param   hook
     *          An initialized but unstarted {@link java.lang.Thread} object
     *
     ...
     * {@link #exec(java.lang.String, java.lang.String[], File) exec}{@code (command, null, null)}.
     *
     ...
     * behaves in exactly the same way as the invocation
     * {@link #exec(java.lang.String, java.lang.String[], File) exec}{@code (command, envp, null)}.
     *
     * @param   command   a specified system command.
     *
     ...
     * behaves in exactly the same way as the invocation
     * {@link #exec(java.lang.String[], java.lang.String[], File) exec}{@code (cmdarray, envp, dir)},
     ...
     * {@code exec(cmdarray)}
     * behaves in exactly the same way as the invocation
     * {@link #exec(java.lang.String[], java.lang.String[], File) exec}{@code (cmdarray, null, null)}.
     *
     ...
     * behaves in exactly the same way as the invocation
     * {@link #exec(java.lang.String[], java.lang.String[], File) exec}{@code (cmdarray, envp, null)}.
     *
     * @param   cmdarray  array containing the command to call and
     *                    its arguments.
     *
     ...
     * corresponding methods {@link #equals(java.lang.Object) equals()} and {@link
     * #equalsIgnoreOptional(java.lang.Object) equalsIgnoreOptional()}.  </p>
     *
    ...
    {
        private final List<java.lang.Integer>     version;
        private final Optional<java.lang.String>  pre;
        private final Optional<java.lang.Integer> build;
        private final Optional<java.lang.String>  optional;
         ...
         */
        private Version(List<java.lang.Integer> unmodifiableListOfVersions,
                        Optional<java.lang.String> pre,
                        Optional<java.lang.Integer> build,
         ...
         *          cannot be represented as an {@link java.lang.Integer}
         *
        ...
        public static Version parse(java.lang.String s) {
            ...
            if (isSimpleNumber(s)) {
                return new Version(List.of(java.lang.Integer.parseInt(s)),
            ...
            java.lang.String[] split = m.group(VersionPattern.VNUM_GROUP).split("\\.");
            java.lang.Integer[] version = new java.lang.Integer[split.length];
            for (int i = 0; i < split.length; i++) {
                version[i] = java.lang.Integer.parseInt(split[i]);
            }

            Optional<java.lang.String> pre = Optional.ofNullable(
                    m.group(VersionPattern.PRE_GROUP));

            java.lang.String b = m.group(VersionPattern.BUILD_GROUP);
            // $BUILD is an integer
            Optional<java.lang.Integer> build = (b == null)
                ? Optional.empty()
                : Optional.of(java.lang.Integer.parseInt(b));

            Optional<java.lang.String> optional = Optional.ofNullable(
        ...
        private static boolean isSimpleNumber(java.lang.String s) {
         ...
         */
        public List<java.lang.Integer> version() {
            return version;
        }
         ...
         */
        public Optional<java.lang.String> pre() {
            return pre;
        }
         ...
         */
        public Optional<java.lang.Integer> build() {
            return build;
        }
         ...
         */
        public Optional<java.lang.String> optional() {
            return optional;
        }
        ...
        private int compareVersion(Version obj) {
            ...
            int min = java.lang.Math.min(size, oSize);
            for (int i = 0; i < min; i++) {
        ...
        private int comparePre(Version obj) {
            Optional<java.lang.String> oPre = obj.pre();
            if (!pre.isPresent()) {
                if (oPre.isPresent())
                    return 1;
            } else {
                if (!oPre.isPresent())
                    return -1;
                java.lang.String val = pre.get();
                java.lang.String oVal = oPre.get();
                if (val.matches("\\d+")) {
        ...
        private int compareBuild(Version obj) {
            Optional<java.lang.Integer> oBuild = obj.build();
            if (oBuild.isPresent()) {
        ...
        private int compareOptional(Version obj) {
            Optional<java.lang.String> oOpt = obj.optional();
            if (!optional.isPresent()) {
                if (oOpt.isPresent())
                    return -1;
            } else {
         ...
         *
         */
        public boolean equalsIgnoreOptional(java.lang.Object obj) {
            if (this == obj)
                return true;
    ...
    private static class VersionPattern {
        ...
        private static final java.lang.String PRE      = "(?:-(?<PRE>[a-zA-Z0-9]+))?";
        private static final java.lang.String BUILD
            = "(?:(?<PLUS>\\+)(?<BUILD>0|[1-9][0-9]*)?)?";
        private static final java.lang.String OPT      = "(?:-(?<OPT>[-a-zA-Z0-9.]+))?";
        private static final java.lang.String VSTR_FORMAT = VNUM + PRE + BUILD + OPT;

        static final Pattern VSTR_PATTERN = Pattern.compile(VSTR_FORMAT);

        static final java.lang.String VNUM_GROUP  = "VNUM";
        static final java.lang.String PRE_GROUP   = "PRE";
        static final java.lang.String PLUS_GROUP  = "PLUS";
        static final java.lang.String BUILD_GROUP = "BUILD";
        static final java.lang.String OPT_GROUP   = "OPT";
    }
}
