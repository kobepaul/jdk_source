 ...
 * via the input streams returned by {@link java.lang.Process#getOutputStream()} and
...
public final class ProcessBuilder
{
     ...
     *         {@link SecurityManager#checkRead(java.lang.String) checkRead} method
     ...
     *         and the security manager's
     *         {@link SecurityManager#checkWrite(java.lang.String) checkWrite} method
     ...
     * @throws IOException if an I/O error occurs
     */
    private java.lang.Process start(Redirect[] redirects) throws IOException {
     ...
     * not accessible.
     * The {@link java.lang.Process#getOutputStream standard input} of all processes
     * except the first process are <i>null output streams</i>
     * The {@link java.lang.Process#getInputStream standard output} of all processes
     ...
     * @since 9
     */
    public static List<java.lang.Process> startPipeline(List<ProcessBuilder> builders) throws IOException {
        // Accumulate and check the builders
        final int numBuilders = builders.size();
        List<java.lang.Process> processes = new ArrayList<>(numBuilders);
        try {
            ...
            processes.forEach(java.lang.Process::destroyForcibly);
            processes.forEach(p -> {
                try {
