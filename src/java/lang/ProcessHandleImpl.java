 ...
 * @since 9
 */
final class ProcessHandleImpl implements java.lang.ProcessHandle {
    /**
     ...
     */
    private static final ConcurrentMap<java.lang.Long, ExitCompletion>
    ...
    private static final Executor processReaperExecutor =
            doPrivileged((PrivilegedAction<Executor>) () -> {
                ...
                java.lang.ThreadGroup tg = java.lang.Thread.currentThread().getThreadGroup();
                while (tg.getParent() != null) tg = tg.getParent();
                java.lang.ThreadGroup systemThreadGroup = tg;
                final long stackSize = java.lang.Boolean.getBoolean("jdk.lang.processReaperUseDefaultStackSize")
                        ? 0 : REAPER_DEFAULT_STACKSIZE;

                ThreadFactory threadFactory = grimReaper -> {
                    java.lang.Thread t = new java.lang.Thread(systemThreadGroup, grimReaper,
    ...
    private static class ExitCompletion extends CompletableFuture<java.lang.Integer> {
     ...
     */
    static CompletableFuture<java.lang.Integer> completion(long pid, boolean shouldReap) {
        ...
        while (completion == null || (shouldReap && !completion.isReaping)) {
            ...
            if (completion == null) {
                ...
                processReaperExecutor.execute(new java.lang.Runnable() {
                    ...
                    public void run() {
                        ...
                        if (exitValue == NOT_A_CHILD) {
                            ...
                            while (startTime >= 0) {
                                try {
                                    java.lang.Thread.sleep(java.lang.Math.min(sleep, 5000L)); // no more than 5 sec
                                    sleep += incr;
    ...
    @java.lang.Override
    public CompletableFuture<java.lang.ProcessHandle> onExit() {
     ...
     */
    static Optional<java.lang.ProcessHandle> get(long pid) {
     ...
     *                                     security policy
     */
    public Optional<java.lang.ProcessHandle> parent() {
        java.lang.SecurityManager sm = java.lang.System.getSecurityManager();
        if (sm != null) {
            sm.checkPermission(new RuntimePermission("manageProcess"));
        }
    ...
    @java.lang.Override
    public Stream<java.lang.ProcessHandle> children() {
     ...
     */
    static Stream<java.lang.ProcessHandle> children(long pid) {
        java.lang.SecurityManager sm = java.lang.System.getSecurityManager();
        if (sm != null) {
            sm.checkPermission(new RuntimePermission("manageProcess"));
        }
    ...
    @java.lang.Override
    public Stream<java.lang.ProcessHandle> descendants() {
        java.lang.SecurityManager sm = java.lang.System.getSecurityManager();
        if (sm != null) {
            sm.checkPermission(new RuntimePermission("manageProcess"));
        }
    ...
    public int compareTo(java.lang.ProcessHandle other) {
        return java.lang.Long.compare(pid, ((ProcessHandleImpl) other).pid);
    }

    @java.lang.Override
    public java.lang.String toString() {
        return java.lang.Long.toString(pid);
    }

    @java.lang.Override
    public int hashCode() {
        return java.lang.Long.hashCode(pid);
    }
     ...
     */
    static class Info implements java.lang.ProcessHandle.Info {
        static {
            initIDs();
        }
         ...
         */
        public static java.lang.ProcessHandle.Info info(long pid, long startTime) {
            Info info = new Info();
            info.info0(pid);
        ...
        @java.lang.Override
        public Optional<java.lang.String> command() {
            return Optional.ofNullable(command);
        }

        @java.lang.Override
        public Optional<java.lang.String> commandLine() {
            if (command != null && arguments != null) {
                return Optional.of(command + " " + java.lang.String.join(" ", arguments));
            } else {
        ...
        @java.lang.Override
        public Optional<java.lang.String[]> arguments() {
        ...
        @java.lang.Override
        public Optional<java.lang.String> user() {
