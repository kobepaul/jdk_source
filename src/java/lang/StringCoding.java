...
class StringCoding {
    ...
    private static final java.lang.ThreadLocal<SoftReference<StringDecoder>> decoder =
        new java.lang.ThreadLocal<>();
    private static final java.lang.ThreadLocal<SoftReference<StringEncoder>> encoder =
        new java.lang.ThreadLocal<>();
    ...
    static class Result {
        ...
        Result with(char[] val, int off, int len) {
            if (java.lang.String.COMPACT_STRINGS) {
                byte[] bs = java.lang.StringUTF16.compress(val, off, len);
                if (bs != null) {
                    value = bs;
                    coder = LATIN1;
                    return this;
            ...
            coder = UTF16;
            value = java.lang.StringUTF16.toBytes(val, off, len);
            return this;
        }
    ...
    static class StringDecoder {
        ...
        StringDecoder(Charset cs, java.lang.String rcn) {
    ...
    static Result decode(java.lang.String charsetName, byte[] ba, int off, int len)
    ...
    private static class StringEncoder {
        ...
        byte[] encode(byte coder, byte[] val) {
            ...
            char[] ca = (coder == LATIN1 ) ? StringLatin1.toChars(val)
                                           : java.lang.StringUTF16.toChars(val);
            ce.reset();
    ...
    static byte[] encode(java.lang.String charsetName, byte coder, byte[] val)
        throws UnsupportedEncodingException
    {
     ...
     */
    private static native void err(java.lang.String msg);

     /* The cached Result for each thread */
    private static final java.lang.ThreadLocal<Result>
        resultCached = new java.lang.ThreadLocal<>() {
    ...
    private static byte[] encodeASCII(byte coder, byte[] val) {
        ...
        int dp = 0;
        for (int i = 0; i < len; i++) {
            char c = java.lang.StringUTF16.getChar(val, i);
            if (c < 0x80) {
                dst[dp++] = (byte)c;
                continue;
            }
            if (java.lang.Character.isHighSurrogate(c) && i + 1 < len &&
                java.lang.Character.isLowSurrogate(java.lang.StringUTF16.getChar(val, i + 1))) {
                i++;
            }
            dst[dp++] = '?';
        }
    ...
    private static int implEncodeISOArray(byte[] sa, int sp,
        ...
        int i = 0;
        for (; i < len; i++) {
            char c = java.lang.StringUTF16.getChar(sa, sp++);
            if (c > '\u00FF')
                break;
            da[dp++] = (byte)c;
        }
    ...
    private static byte[] encode8859_1(byte coder, byte[] val, boolean doReplace) {
        ...
        while (sp < sl) {
            ...
            if (ret != len) {
                ...
                char c = java.lang.StringUTF16.getChar(val, sp++);
                if (java.lang.Character.isHighSurrogate(c) && sp < sl &&
                    java.lang.Character.isLowSurrogate(java.lang.StringUTF16.getChar(val, sp))) {
                    sp++;
                }
                dst[dp++] = '?';
                len = sl - sp;
    ...
    private static void throwMalformed(int off, int nb) {
        java.lang.String msg = "malformed input off : " + off + ", length : " + nb;
    ...
    private static byte[] encodeUTF8_UTF16(byte[] val, boolean doReplace) {
        ...
        char c;
        while (sp < sl && (c = java.lang.StringUTF16.getChar(val, sp)) < '\u0080') {
            // ascii fast loop;
            dst[dp++] = (byte)c;
            sp++;
        }
        while (sp < sl) {
            c = java.lang.StringUTF16.getChar(val, sp++);
            if (c < 0x80) {
                dst[dp++] = (byte)c;
            } else if (c < 0x800) {
                dst[dp++] = (byte)(0xc0 | (c >> 6));
                dst[dp++] = (byte)(0x80 | (c & 0x3f));
            } else if (java.lang.Character.isSurrogate(c)) {
                int uc = -1;
                char c2;
                if (java.lang.Character.isHighSurrogate(c) && sp < sl &&
                    java.lang.Character.isLowSurrogate(c2 = java.lang.StringUTF16.getChar(val, sp))) {
                    uc = java.lang.Character.toCodePoint(c, c2);
                }
                if (uc < 0) {
                    if (doReplace) {
                        dst[dp++] = '?';
     ...
     */
    static java.lang.String newStringUTF8NoRepl(byte[] src, int off, int len) {
        if (COMPACT_STRINGS && !hasNegatives(src, off, len))
            return new java.lang.String(Arrays.copyOfRange(src, off, off + len), LATIN1);
        Result ret = decodeUTF8_0(src, off, len, false);
        return new java.lang.String(ret.value, ret.coder);
    }

    /*
     * Throws iae, instead of replacing, if unmappable.
     */
    static byte[] getBytesUTF8NoRepl(java.lang.String s) {
    ...
    private static java.lang.String newStringLatin1(byte[] src) {
        if (COMPACT_STRINGS)
           return new java.lang.String(src, LATIN1);
        return new java.lang.String(StringLatin1.inflate(src, 0, src.length), UTF16);
    }

    static java.lang.String newStringNoRepl(byte[] src, Charset cs) throws CharacterCodingException {
        try {
    ...
    static java.lang.String newStringNoRepl1(byte[] src, Charset cs) {
        if (cs == UTF_8) {
     ...
     */
    static byte[] getBytesNoRepl(java.lang.String s, Charset cs) throws CharacterCodingException {
        try {
    ...
    static byte[] getBytesNoRepl1(java.lang.String s, Charset cs) {
        byte[] val = s.value();
        byte coder = s.coder();
        if (cs == UTF_8) {
            if (isASCII(val)) {
