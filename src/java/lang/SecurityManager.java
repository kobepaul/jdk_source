...
public class SecurityManager {
    ...
    private static final Map<java.lang.String, java.lang.Boolean> nonExportedPkgs = new ConcurrentHashMap<>();
    static {
        addNonExportedPackages(java.lang.ModuleLayer.boot());
    }
    ...
    static void addNonExportedPackages(java.lang.ModuleLayer layer) {
        Set<java.lang.String> bootModules = ModuleLoaderMap.bootModules();
        Set<java.lang.String> platformModules = ModuleLoaderMap.platformModules();
        layer.modules().stream()
                ...
                .flatMap(Set::stream)
                .forEach(pn -> nonExportedPkgs.put(pn, java.lang.Boolean.TRUE));
    }
     ...
     */
    private static Set<java.lang.String> nonExportedPkgs(ModuleDescriptor md) {
        // start with all packages in the module
        Set<java.lang.String> pkgs = new HashSet<>(md.packages());
     ...
     * loaded by {@linkplain java.lang.ClassLoader#getPlatformClassLoader
    ...
    public void checkPackageAccess(java.lang.String pkg) {
        ...
        java.lang.String[] restrictedPkgs;
        synchronized (packageAccessLock) {
            /*
        ...
        for (java.lang.String restrictedPkg : restrictedPkgs) {
    ...
    public void checkPackageDefinition(java.lang.String pkg) {
         ...
         * Traverse the list of packages, check for any matches.
         */
        for (java.lang.String restrictedPkg : pkgs) {
