...
interface LiveStackFrame extends StackFrame {
     ...
     */
    public java.lang.Object[] getLocals();
     ...
     */
    public static java.lang.StackWalker getStackWalker() {
        return getStackWalker(EnumSet.noneOf(java.lang.StackWalker.Option.class));
    }
     ...
     * {@linkplain java.lang.StackWalker.Option#SHOW_HIDDEN_FRAMES hidden frames} skipped.
     * The returned {@code StackWalker} can get locals and operands.
     *
     * @param options stack walk {@link java.lang.StackWalker.Option options}
     *
     * @throws SecurityException if the security manager is present and
     * it denies access to {@code RuntimePermission("liveStackFrames")}; or
     * or if the given {@code options} contains
     * {@link java.lang.StackWalker.Option#RETAIN_CLASS_REFERENCE Option.RETAIN_CLASS_REFERENCE}
     * and it denies access to {@code RuntimePermission("getStackWalkerWithClassReference")}.
     */
    public static java.lang.StackWalker getStackWalker(Set<java.lang.StackWalker.Option> options) {
        SecurityManager sm = java.lang.System.getSecurityManager();
        if (sm != null) {
            sm.checkPermission(new RuntimePermission("liveStackFrames"));
        }
        return java.lang.StackWalker.newInstance(options, LOCALS_AND_OPERANDS);
    }
}
