...
final class LiveStackFrameInfo extends java.lang.StackFrameInfo implements java.lang.LiveStackFrame {
    private static java.lang.Object[] EMPTY_ARRAY = new java.lang.Object[0];

    // These flags must match the values maintained in the VM
    private static final int MODE_INTERPRETED = 0x01;
    private static final int MODE_COMPILED    = 0x02;

    LiveStackFrameInfo(java.lang.StackWalker walker) {
        super(walker);
    }

    // These fields are initialized by the VM if ExtendedOption.LOCALS_AND_OPERANDS is set
    private java.lang.Object[] monitors = EMPTY_ARRAY;
    private java.lang.Object[] locals = EMPTY_ARRAY;
    private java.lang.Object[] operands = EMPTY_ARRAY;
    private int mode = 0;
    ...
    public java.lang.String toString() {
        java.lang.StringBuilder retVal = new java.lang.StringBuilder(super.toString());
        if (mode != 0) {
            retVal.append("(");
