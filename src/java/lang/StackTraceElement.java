...
public final class StackTraceElement implements java.io.Serializable {
    ...
    private transient java.lang.Class<?> declaringClassObject;
    ...
    public StackTraceElement(java.lang.String classLoaderName,
                             java.lang.String moduleName, java.lang.String moduleVersion,
                             java.lang.String declaringClass, java.lang.String methodName,
                             java.lang.String fileName, int lineNumber) {
     ...
     * {@linkplain #equals(java.lang.Object) equal}, for example one created via the
    ...
    private synchronized void computeFormat() {
        try {
            java.lang.Class<?> cls = (java.lang.Class<?>) declaringClassObject;
            java.lang.ClassLoader loader = cls.getClassLoader0();
            java.lang.Module m = cls.getModule();
            byte bits = 0;
     ...
     */
    private static boolean isHashedInJavaBase(java.lang.Module m) {
        // return true if module system is not initialized as the code
        // must be in java.base
        if (!VM.isModuleSystemInited())
            return true;

        return java.lang.ModuleLayer.boot() == m.getLayer() && HashedModules.contains(m);
    }
    ...
    private static class HashedModules {
        static Set<java.lang.String> HASHED_MODULES = hashedModules();

        static Set<java.lang.String> hashedModules() {

            Optional<ResolvedModule> resolvedModule = java.lang.ModuleLayer.boot()
                    .configuration()
            ...
            if (hashes != null) {
                Set<java.lang.String> names = new HashSet<>(hashes.names());
                names.add("java.base");
                return names;
            }
        ...
        static boolean contains(java.lang.Module m) {
     ...
     */
    static StackTraceElement[] of(java.lang.Throwable x, int depth) {
     ...
     */
    static StackTraceElement of(java.lang.StackFrameInfo sfi) {
