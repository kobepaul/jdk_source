...
final class StringUTF16 {
    ...
    private static int codePointAt(byte[] value, int index, int end, boolean checked) {
        ...
        if (java.lang.Character.isHighSurrogate(c1) && ++index < end) {
            if (checked) {
                checkIndex(index, value);
            }
    ...
    private static int codePointBefore(byte[] value, int index, boolean checked) {
        ...
        char c2 = getChar(value, index);
        if (java.lang.Character.isLowSurrogate(c2) && index > 0) {
            --index;
            if (checked) {
                checkIndex(index, value);
            }
    ...
    private static int codePointCount(byte[] value, int beginIndex, int endIndex, boolean checked) {
        ...
        for (; i < endIndex - 1; ) {
            if (java.lang.Character.isHighSurrogate(getChar(value, i++)) &&
                java.lang.Character.isLowSurrogate(getChar(value, i))) {
                count--;
                i++;
            }
        }
    ...
    public static byte[] toBytes(int[] val, int index, int len) {
        ...
        for (int i = index; i < end; i++) {
            int cp = val[i];
            if (java.lang.Character.isBmpCodePoint(cp))
                continue;
            else if (java.lang.Character.isValidCodePoint(cp))
                n++;
            else throw new IllegalArgumentException(java.lang.Integer.toString(cp));
        }
        ...
        for (int i = index, j = 0; i < end; i++, j++) {
            ...
            if (java.lang.Character.isBmpCodePoint(cp)) {
                ...
                putChar(buf, j++, java.lang.Character.highSurrogate(cp));
                putChar(buf, j, java.lang.Character.lowSurrogate(cp));
            }
        }
        return buf;
    }
    ...
    static byte[] toBytesSupplementary(int cp) {
        ...
        putChar(result, 0, java.lang.Character.highSurrogate(cp));
        putChar(result, 1, java.lang.Character.lowSurrogate(cp));
        return result;
    }
    ...
    public static int indexOfLatin1(byte[] src, int srcCount, byte[] tgt, int tgtCount, int fromIndex) {
        ...
        java.lang.String.checkBoundsBeginEnd(0, tgtCount, tgt.length);
    ...
    public static int lastIndexOf(byte[] value, int ch, int fromIndex) {
        if (ch < java.lang.Character.MIN_SUPPLEMENTARY_CODE_POINT) {
            // handle most cases here (ch is a BMP code point or a
            // negative value (invalid code point))
            int i = java.lang.Math.min(fromIndex, (value.length >> 1) - 1);
            for (; i >= 0; i--) {
                if (getChar(value, i) == ch) {
                    return i;
                }
    ...
    private static int lastIndexOfSupplementary(final byte[] value, int ch, int fromIndex) {
        if (java.lang.Character.isValidCodePoint(ch)) {
            ...
            int i = java.lang.Math.min(fromIndex, (value.length >> 1) - 2);
            for (; i >= 0; i--) {
                if (getChar(value, i) == hi && getChar(value, i + 1) == lo) {
                    return i;
                }
    ...
    public static java.lang.String replace(byte[] value, char oldChar, char newChar) {
        ...
        if (i < len) {
           ...
           if (java.lang.String.COMPACT_STRINGS &&
               ...
               if (val != null) {
                   return new java.lang.String(val, LATIN1);
               }
           }
    ...
    public static java.lang.String toLowerCase(java.lang.String str, byte[] value, Locale locale) {
        ...
        for (first = 0 ; first < len; first++) {
            ...
            if (java.lang.Character.isSurrogate((char)cp)) {
                hasSurr = true;
                break;
            }
        ...
        java.lang.System.arraycopy(value, 0, result, 0, first << 1);  // Just copy the first few
        ...
        for (int i = first; i < len; i++) {
            ...
            if (cp == '\u03A3' ||                       // GREEK CAPITAL LETTER SIGMA
                java.lang.Character.isSurrogate((char)cp)) {
        ...
        if (bits > 0xFF) {
            return new java.lang.String(result, UTF16);
        } else {
    ...
    private static java.lang.String toLowerCaseEx(java.lang.String str, byte[] value,
        ...
        for (int i = first; i < length; i += srcCount) {
            ...
            char[] lowerCharArray;
            srcCount = 1;
            if (java.lang.Character.isSurrogate((char)srcChar)) {
    ...
    public static java.lang.String toUpperCase(java.lang.String str, byte[] value, Locale locale) {
        ...
        for (int i = first; i < len; i++) {
            ...
            if (!java.lang.Character.isBmpCodePoint(cp)) {    // Character.ERROR is not bmp
                return toUpperCaseEx(str, value, result, i, locale, false);
            }
            bits |= cp;
            putChar(result, i, cp);
    ...
    public static java.lang.String trim(byte[] value) {
        ...
        return ((st > 0) || (len < length )) ?
            new java.lang.String(Arrays.copyOfRange(value, st << 1, len << 1), UTF16) :
            null;
    }
    ...
    public static int indexOfNonWhitespace(byte[] value) {
        ...
        while (left < length) {
            ...
            if (codepoint != ' ' && codepoint != '\t' && !java.lang.Character.isWhitespace(codepoint)) {
                break;
            }
            left += java.lang.Character.charCount(codepoint);
        }
        return left;
    }
    ...
    public static int lastIndexOfNonWhitespace(byte[] value) {
        ...
        while (0 < right) {
            ...
            right -= java.lang.Character.charCount(codepoint);
        }
        return right;
    }
    ...
    public static java.lang.String newString(byte[] val, int index, int len) {
        ...
        int last = index + len;
        return new java.lang.String(Arrays.copyOfRange(val, index << 1, last << 1), UTF16);
    }
    ...
    static class CodePointsSpliterator implements Spliterator.OfInt {
        ...
        public OfInt trySplit() {
            ...
            if (java.lang.Character.isLowSurrogate(charAt(array, mid)) &&
                java.lang.Character.isHighSurrogate(charAt(array, midOneLess = (mid -1)))) {
        ...
        private static int advance(byte[] a, int i, int hi, IntConsumer action) {
            char c1 = charAt(a, i++);
            int cp = c1;
            if (java.lang.Character.isHighSurrogate(c1) && i < hi) {
                char c2 = charAt(a, i);
                if (java.lang.Character.isLowSurrogate(c2)) {
                    i++;
                    cp = java.lang.Character.toCodePoint(c1, c2);
                }
            }
            action.accept(cp);
            return i;
    ...
    static final int MAX_LENGTH = java.lang.Integer.MAX_VALUE >> 1;

    // Used by trusted callers.  Assumes all necessary bounds checks have
    // been done by the caller.

    /**
     * This is a variant of {@link java.lang.Integer#getChars(int, int, byte[])}, but for
     * UTF-16 coder.
     *
    ...
    static int getChars(int i, int index, byte[] buf) {
        ...
        while (i <= -100) {
            ...
            r = (q * 100) - i;
            i = q;
            putChar(buf, --charPos, java.lang.Integer.DigitOnes[r]);
            putChar(buf, --charPos, java.lang.Integer.DigitTens[r]);
        }
    ...
    /**
     * This is a variant of {@link java.lang.Long#getChars(long, int, byte[])}, but for
     * UTF-16 coder.
     *
     * @param i     value to convert
     * @param index next index, after the least significant digit
    ...
    static int getChars(long i, int index, byte[] buf) {
        ...
        while (i <= java.lang.Integer.MIN_VALUE) {
            q = i / 100;
            r = (int)((q * 100) - i);
            i = q;
            putChar(buf, --charPos, java.lang.Integer.DigitOnes[r]);
    ...
    public static void checkIndex(int off, byte[] val) {
        java.lang.String.checkIndex(off, length(val));
    }

    public static void checkOffset(int off, byte[] val) {
        java.lang.String.checkOffset(off, length(val));
    }

    public static void checkBoundsBeginEnd(int begin, int end, byte[] val) {
        java.lang.String.checkBoundsBeginEnd(begin, end, length(val));
    }

    public static void checkBoundsOffCount(int offset, int count, byte[] val) {
        java.lang.String.checkBoundsOffCount(offset, count, length(val));
    }
