...
public class AccessibleObject implements AnnotatedElement {
     ...
     * access to a {@link java.lang.reflect.Member member} of {@link java.lang.reflect.Member#getDeclaringClass()
    ...
    public final boolean trySetAccessible() {
        ...
        if (!java.lang.reflect.Member.class.isInstance(this)) {
            return setAccessible0(true);
        }

        // does not allow to suppress access check for Class's constructor
        Class<?> declaringClass = ((java.lang.reflect.Member) this).getDeclaringClass();
        if (declaringClass == Class.class && this instanceof java.lang.reflect.Constructor) {
            return false;
        }
    ...
    */
    ...
    private boolean checkCanSetAccessible(Class<?> caller,
        ...
        int modifiers;
        if (this instanceof java.lang.reflect.Executable) {
            modifiers = ((Executable) this).getModifiers();
        } else {
            modifiers = ((java.lang.reflect.Field) this).getModifiers();
        }

        // class is public and package is exported to caller
        boolean isClassPublic = java.lang.reflect.Modifier.isPublic(declaringClass.getModifiers());
        ...
        if (throwExceptionIfDenied) {
            ...
            if (this instanceof java.lang.reflect.Field)
                msg += "field ";
            msg += this + " accessible: " + declaringModule + " does not \"";
            if (isClassPublic && java.lang.reflect.Modifier.isPublic(modifiers))
                msg += "exports";
            else
                msg += "opens";
     ...
     * instance of the {@link java.lang.reflect.Member#getDeclaringClass() declaring class}. For
     ...
     *              that is not a subclass of the {@link java.lang.reflect.Member#getDeclaringClass()
    ...
    public final boolean canAccess(Object obj) {
        ...
        if (this instanceof Constructor) {
            ...
            targetClass = java.lang.reflect.Modifier.isStatic(modifiers) ? null : obj.getClass();
        }
