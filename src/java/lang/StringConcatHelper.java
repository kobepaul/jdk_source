...
final class StringConcatHelper {
    ...
    private static int checkOverflow(int len) {
        if (len < 0) {
            throw new java.lang.OutOfMemoryError("Overflow: String length out of range");
        }
        return len;
    }
    ...
    static int mixLen(int current, int value) {
        return checkOverflow(current + java.lang.Integer.stringSize(value));
    }
    ...
    static int mixLen(int current, long value) {
        return checkOverflow(current + java.lang.Long.stringSize(value));
    }
     ...
     * @return new length
     */
    static int mixLen(int current, java.lang.String value) {
    ...
    static byte mixCoder(byte current, char value) {
        return (byte)(current | (java.lang.StringLatin1.canEncode(value) ? 0 : 1));
    }
     ...
     * @return new coder
     */
    static byte mixCoder(byte current, java.lang.String value) {
    ...
    static int prepend(int index, byte[] buf, byte coder, boolean value) {
        if (coder == java.lang.String.LATIN1) {
            if (value) {
                buf[--index] = 'e';
                buf[--index] = 'u';
                buf[--index] = 'r';
            ...
            if (value) {
                java.lang.StringUTF16.putChar(buf, --index, 'e');
                java.lang.StringUTF16.putChar(buf, --index, 'u');
                java.lang.StringUTF16.putChar(buf, --index, 'r');
                java.lang.StringUTF16.putChar(buf, --index, 't');
            } else {
                java.lang.StringUTF16.putChar(buf, --index, 'e');
                java.lang.StringUTF16.putChar(buf, --index, 's');
                java.lang.StringUTF16.putChar(buf, --index, 'l');
                java.lang.StringUTF16.putChar(buf, --index, 'a');
                java.lang.StringUTF16.putChar(buf, --index, 'f');
            }
        }
        return index;
    }
    ...
    static int prepend(int index, byte[] buf, byte coder, char value) {
        if (coder == java.lang.String.LATIN1) {
            ...
            java.lang.StringUTF16.putChar(buf, --index, value);
        }
        return index;
    }
    ...
    static int prepend(int index, byte[] buf, byte coder, int value) {
        if (coder == java.lang.String.LATIN1) {
            return java.lang.Integer.getChars(value, index, buf);
        } else {
            return java.lang.StringUTF16.getChars(value, index, buf);
        }
    }
    ...
    static int prepend(int index, byte[] buf, byte coder, long value) {
        if (coder == java.lang.String.LATIN1) {
            return java.lang.Long.getChars(value, index, buf);
        } else {
            return java.lang.StringUTF16.getChars(value, index, buf);
        }
    }
     ...
     * @return new index
     */
    static int prepend(int index, byte[] buf, byte coder, java.lang.String value) {
        index -= value.length();
     ...
     */
    static java.lang.String newString(byte[] buf, int index, byte coder) {
        // Use the private, non-copying constructor (unsafe!)
        if (index != 0) {
            throw new java.lang.InternalError("Storage is not completely initialized, " + index + " bytes left");
        }
    ...
    static byte initialCoder() {
        return java.lang.String.COMPACT_STRINGS ? java.lang.String.LATIN1 : java.lang.String.UTF16;
    }
