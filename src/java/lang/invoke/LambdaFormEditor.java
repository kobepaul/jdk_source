...
class LambdaFormEditor {
    ...
    java.lang.invoke.LambdaForm foldArgumentsForm(int foldPos, boolean dropResult, java.lang.invoke.MethodType combinerType) {
        int combinerArity = combinerType.parameterCount();
    ...
    java.lang.invoke.LambdaForm foldArgumentsForm(int foldPos, boolean dropResult, MethodType combinerType, int ... argPositions) {
    ...
    java.lang.invoke.LambdaForm permuteArgumentsForm(int skip, int[] reorder) {
        ...
        form = new java.lang.invoke.LambdaForm(arity2, names2, result2);
        return putInCache(key, form);
    }

    java.lang.invoke.LambdaForm noteLoopLocalTypesForm(int pos, BasicType[] localTypes) {
