 ...
 */
// public
interface BootstrapCallInfo<T> extends java.lang.invoke.ConstantGroup {
     ...
     * @param <T> the type of the invocation type, either {@link java.lang.invoke.MethodHandle} or {@link Class}
    ...
    static <T> BootstrapCallInfo<T> makeBootstrapCallInfo(MethodHandle bsm,
                                                          String name,
                                                          T type,
                                                          java.lang.invoke.ConstantGroup constants) {
