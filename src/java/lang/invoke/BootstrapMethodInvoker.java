...
final class BootstrapMethodInvoker {
    ...
    static <T> T invoke(Class<T> resultType,
        ...
        java.lang.invoke.MethodHandle pullModeBSM;
        ...
        try {
            ...
            if (info == null) {
                ...
                if (isStringConcatFactoryBSM(bootstrapMethod.type())) {
                    result = (java.lang.invoke.CallSite)bootstrapMethod
                            .invokeExact(caller, name, (java.lang.invoke.MethodType)type,
                ...
                java.lang.invoke.BootstrapCallInfo<Object> bsci
                ...
                java.lang.invoke.MethodType bsmType = bootstrapMethod.type();
                if (isLambdaMetafactoryIndyBSM(bsmType) && argv.length == 3) {
                    result = (java.lang.invoke.CallSite)bootstrapMethod
                            .invokeExact(caller, name, (java.lang.invoke.MethodType)type, (java.lang.invoke.MethodType)argv[0],
                                    (java.lang.invoke.MethodHandle)argv[1], (java.lang.invoke.MethodType)argv[2]);
                } else if (isLambdaMetafactoryCondyBSM(bsmType) && argv.length == 3) {
                    result = bootstrapMethod
                            .invokeExact(caller, name, (Class<?>)type, (java.lang.invoke.MethodType)argv[0],
                                    (java.lang.invoke.MethodHandle)argv[1], (java.lang.invoke.MethodType)argv[2]);
                    ...
                    result = (java.lang.invoke.CallSite)bootstrapMethod.invokeExact(caller, name, (java.lang.invoke.MethodType)type, recipe, shiftedArgs);
                } else if (isLambdaMetafactoryAltMetafactoryBSM(bsmType)) {
                    result = (java.lang.invoke.CallSite)bootstrapMethod.invokeExact(caller, name, (java.lang.invoke.MethodType)type, argv);
                } else {
                    switch (argv.length) {
                        case 0:
                            result = invoke(bootstrapMethod, caller, name, type);
            ...
            if (resultType.isPrimitive()) {
                ...
                java.lang.invoke.MethodHandle funnel = java.lang.invoke.MethodHandles.identity(resultType);
    ...
    private static Object invoke(java.lang.invoke.MethodHandle bootstrapMethod, Lookup caller,
                                 String name, Object type) throws Throwable {
        if (type instanceof Class) {
            return bootstrapMethod.invoke(caller, name, (Class<?>)type);
        } else {
            return bootstrapMethod.invoke(caller, name, (java.lang.invoke.MethodType)type);
        }
    }
    ...
    private static Object invoke(java.lang.invoke.MethodHandle bootstrapMethod, Lookup caller,
        ...
        if (type instanceof Class) {
            ...
            return bootstrapMethod.invoke(caller, name, (java.lang.invoke.MethodType)type, arg0);
        }
    }

    private static Object invoke(java.lang.invoke.MethodHandle bootstrapMethod, Lookup caller, String name,
                                 Object type, Object arg0, Object arg1) throws Throwable {
        if (type instanceof Class) {
            return bootstrapMethod.invoke(caller, name, (Class<?>)type, arg0, arg1);
        } else {
            return bootstrapMethod.invoke(caller, name, (java.lang.invoke.MethodType)type, arg0, arg1);
        }
    }
    ...
    private static Object invoke(java.lang.invoke.MethodHandle bootstrapMethod, Lookup caller, String name,
        ...
        if (type instanceof Class) {
            ...
            return bootstrapMethod.invoke(caller, name, (java.lang.invoke.MethodType)type, arg0, arg1, arg2);
        }
    }
    ...
    private static Object invoke(java.lang.invoke.MethodHandle bootstrapMethod, Lookup caller, String name,
        ...
        if (type instanceof Class) {
            ...
            return bootstrapMethod.invoke(caller, name, (java.lang.invoke.MethodType)type, arg0, arg1, arg2, arg3);
        }
    }
    ...
    private static Object invoke(java.lang.invoke.MethodHandle bootstrapMethod, Lookup caller,
        ...
        if (type instanceof Class) {
            ...
            return bootstrapMethod.invoke(caller, name, (java.lang.invoke.MethodType)type, arg0, arg1, arg2, arg3, arg4);
        }
    }
    ...
    private static Object invoke(java.lang.invoke.MethodHandle bootstrapMethod, Lookup caller,
        ...
        if (type instanceof Class) {
            ...
            return bootstrapMethod.invoke(caller, name, (java.lang.invoke.MethodType)type, arg0, arg1, arg2, arg3, arg4, arg5);
        }
    }

    private static Object invokeWithManyArguments(java.lang.invoke.MethodHandle bootstrapMethod, Lookup caller,
                                                  String name, Object type, Object[] argv) throws Throwable {
        final int NON_SPREAD_ARG_COUNT = 3;  // (caller, name, type)
        final int MAX_SAFE_SIZE = java.lang.invoke.MethodType.MAX_MH_ARITY / 2 - NON_SPREAD_ARG_COUNT;
        if (argv.length >= MAX_SAFE_SIZE) {
            ...
            java.lang.invoke.MethodType invocationType = java.lang.invoke.MethodType.genericMethodType(NON_SPREAD_ARG_COUNT + argv.length);
            java.lang.invoke.MethodHandle typedBSM = bootstrapMethod.asType(invocationType);
            java.lang.invoke.MethodHandle spreader = invocationType.invokers().spreadInvoker(NON_SPREAD_ARG_COUNT);
            return spreader.invokeExact(typedBSM, (Object) caller, (Object) name, type, argv);
        }
    }

    private static final java.lang.invoke.MethodType LMF_INDY_MT = java.lang.invoke.MethodType.methodType(java.lang.invoke.CallSite.class,
            Lookup.class, String.class, java.lang.invoke.MethodType.class, java.lang.invoke.MethodType.class, java.lang.invoke.MethodHandle.class, java.lang.invoke.MethodType.class);

    private static final java.lang.invoke.MethodType LMF_ALT_MT = java.lang.invoke.MethodType.methodType(java.lang.invoke.CallSite.class,
            Lookup.class, String.class, java.lang.invoke.MethodType.class, Object[].class);

    private static final java.lang.invoke.MethodType LMF_CONDY_MT = java.lang.invoke.MethodType.methodType(Object.class,
            Lookup.class, String.class, Class.class, java.lang.invoke.MethodType.class, java.lang.invoke.MethodHandle.class, java.lang.invoke.MethodType.class);

    private static final java.lang.invoke.MethodType SCF_MT = java.lang.invoke.MethodType.methodType(CallSite.class,
            Lookup.class, String.class, java.lang.invoke.MethodType.class, String.class, Object[].class);
     ...
     */
    private static boolean isStringConcatFactoryBSM(java.lang.invoke.MethodType bsmType) {
     ...
     */
    private static boolean isLambdaMetafactoryCondyBSM(java.lang.invoke.MethodType bsmType) {
     ...
     */
    private static boolean isLambdaMetafactoryIndyBSM(java.lang.invoke.MethodType bsmType) {
     ...
     */
    private static boolean isLambdaMetafactoryAltMetafactoryBSM(java.lang.invoke.MethodType bsmType) {
    ...
    private static final class VM_BSCI<T> extends BSCIWithCache<T> {
        ...
        VM_BSCI(java.lang.invoke.MethodHandle bsm, String name, T type,
    ...
    class PushAdapter {
        ...
        static Object pushToBootstrapMethod(java.lang.invoke.MethodHandle pullModeBSM,
                                            Lookup lookup, String name, Object type,
                                            Object... arguments) throws Throwable {
            java.lang.invoke.ConstantGroup cons = makeConstantGroup(Arrays.asList(arguments));
            java.lang.invoke.BootstrapCallInfo<?> bsci = makeBootstrapCallInfo(pullModeBSM, name, type, cons);
            if (TRACE_METHOD_LINKAGE)
                System.out.println("pull-mode BSM gets pushed arguments from fake BSCI");
            return pullModeBSM.invoke(lookup, bsci);
        }

        static final java.lang.invoke.MethodHandle MH_pushToBootstrapMethod;
        static {
            final Class<?> THIS_CLASS = PushAdapter.class;
            try {
                MH_pushToBootstrapMethod = IMPL_LOOKUP
                    .findStatic(THIS_CLASS, "pushToBootstrapMethod",
                                java.lang.invoke.MethodType.methodType(Object.class, java.lang.invoke.MethodHandle.class,
    ...
    class PullAdapter {
        ...
        static Object pullFromBootstrapMethod(java.lang.invoke.MethodHandle pushModeBSM,
                                              Lookup lookup,
                                              java.lang.invoke.BootstrapCallInfo<?> bsci)
                throws Throwable {
            int argc = bsci.size();
            switch (argc) {
                case 0:
                ...
                default:
                    ...
                    java.lang.invoke.MethodType invocationType = java.lang.invoke.MethodType.genericMethodType(NON_SPREAD_ARG_COUNT + argc);
                    java.lang.invoke.MethodHandle typedBSM = pushModeBSM.asType(invocationType);
                    java.lang.invoke.MethodHandle spreader = invocationType.invokers().spreadInvoker(NON_SPREAD_ARG_COUNT);
            ...
            try {
                MH_pullFromBootstrapMethod = IMPL_LOOKUP
                    .findStatic(THIS_CLASS, "pullFromBootstrapMethod",
                                MethodType.methodType(Object.class, java.lang.invoke.MethodHandle.class,
                                        Lookup.class, java.lang.invoke.BootstrapCallInfo.class));
            } catch (Throwable ex) {
                throw new InternalError(ex);
            }
        }
     ...
     */
    static java.lang.invoke.MethodHandle pushMePullYou(MethodHandle bsm, boolean goToPushMode) {
        if (TRACE_METHOD_LINKAGE) {
