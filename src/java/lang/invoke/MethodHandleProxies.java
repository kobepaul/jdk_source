...
public class MethodHandleProxies {
    ...
    <T> T asInterfaceInstance(final Class<T> intfc, final java.lang.invoke.MethodHandle target) {
        ...
        for (int i = 0; i < methods.length; i++) {
            Method sm = methods[i];
            java.lang.invoke.MethodType smMT = MethodType.methodType(sm.getReturnType(), sm.getParameterTypes());
    ...
    private static java.lang.invoke.MethodHandle bindCaller(java.lang.invoke.MethodHandle target, Class<?> hostClass) {
        return java.lang.invoke.MethodHandleImpl.bindCaller(target, hostClass).withVarargs(target.isVarargsCollector());
    }
