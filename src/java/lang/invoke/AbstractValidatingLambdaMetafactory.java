...
/* package */ abstract class AbstractValidatingLambdaMetafactory {
    ...
    final java.lang.invoke.MethodType implMethodType;          // Type of the implMethod MethodHandle "(CC,int)String"
    ...
    private void checkDescriptor(MethodType descriptor) throws java.lang.invoke.LambdaConversionException {
        for (int i = 0; i < instantiatedMethodType.parameterCount(); i++) {
            ...
            if (!descriptorParamType.isAssignableFrom(instantiatedParamType)) {
                ...
                throw new java.lang.invoke.LambdaConversionException(msg);
            }
        }
