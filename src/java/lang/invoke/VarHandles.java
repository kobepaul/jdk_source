...
final class VarHandles {
    ...
    static java.lang.invoke.VarHandle makeFieldHandle(java.lang.invoke.MemberName f, Class<?> refc, Class<?> type, boolean isWriteAllowedOnFinalFields) {
        if (!f.isStatic()) {
    ...
    static java.lang.invoke.VarHandle byteArrayViewHandle(Class<?> viewArrayClass,
                                                          boolean be) {
