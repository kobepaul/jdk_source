...
/*non-public*/ final class MemberName implements Member, Cloneable {
    ...
    public boolean isVarHandleMethodInvoke() {
        ...
        final int negs = Modifier.STATIC;
        if (testFlags(bits | negs, bits) &&
            clazz == java.lang.invoke.VarHandle.class) {
    ...
    public static boolean isVarHandleMethodInvokeName(String name) {
        try {
            java.lang.invoke.VarHandle.AccessMode.valueFromMethodName(name);
            return true;
    ...
    public MemberName(Method m, boolean wantSpecial) {
        ...
        if (clazz == null) {  // MHN.init failed
            ...
            if (m.getDeclaringClass() == java.lang.invoke.VarHandle.class &&
                ...
                MethodType type = MethodType.methodType(m.getReturnType(), m.getParameterTypes());
                int flags = flagsMods(IS_METHOD, m.getModifiers(), REF_invokeVirtual);
                init(java.lang.invoke.VarHandle.class, m.getName(), type, flags);
