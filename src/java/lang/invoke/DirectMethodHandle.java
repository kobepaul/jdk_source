...
class DirectMethodHandle extends java.lang.invoke.MethodHandle {
    ...
    // Factory methods:
    static DirectMethodHandle make(byte refKind, Class<?> refc, java.lang.invoke.MemberName member, Class<?> callerClass) {
        ...
        if (!member.isField()) {
            ...
            switch (refKind) {
                case REF_invokeSpecial: {
                    ...
                    java.lang.invoke.LambdaForm lform = preparedLambdaForm(member, callerClass.isInterface());
                ...
                case REF_invokeInterface: {
                    ...
                    java.lang.invoke.LambdaForm lform = preparedLambdaForm(member, true);
    ...
    static DirectMethodHandle make(Class<?> refc, java.lang.invoke.MemberName member) {
     ...
     */
    private static java.lang.invoke.LambdaForm preparedLambdaForm(java.lang.invoke.MemberName m, boolean adaptToSpecialIfc) {
    ...
    static java.lang.invoke.LambdaForm makePreparedLambdaForm(java.lang.invoke.MethodType mtype, int which) {
        ...
        String linkerName;
        java.lang.invoke.LambdaForm.Kind kind;
        switch (which) {
        ...
        java.lang.invoke.LambdaForm lform = new java.lang.invoke.LambdaForm(ARG_LIMIT, names, result, kind);
    ...
    private static void maybeCompile(java.lang.invoke.LambdaForm lform, java.lang.invoke.MemberName m) {
        if (lform.vmentry == null && VerifyAccess.isSamePackage(m.getDeclaringClass(), java.lang.invoke.MethodHandle.class))
    ...
    static class Special extends DirectMethodHandle {
        ...
        private Special(java.lang.invoke.MethodType mtype, java.lang.invoke.LambdaForm form, java.lang.invoke.MemberName member, Class<?> caller) {
        ...
        @Override
        java.lang.invoke.MethodHandle copyWith(java.lang.invoke.MethodType mt, java.lang.invoke.LambdaForm lf) {
            return new java.lang.invoke.DirectMethodHandle.Special(mt, lf, member, caller);
        }
    ...
    static java.lang.invoke.LambdaForm makePreparedFieldLambdaForm(byte formOp, boolean isVolatile, int ftypeKind) {
        ...
        java.lang.invoke.MemberName linker = new java.lang.invoke.MemberName(Unsafe.class, kind.methodName, linkerType, REF_invokeVirtual);
        try {
        ...
        if (isGetter)
            ...
            mtype = java.lang.invoke.MethodType.methodType(void.class, ft);
        ...
        if (needsCast || needsInit) {
            ...
            form = new java.lang.invoke.LambdaForm(ARG_LIMIT, names, RESULT);
        } else {
            form = new java.lang.invoke.LambdaForm(ARG_LIMIT, names, RESULT, kind);
        }

        if (java.lang.invoke.LambdaForm.debugNames()) {
            ...
            java.lang.invoke.LambdaForm.associateWithDebugName(form, nameBuilder.toString());
        }
        return form;
    }
    ...
    private static final java.lang.invoke.MethodType OBJ_OBJ_TYPE = java.lang.invoke.MethodType.methodType(Object.class, Object.class);

    private static final java.lang.invoke.MethodType LONG_OBJ_TYPE = java.lang.invoke.MethodType.methodType(long.class, Object.class);
        ...
        try {
            switch (func) {
                ...
                case NF_ensureInitialized:
                    return getNamedFunction("ensureInitialized", java.lang.invoke.MethodType.methodType(void.class, Object.class));
                case NF_fieldOffset:
                ...
                case NF_checkCast:
                    return getNamedFunction("checkCast", java.lang.invoke.MethodType.methodType(Object.class, Object.class, Object.class));
                ...
                case NF_UNSAFE:
                    java.lang.invoke.MemberName member = new java.lang.invoke.MemberName(MethodHandleStatics.class, "UNSAFE", Unsafe.class, REF_getField);
                ...
                case NF_checkReceiver:
                    member = new java.lang.invoke.MemberName(DirectMethodHandle.class, "checkReceiver", OBJ_OBJ_TYPE, REF_invokeVirtual);
                    return new NamedFunction(
                        java.lang.invoke.MemberName.getFactory()
    ...
    {
        java.lang.invoke.MemberName member = new java.lang.invoke.MemberName(DirectMethodHandle.class, name, type, REF_invokeStatic);
        return new NamedFunction(
            java.lang.invoke.MemberName.getFactory()
