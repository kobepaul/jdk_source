...
/*non-public*/
abstract class AbstractConstantGroup implements java.lang.invoke.ConstantGroup {
    ...
    static class AsIterator implements Iterator<Object> {
        private final java.lang.invoke.ConstantGroup self;
        ...
        private AsIterator(java.lang.invoke.ConstantGroup self, int start, int end,
        ...
        AsIterator(java.lang.invoke.ConstantGroup self, int start, int end) {
    ...
    static class SubGroup extends AbstractConstantGroup {
        private final java.lang.invoke.ConstantGroup self;  // the real CG
        private final int offset;  // offset within myself
        SubGroup(java.lang.invoke.ConstantGroup self, int start, int end) {
            super(end - start);
            this.self = self;
            this.offset = start;
        ...
        @Override
        public java.lang.invoke.ConstantGroup subGroup(int start, int end) {
            rangeCheck2(start, end, size);
            return new java.lang.invoke.AbstractConstantGroup.SubGroup(self, offset + start, offset + end);
        }

        @Override
        public List<Object> asList() {
            return new java.lang.invoke.AbstractConstantGroup.AsList(self, offset, offset + size);
        }

        @Override
        public List<Object> asList(Object ifNotPresent) {
            return new java.lang.invoke.AbstractConstantGroup.AsList(self, offset, offset + size, ifNotPresent);
        }
    ...
    static class AsList extends AbstractList<Object> {
        ...
        private AsList(java.lang.invoke.ConstantGroup self, int start, int end,
                       boolean resolving, Object ifNotPresent) {
            this.self = self;
            this.size = end - start;
            this.offset = start;
        ...
        AsList(java.lang.invoke.ConstantGroup self, int start, int end) {
            this(self, start, end, true, null);
        }
        AsList(java.lang.invoke.ConstantGroup self, int start, int end,
               Object ifNotPresent) {
    ...
    static
    class BSCIWithCache<T> extends WithCache implements java.lang.invoke.BootstrapCallInfo<T> {
        private final java.lang.invoke.MethodHandle bsm;
        ...
        BSCIWithCache(java.lang.invoke.MethodHandle bsm, String name, T type, int size) {
            super(size);
            this.type = type;
            this.bsm = bsm;
            this.name = name;
