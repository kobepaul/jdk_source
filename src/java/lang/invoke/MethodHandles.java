...
public class MethodHandles {
    ...
    static final java.lang.invoke.MemberName.Factory IMPL_NAMES = java.lang.invoke.MemberName.getFactory();
...
assertEquals("", (String) MH_newString.invokeExact());
        ...
        public java.lang.invoke.MethodHandle findVirtual(Class<?> refc, String name, java.lang.invoke.MethodType type) throws NoSuchMethodException, IllegalAccessException {
            ...
            } else if (refc == java.lang.invoke.VarHandle.class) {
                java.lang.invoke.MethodHandle mh = findVirtualForVH(name, type);
                if (mh != null)  return mh;
            }
        ...
        private java.lang.invoke.MethodHandle findVirtualForVH(String name, java.lang.invoke.MethodType type) {
            try {
                return varHandleInvoker(java.lang.invoke.VarHandle.AccessMode.valueFromMethodName(name), type);
...
assertEquals("[x, y, z]", pb.command().toString());
        ...
        public Class<?> accessClass(Class<?> targetClass) throws IllegalAccessException {
            if (!VerifyAccess.isClassAccessible(targetClass, lookupClass, allowedModes)) {
                throw new java.lang.invoke.MemberName(targetClass).makeAccessException("access violation", this);
            }
...
assertEquals(""+l, (String) MH_this.invokeExact(subl)); // Listie method
         ...
         * @since 9
         */
        public java.lang.invoke.VarHandle findVarHandle(Class<?> recv, String name, Class<?> type) throws NoSuchFieldException, IllegalAccessException {
            java.lang.invoke.MemberName getField = resolveOrFail(REF_getField, recv, name, type);
            java.lang.invoke.MemberName putField = resolveOrFail(REF_putField, recv, name, type);
         ...
         * @since 9
         */
        public java.lang.invoke.VarHandle findStaticVarHandle(Class<?> decl, String name, Class<?> type) throws NoSuchFieldException, IllegalAccessException {
            java.lang.invoke.MemberName getField = resolveOrFail(REF_getStatic, decl, name, type);
            java.lang.invoke.MemberName putField = resolveOrFail(REF_putStatic, decl, name, type);
...
return mh1;
        ...
        public java.lang.invoke.MethodHandle bind(Object receiver, String name, java.lang.invoke.MethodType type) throws NoSuchMethodException, IllegalAccessException {
            ...
            java.lang.invoke.MethodHandle mh = getDirectMethodNoRestrictInvokeSpecial(refc, method, findBoundCallerClass(method));
        ...
        public java.lang.invoke.MethodHandle unreflect(Method m) throws IllegalAccessException {
            ...
            if (m.getDeclaringClass() == java.lang.invoke.VarHandle.class) {
                java.lang.invoke.MethodHandle mh = unreflectForVH(m);
                if (mh != null)  return mh;
            }
        ...
        private java.lang.invoke.MethodHandle unreflectForVH(Method m) {
            // these names require special lookups because they throw UnsupportedOperationException
            if (java.lang.invoke.MemberName.isVarHandleMethodInvokeName(m.getName()))
                return MethodHandleImpl.fakeVarHandleInvoke(new java.lang.invoke.MemberName(m));
            return null;
        }
         ...
         * @since 9
         */
        public java.lang.invoke.VarHandle unreflectVarHandle(Field f) throws IllegalAccessException {
            java.lang.invoke.MemberName getField = new java.lang.invoke.MemberName(f, false);
            java.lang.invoke.MemberName putField = new java.lang.invoke.MemberName(f, true);
        ...
        java.lang.invoke.MemberName resolveOrNull(byte refKind, java.lang.invoke.MemberName member) {
        ...
        void checkSymbolicClass(Class<?> refc) throws IllegalAccessException {
            if (!isClassAccessible(refc)) {
                throw new java.lang.invoke.MemberName(refc).makeAccessException("symbolic reference class is not accessible", this);
            }
        }
        ...
        private java.lang.invoke.MethodHandle getDirectMethod(byte refKind, Class<?> refc, java.lang.invoke.MemberName method, Class<?> boundCallerClass) throws IllegalAccessException {
        ...
        private java.lang.invoke.MethodHandle getDirectMethodNoRestrictInvokeSpecial(Class<?> refc, java.lang.invoke.MemberName method, Class<?> boundCallerClass) throws IllegalAccessException {
            final boolean doRestrict    = false;
            final boolean checkSecurity = true;
            return getDirectMethodCommon(REF_invokeSpecial, refc, method, checkSecurity, doRestrict, boundCallerClass);
        }
        /** Check access and get the requested method, eliding security manager checks. */
        private java.lang.invoke.MethodHandle getDirectMethodNoSecurityManager(byte refKind, Class<?> refc, java.lang.invoke.MemberName method, Class<?> boundCallerClass) throws IllegalAccessException {
            final boolean doRestrict    = true;
        ...
        private java.lang.invoke.VarHandle getFieldVarHandle(byte getRefKind, byte putRefKind,
                                                             Class<?> refc, java.lang.invoke.MemberName getField, java.lang.invoke.MemberName putField)
                throws IllegalAccessException {
            final boolean checkSecurity = true;
            return getFieldVarHandleCommon(getRefKind, putRefKind, refc, getField, putField, checkSecurity);
        }
        private java.lang.invoke.VarHandle getFieldVarHandleNoSecurityManager(byte getRefKind, byte putRefKind,
                                                                              Class<?> refc, java.lang.invoke.MemberName getField, java.lang.invoke.MemberName putField)
                throws IllegalAccessException {
            final boolean checkSecurity = false;
            return getFieldVarHandleCommon(getRefKind, putRefKind, refc, getField, putField, checkSecurity);
        }
        private java.lang.invoke.VarHandle getFieldVarHandleCommon(byte getRefKind, byte putRefKind,
                                                                   Class<?> refc, java.lang.invoke.MemberName getField, java.lang.invoke.MemberName putField,
                                                                   boolean checkSecurity) throws IllegalAccessException {
            ...
            return java.lang.invoke.VarHandles.makeFieldHandle(getField, refc, getField.getFieldType(), this.allowedModes == TRUSTED);
        }
        ...
        java.lang.invoke.MethodHandle linkMethodHandleConstant(byte refKind, Class<?> defc, String name, Object type) throws ReflectiveOperationException {
            ...
            } else if (defc == java.lang.invoke.VarHandle.class && refKind == REF_invokeVirtual) {
        ...
        boolean canBeCached(byte refKind, Class<?> defc, java.lang.invoke.MemberName member) {
            ...
            try {
                java.lang.invoke.MemberName resolved2 = publicLookup().resolveOrNull(refKind,
     ...
     * @since 9
     */
    public static java.lang.invoke.MethodHandle arrayConstructor(Class<?> arrayClass) throws IllegalArgumentException {
        if (!arrayClass.isArray()) {
            throw newIllegalArgumentException("not an array class: " + arrayClass.getName());
        }
        java.lang.invoke.MethodHandle ani = MethodHandleImpl.getConstantHandle(MethodHandleImpl.MH_Array_newInstance).
     ...
     * @since 9
     */
    public static java.lang.invoke.MethodHandle arrayLength(Class<?> arrayClass) throws IllegalArgumentException {
     ...
     * @since 9
     */
    public static java.lang.invoke.VarHandle arrayElementVarHandle(Class<?> arrayClass) throws IllegalArgumentException {
        return java.lang.invoke.VarHandles.makeArrayElementHandle(arrayClass);
    }
     ...
     * @since 9
     */
    public static java.lang.invoke.VarHandle byteArrayViewVarHandle(Class<?> viewArrayClass,
                                                                    ByteOrder byteOrder) throws IllegalArgumentException {
        Objects.requireNonNull(byteOrder);
        return java.lang.invoke.VarHandles.byteArrayViewHandle(viewArrayClass,
     ...
     * @since 9
     */
    public static java.lang.invoke.VarHandle byteBufferViewVarHandle(Class<?> viewArrayClass,
                                                                     ByteOrder byteOrder) throws IllegalArgumentException {
        Objects.requireNonNull(byteOrder);
        return java.lang.invoke.VarHandles.makeByteBufferViewHandle(viewArrayClass,
                                                   byteOrder == ByteOrder.BIG_ENDIAN);
    }
...
return invoker;
     ...
     * @since 9
     */
    static public java.lang.invoke.MethodHandle varHandleExactInvoker(java.lang.invoke.VarHandle.AccessMode accessMode, java.lang.invoke.MethodType type) {
     ...
     * @since 9
     */
    static public java.lang.invoke.MethodHandle varHandleInvoker(VarHandle.AccessMode accessMode, java.lang.invoke.MethodType type) {
...
assert((int)twice.invokeExact(21) == 42);
     * }</pre></blockquote>
     * <p>
     * <em>Note:</em> The resulting adapter is never a {@linkplain java.lang.invoke.MethodHandle#asVarargsCollector
     ...
     * @since 9
     */
    public static java.lang.invoke.MethodHandle zero(Class<?> type) {
        Objects.requireNonNull(type);
        return type.isPrimitive() ?  zero(Wrapper.forPrimitiveType(type), type) : zero(Wrapper.OBJECT, type);
    }

    private static java.lang.invoke.MethodHandle identityOrVoid(Class<?> type) {
    ...
    private static final java.lang.invoke.MethodHandle[] IDENTITY_MHS = new java.lang.invoke.MethodHandle[Wrapper.COUNT];
    private static java.lang.invoke.MethodHandle makeIdentity(Class<?> ptype) {
        java.lang.invoke.MethodType mtype = methodType(ptype, ptype);
    ...
    private static final java.lang.invoke.MethodHandle[] ZERO_MHS = new java.lang.invoke.MethodHandle[Wrapper.COUNT];
    private static java.lang.invoke.MethodHandle makeZero(Class<?> rtype) {
        java.lang.invoke.MethodType mtype = methodType(rtype);
        java.lang.invoke.LambdaForm lform = java.lang.invoke.LambdaForm.zeroForm(BasicType.basicType(rtype));
        return MethodHandleImpl.makeIntrinsic(mtype, lform, Intrinsic.ZERO);
    }

    private static synchronized java.lang.invoke.MethodHandle setCachedMethodHandle(java.lang.invoke.MethodHandle[] cache, int pos, java.lang.invoke.MethodHandle value) {
...
assertEquals("yz", (String) d0.invokeExact(123, "x", "y", "z"));
    ...
    private static java.lang.invoke.MethodHandle dropArguments0(java.lang.invoke.MethodHandle target, int pos, List<Class<?>> valueTypes) {
...
assertEquals("xz", (String) d12.invokeExact("x", 12, true, "z"));
    ...
    private static java.lang.invoke.MethodHandle dropArgumentsToMatch(java.lang.invoke.MethodHandle target, int skip, List<Class<?>> newTypes, int pos,
     ...
     * {@link #dropArguments(java.lang.invoke.MethodHandle, int, Class[])}.
     * <p>
...
assertEquals("xy", h3.invoke("x", "y", 1, "a", "b", "c"));
     ...
     * @since 9
     */
    public static java.lang.invoke.MethodHandle dropArgumentsToMatch(java.lang.invoke.MethodHandle target, int skip, List<Class<?>> newTypes, int pos) {
...
assertEquals("XY", (String) f2.invokeExact("x", "y")); // XY
    ...
    public static java.lang.invoke.MethodHandle filterArguments(java.lang.invoke.MethodHandle target, int pos, java.lang.invoke.MethodHandle... filters) {
        ...
        for (int i = filters.length - 1; i >= 0; --i) {
            java.lang.invoke.MethodHandle filter = filters[i];
...
assertEquals("boojum", (String) catTrace.invokeExact("boo", "jum"));
     ...
     * <p>
     * This method is closely related to {@link #foldArguments(java.lang.invoke.MethodHandle, java.lang.invoke.MethodHandle)}, but allows to control the
     * position in the parameter list at which folding takes place. The argument controlling this, {@code pos}, is a
     * zero-based index. The aforementioned method {@link #foldArguments(java.lang.invoke.MethodHandle, java.lang.invoke.MethodHandle)} assumes position
     * 0.
     *
     * @apiNote Example:
     * <blockquote><pre>{@code
     ...
     *            0}, the effect is the same as for {@link #foldArguments(java.lang.invoke.MethodHandle, java.lang.invoke.MethodHandle)}.
     * @param combiner method handle to call initially on the incoming arguments
     * @return method handle which incorporates the specified argument folding logic
     * @throws NullPointerException if either argument is null
     ...
     *
     * @see #foldArguments(java.lang.invoke.MethodHandle, java.lang.invoke.MethodHandle)
     * @since 9
     */
    public static java.lang.invoke.MethodHandle foldArguments(java.lang.invoke.MethodHandle target, int pos, java.lang.invoke.MethodHandle combiner) {
        ...
        java.lang.invoke.LambdaForm lform = result.editor().foldArgumentsForm(1 + pos, dropResult, combinerType.basicType());
     ...
     */
    static java.lang.invoke.MethodHandle foldArguments(java.lang.invoke.MethodHandle target, int pos, java.lang.invoke.MethodHandle combiner, int ... argPositions) {
        java.lang.invoke.MethodType targetType = target.type();
        java.lang.invoke.MethodType combinerType = combiner.type();
        Class<?> rtype = foldArgumentChecks(pos, targetType, combinerType, argPositions);
        BoundMethodHandle result = target.rebind();
        boolean dropResult = rtype == void.class;
        java.lang.invoke.LambdaForm lform = result.editor().foldArgumentsForm(1 + pos, dropResult, combinerType.basicType(), argPositions);
        java.lang.invoke.MethodType newType = targetType;
        if (!dropResult) {
            newType = newType.dropParameterTypes(pos, pos + 1);
        }
    ...
    private static Class<?> foldArgumentChecks(int foldPos, java.lang.invoke.MethodType targetType, java.lang.invoke.MethodType combinerType, int ... argPos) {
        int foldArgs = combinerType.parameterCount();
     ...
     * @see MethodHandles#tryFinally(java.lang.invoke.MethodHandle, java.lang.invoke.MethodHandle)
     */
     ...
     * @throws NullPointerException if either argument is null
     */
    public static java.lang.invoke.MethodHandle throwException(Class<?> returnType, Class<? extends Throwable> exType) {
        if (!Throwable.class.isAssignableFrom(exType))
            throw new ClassCastException(exType.getName());
     ...
     * <li>Argument lists are padded out by {@linkplain #dropArgumentsToMatch(java.lang.invoke.MethodHandle, int, List, int) dropping unused trailing arguments}.
     * </ol>
     * <p>
     ...
     * As noted above, missing parameters are filled in as if by {@link #dropArgumentsToMatch(java.lang.invoke.MethodHandle, int, List, int)}.
     *
     * @apiNote Example:
     * <blockquote><pre>{@code
     ...
     * }</pre></blockquote>
     *
     * @param clauses an array of arrays (4-tuples) of {@link java.lang.invoke.MethodHandle}s adhering to the rules described above.
     *
     ...
     *
     * @see MethodHandles#whileLoop(java.lang.invoke.MethodHandle, java.lang.invoke.MethodHandle, java.lang.invoke.MethodHandle)
     * @see MethodHandles#doWhileLoop(java.lang.invoke.MethodHandle, java.lang.invoke.MethodHandle, java.lang.invoke.MethodHandle)
     * @see MethodHandles#countedLoop(java.lang.invoke.MethodHandle, java.lang.invoke.MethodHandle, java.lang.invoke.MethodHandle)
     * @see MethodHandles#iteratedLoop(java.lang.invoke.MethodHandle, java.lang.invoke.MethodHandle, java.lang.invoke.MethodHandle)
     * @since 9
     */
    public static java.lang.invoke.MethodHandle loop(java.lang.invoke.MethodHandle[]... clauses) {
        // Step 0: determine clause structure.
        loopChecks0(clauses);

        List<java.lang.invoke.MethodHandle> init = new ArrayList<>();
        List<java.lang.invoke.MethodHandle> step = new ArrayList<>();
        List<java.lang.invoke.MethodHandle> pred = new ArrayList<>();
        List<java.lang.invoke.MethodHandle> fini = new ArrayList<>();
        ...
        for (int i = 0; i < nclauses; ++i) {
            java.lang.invoke.MethodHandle in = init.get(i);
            java.lang.invoke.MethodHandle st = step.get(i);
            if (in == null && st == null) {
        ...
        final Class<?> loopReturnType = fini.stream().filter(Objects::nonNull).map(java.lang.invoke.MethodHandle::type).
                map(java.lang.invoke.MethodType::returnType).findFirst().orElse(void.class);
        ...
        List<java.lang.invoke.MethodHandle> finit = fixArities(fillParameterTypes(init, commonSuffix));
        List<java.lang.invoke.MethodHandle> fstep = fixArities(fillParameterTypes(step, commonParameterSequence));
        List<java.lang.invoke.MethodHandle> fpred = fixArities(fillParameterTypes(pred, commonParameterSequence));
        List<java.lang.invoke.MethodHandle> ffini = fixArities(fillParameterTypes(fini, commonParameterSequence));

        assert finit.stream().map(java.lang.invoke.MethodHandle::type).map(java.lang.invoke.MethodType::parameterList).
                allMatch(pl -> pl.equals(commonSuffix));
        assert Stream.of(fstep, fpred, ffini).flatMap(List::stream).map(java.lang.invoke.MethodHandle::type).map(java.lang.invoke.MethodType::parameterList).
    ...
    private static void loopChecks0(java.lang.invoke.MethodHandle[][] clauses) {
    ...
    private static void loopChecks1a(int i, java.lang.invoke.MethodHandle in, java.lang.invoke.MethodHandle st) {
    ...
    private static List<Class<?>> longestParameterList(Stream<java.lang.invoke.MethodHandle> mhs, int skipSize) {
        ...
        final List<Class<?>> longest = mhs.filter(Objects::nonNull).
                // take only those that can contribute to a common suffix because they are longer than the prefix
                        map(java.lang.invoke.MethodHandle::type).
                        filter(t -> t.parameterCount() > skipSize).
                        map(java.lang.invoke.MethodType::parameterList).
    ...
    private static List<Class<?>> buildCommonSuffix(List<java.lang.invoke.MethodHandle> init, List<java.lang.invoke.MethodHandle> step, List<java.lang.invoke.MethodHandle> pred, List<java.lang.invoke.MethodHandle> fini, int cpSize) {
    ...
    private static void loopChecks1b(List<java.lang.invoke.MethodHandle> init, List<Class<?>> commonSuffix) {
        if (init.stream().filter(Objects::nonNull).map(java.lang.invoke.MethodHandle::type).
    ...
    private static void loopChecks1cd(List<java.lang.invoke.MethodHandle> pred, List<java.lang.invoke.MethodHandle> fini, Class<?> loopReturnType) {
        if (fini.stream().filter(Objects::nonNull).map(java.lang.invoke.MethodHandle::type).map(java.lang.invoke.MethodType::returnType).
        ...
        if (pred.stream().filter(Objects::nonNull).map(java.lang.invoke.MethodHandle::type).map(java.lang.invoke.MethodType::returnType).
                anyMatch(t -> t != boolean.class)) {
            throw newIllegalArgumentException("predicates must have boolean return type", pred);
        }
    }

    private static void loopChecks2(List<java.lang.invoke.MethodHandle> step, List<java.lang.invoke.MethodHandle> pred, List<java.lang.invoke.MethodHandle> fini, List<Class<?>> commonParameterSequence) {
        if (Stream.of(step, pred, fini).flatMap(List::stream).filter(Objects::nonNull).map(java.lang.invoke.MethodHandle::type).
    ...
    private static List<java.lang.invoke.MethodHandle> fillParameterTypes(List<java.lang.invoke.MethodHandle> hs, final List<Class<?>> targetParams) {
    ...
    private static List<java.lang.invoke.MethodHandle> fixArities(List<java.lang.invoke.MethodHandle> hs) {
        return hs.stream().map(java.lang.invoke.MethodHandle::asFixedArity).collect(Collectors.toList());
    }

    /**
     * Constructs a {@code while} loop from an initializer, a body, and a predicate.
     * This is a convenience wrapper for the {@linkplain #loop(java.lang.invoke.MethodHandle[][]) generic loop combinator}.
     * <p>
     ...
     *
     * @see #loop(java.lang.invoke.MethodHandle[][])
     * @see #doWhileLoop(java.lang.invoke.MethodHandle, java.lang.invoke.MethodHandle, java.lang.invoke.MethodHandle)
     * @since 9
     */
    public static java.lang.invoke.MethodHandle whileLoop(java.lang.invoke.MethodHandle init, java.lang.invoke.MethodHandle pred, java.lang.invoke.MethodHandle body) {
        ...
        java.lang.invoke.MethodHandle fini = identityOrVoid(body.type().returnType());
        java.lang.invoke.MethodHandle[] checkExit = { null, null, pred, fini };
        java.lang.invoke.MethodHandle[] varBody = { init, body };
        return loop(checkExit, varBody);
    }
     ...
     *
     * @see #loop(java.lang.invoke.MethodHandle[][])
     * @see #whileLoop(java.lang.invoke.MethodHandle, java.lang.invoke.MethodHandle, java.lang.invoke.MethodHandle)
     * @since 9
     */
    public static java.lang.invoke.MethodHandle doWhileLoop(java.lang.invoke.MethodHandle init, java.lang.invoke.MethodHandle body, java.lang.invoke.MethodHandle pred) {
        whileLoopChecks(init, pred, body);
        java.lang.invoke.MethodHandle fini = identityOrVoid(body.type().returnType());
        java.lang.invoke.MethodHandle[] clause = {init, body, pred, fini };
        return loop(clause);
    }

    private static void whileLoopChecks(java.lang.invoke.MethodHandle init, java.lang.invoke.MethodHandle pred, java.lang.invoke.MethodHandle body) {
        Objects.requireNonNull(pred);
        Objects.requireNonNull(body);
        java.lang.invoke.MethodType bodyType = body.type();
        ...
        if (returnType == void.class) {
            ...
            java.lang.invoke.MethodType expected = bodyType.insertParameterTypes(0, returnType);
            throw misMatchedTypes("body function", bodyType, expected);
        } else {
            outerList = innerList.subList(1, innerList.size());
        }
        java.lang.invoke.MethodType predType = pred.type();
        ...
        if (init != null) {
            java.lang.invoke.MethodType initType = init.type();
     ...
     * }</pre></blockquote>
     *
     * @apiNote Example that illustrates the usage of {@link #dropArgumentsToMatch(java.lang.invoke.MethodHandle, int, List, int)}
     ...
     *
     * @see #countedLoop(java.lang.invoke.MethodHandle, java.lang.invoke.MethodHandle, java.lang.invoke.MethodHandle, java.lang.invoke.MethodHandle)
     * @since 9
     */
     ...
     * @throws IllegalArgumentException if any argument violates the rules formulated above.
     *
     * @see #countedLoop(java.lang.invoke.MethodHandle, java.lang.invoke.MethodHandle, java.lang.invoke.MethodHandle)
     * @since 9
     */
    public static java.lang.invoke.MethodHandle countedLoop(java.lang.invoke.MethodHandle start, java.lang.invoke.MethodHandle end, java.lang.invoke.MethodHandle init, java.lang.invoke.MethodHandle body) {
        ...
        Class<?> returnType  = body.type().returnType();
        java.lang.invoke.MethodHandle incr = MethodHandleImpl.getConstantHandle(MethodHandleImpl.MH_countedLoopStep);
        java.lang.invoke.MethodHandle pred = MethodHandleImpl.getConstantHandle(MethodHandleImpl.MH_countedLoopPred);
        java.lang.invoke.MethodHandle retv = null;
        if (returnType != void.class) {
            incr = dropArguments(incr, 1, returnType);  // (limit, v, i) => (limit, i)
            pred = dropArguments(pred, 1, returnType);  // ditto
    ...
    private static void countedLoopChecks(java.lang.invoke.MethodHandle start, java.lang.invoke.MethodHandle end, java.lang.invoke.MethodHandle init, java.lang.invoke.MethodHandle body) {
        Objects.requireNonNull(start);
        Objects.requireNonNull(end);
        Objects.requireNonNull(body);
        Class<?> counterType = start.type().returnType();
        if (counterType != int.class) {
            java.lang.invoke.MethodType expected = start.type().changeReturnType(int.class);
            throw misMatchedTypes("start function", start.type(), expected);
        } else if (end.type().returnType() != counterType) {
            java.lang.invoke.MethodType expected = end.type().changeReturnType(counterType);
        ...
        if (vsize != 0 && (innerList.size() == 0 || innerList.get(0) != returnType)) {
            ...
            java.lang.invoke.MethodType expected = bodyType.insertParameterTypes(vsize, counterType);
            throw misMatchedTypes("body function", bodyType, expected);
        }
        ...
        java.lang.invoke.MethodType expected = methodType(counterType, outerList);
     ...
     * the {@link java.lang.invoke.MethodHandle#asType asType} conversion method.
     ...
     * as if by the {@link java.lang.invoke.MethodHandle#asType asType} conversion method.
     * Therefore, if an iterator of the wrong type appears as the loop is executed, runtime exceptions may occur
     * as the result of dynamic conversions performed by {@link java.lang.invoke.MethodHandle#asType(java.lang.invoke.MethodType)}.
     * <p>
     * The resulting loop handle's result type and parameter signature are determined as follows:<ul>
     * <li>The loop handle's result type is the result type {@code V} of the body.
     * <li>The loop handle's parameter types are the types {@code (A...)},
    ...
    public static java.lang.invoke.MethodHandle iteratedLoop(java.lang.invoke.MethodHandle iterator, java.lang.invoke.MethodHandle init, java.lang.invoke.MethodHandle body) {
        ...
        Class<?> returnType = body.type().returnType();
        java.lang.invoke.MethodHandle hasNext = MethodHandleImpl.getConstantHandle(MethodHandleImpl.MH_iteratePred);
        java.lang.invoke.MethodHandle nextRaw = MethodHandleImpl.getConstantHandle(MethodHandleImpl.MH_iterateNext);
        java.lang.invoke.MethodHandle startIter;
        java.lang.invoke.MethodHandle nextVal;
        {
            java.lang.invoke.MethodType iteratorType;
            if (iterator == null) {
            ...
            Class<?> ttype = body.type().parameterType(returnType == void.class ? 0 : 1);
            java.lang.invoke.MethodType nextValType = nextRaw.type().changeReturnType(ttype);
        ...
        java.lang.invoke.MethodHandle retv = null, step = body;
        if (returnType != void.class) {
            // the simple thing first:  in (I V A...), drop the I to get V
            retv = dropArguments(identity(returnType), 0, Iterator.class);
            // body type signature (V T A...), internal loop types (I V A...)
    ...
    private static Class<?> iteratedLoopChecks(java.lang.invoke.MethodHandle iterator, java.lang.invoke.MethodHandle init, java.lang.invoke.MethodHandle body) {
        Objects.requireNonNull(body);
        java.lang.invoke.MethodType bodyType = body.type();
        Class<?> returnType = bodyType.returnType();
        ...
        if (vsize != 0 && (internalParamList.size() == 0 || internalParamList.get(0) != returnType)) {
            ...
            java.lang.invoke.MethodType expected = bodyType.insertParameterTypes(vsize, Object.class);
            throw misMatchedTypes("body function", bodyType, expected);
        }
        ...
        if (iterator != null) {
            ...
            java.lang.invoke.MethodType itype = iterator.type();
            ...
            if (!itype.effectivelyIdenticalParameters(0, externalParamList)) {
                java.lang.invoke.MethodType expected = methodType(itype.returnType(), externalParamList);
    ...
    /*non-public*/ static java.lang.invoke.MethodHandle swapArguments(java.lang.invoke.MethodHandle mh, int i, int j) {
        ...
        java.lang.invoke.MethodType swapType = methodType(mh.type().returnType(), types);
     ...
     * the target with {@link #catchException(java.lang.invoke.MethodHandle, Class, java.lang.invoke.MethodHandle)}
     ...
     *
     * @see MethodHandles#catchException(java.lang.invoke.MethodHandle, Class, java.lang.invoke.MethodHandle)
     * @since 9
     */
    ...
    private static void tryFinallyChecks(java.lang.invoke.MethodHandle target, MethodHandle cleanup) {
        Class<?> rtype = target.type().returnType();
