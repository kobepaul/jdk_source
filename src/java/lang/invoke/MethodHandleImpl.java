...
/*non-public*/ abstract class MethodHandleImpl {
    ...
    static java.lang.invoke.MethodHandle makeArrayElementAccessor(Class<?> arrayClass, ArrayAccess access) {
        ...
        java.lang.invoke.MethodType correctType = ArrayAccessor.correctType(arrayClass, access);
    ...
    enum ArrayAccess {
        ...
        static java.lang.invoke.MethodHandle objectAccessor(ArrayAccess a) {
            switch (a) {
    ...
    static final class ArrayAccessor {
        ...
        static final java.lang.invoke.MethodHandle OBJECT_ARRAY_GETTER, OBJECT_ARRAY_SETTER, OBJECT_ARRAY_LENGTH;
        static {
        ...
        static java.lang.invoke.MethodType type(Class<?> arrayClass, ArrayAccess access) {
            Class<?> elemClass = arrayClass.getComponentType();
            ...
            switch (access) {
                case GET:    return java.lang.invoke.MethodType.methodType(elemClass,  arrayArgClass, int.class);
                case SET:    return java.lang.invoke.MethodType.methodType(void.class, arrayArgClass, int.class, elemClass);
                case LENGTH: return java.lang.invoke.MethodType.methodType(int.class,  arrayArgClass);
            }
            throw unmatchedArrayAccess(access);
        }
        static java.lang.invoke.MethodType correctType(Class<?> arrayClass, ArrayAccess access) {
            Class<?> elemClass = arrayClass.getComponentType();
            switch (access) {
                case GET:    return java.lang.invoke.MethodType.methodType(elemClass,  arrayClass, int.class);
                case SET:    return java.lang.invoke.MethodType.methodType(void.class, arrayClass, int.class, elemClass);
                case LENGTH: return java.lang.invoke.MethodType.methodType(int.class,  arrayClass);
            }
            throw unmatchedArrayAccess(access);
        }
        static java.lang.invoke.MethodHandle getAccessor(Class<?> arrayClass, ArrayAccess access) {
            String     name = name(arrayClass, access);
            java.lang.invoke.MethodType type = type(arrayClass, access);
            try {
    ...
    static java.lang.invoke.MethodHandle makePairwiseConvertIndirect(java.lang.invoke.MethodHandle target, java.lang.invoke.MethodType srcType,
        ...
        java.lang.invoke.LambdaForm form = new java.lang.invoke.LambdaForm(lambdaType.parameterCount(), names, RESULT, Kind.CONVERT);
    ...
    private static final class AsVarargsCollector extends DelegatingMethodHandle {
        ...
        @Override
        public java.lang.invoke.MethodHandle withVarargs(boolean makeVarargs) {
        ...
        public Object invokeWithArguments(Object... arguments) throws Throwable {
            ...
            if (!elemType.isPrimitive()) {
                ...
                java.lang.invoke.MethodHandle arraySetter = java.lang.invoke.MethodHandles.arrayElementSetter(arrayType);
                try {
    ...
    static java.lang.invoke.MethodHandle makeSpreadArguments(java.lang.invoke.MethodHandle target,
        ...
        java.lang.invoke.LambdaForm form = new java.lang.invoke.LambdaForm(lambdaType.parameterCount(), names, Kind.SPREAD);
        return SimpleMethodHandle.make(srcType, form);
    }
    ...
    static java.lang.invoke.MethodHandle makeCollectArguments(java.lang.invoke.MethodHandle target,
        ...
        java.lang.invoke.LambdaForm form = new java.lang.invoke.LambdaForm(lambdaType.parameterCount(), names, Kind.COLLECT);
        return SimpleMethodHandle.make(srcType, form);
    }
    ...
    private final static class Makers {
        ...
        static final Function<java.lang.invoke.MethodHandle, java.lang.invoke.LambdaForm> PRODUCE_BLOCK_INLINING_FORM = new Function<java.lang.invoke.MethodHandle, java.lang.invoke.LambdaForm>() {
            @Override
            public java.lang.invoke.LambdaForm apply(java.lang.invoke.MethodHandle target) {
                return DelegatingMethodHandle.makeReinvokerForm(target,
                                   java.lang.invoke.MethodTypeForm.LF_DELEGATE_BLOCK_INLINING, CountingWrapper.class, false,
        ...
        static final Function<java.lang.invoke.MethodHandle, java.lang.invoke.LambdaForm> PRODUCE_REINVOKER_FORM = new Function<java.lang.invoke.MethodHandle, java.lang.invoke.LambdaForm>() {
            @Override
            public java.lang.invoke.LambdaForm apply(java.lang.invoke.MethodHandle target) {
                return DelegatingMethodHandle.makeReinvokerForm(target,
        ...
        static final ClassValue<java.lang.invoke.MethodHandle[]> TYPED_COLLECTORS = new ClassValue<java.lang.invoke.MethodHandle[]>() {
            @Override
            protected java.lang.invoke.MethodHandle[] computeValue(Class<?> type) {
                return new java.lang.invoke.MethodHandle[MAX_JVM_ARITY + 1];
            }
        };
    }
    ...
    static java.lang.invoke.LambdaForm makeGuardWithTestForm(java.lang.invoke.MethodType basicType) {
        ...
        lform = new java.lang.invoke.LambdaForm(lambdaType.parameterCount(), names, /*forceInline=*/true, Kind.GUARD);
    ...
    private static java.lang.invoke.LambdaForm makeGuardWithCatchForm(java.lang.invoke.MethodType basicType) {
        ...
        lform = new java.lang.invoke.LambdaForm(lambdaType.parameterCount(), names, Kind.GUARD_WITH_CATCH);
    ...
    static java.lang.invoke.MethodHandle makeGuardWithCatch(java.lang.invoke.MethodHandle target,
        ...
        java.lang.invoke.MethodHandle unboxResult = unboxResultHandle(type.returnType());
    ...
    static java.lang.invoke.MethodHandle throwException(java.lang.invoke.MethodType type) {
        ...
        if (arity > 1) {
            ...
            mh = java.lang.invoke.MethodHandles.dropArguments(mh, 1, Arrays.copyOfRange(type.parameterArray(), 1, arity));
            return mh;
        }
    ...
    static java.lang.invoke.MethodHandle fakeVarHandleInvoke(java.lang.invoke.MemberName method) {
        ...
        java.lang.invoke.MethodType type = java.lang.invoke.MethodType.methodType(method.getReturnType(), UnsupportedOperationException.class,
                                                VarHandle.class, Object[].class);
        java.lang.invoke.MethodHandle mh = throwException(type);
    ...
    private static class BindCaller {
        private static java.lang.invoke.MethodType INVOKER_MT = java.lang.invoke.MethodType.methodType(Object.class, java.lang.invoke.MethodHandle.class, Object[].class);
        ...
        private static boolean checkInjectedInvoker(Class<?> hostClass, Class<?> invokerClass) {
            ...
            try {
                ...
                java.lang.invoke.MethodHandle invoker = IMPL_LOOKUP.findStatic(invokerClass, "invoke_V", INVOKER_MT);
    ...
    static final class IntrinsicMethodHandle extends DelegatingMethodHandle {
        ...
        public java.lang.invoke.MethodHandle asCollector(Class<?> arrayType, int arrayLength) {
            if (intrinsicName == Intrinsic.IDENTITY) {
                java.lang.invoke.MethodType resultType = type().asCollectorType(arrayType, type().parameterCount() - 1, arrayLength);
    ...
    private static final @Stable java.lang.invoke.MethodHandle[] ARRAYS = new java.lang.invoke.MethodHandle[MAX_ARITY + 1];
    ...
    private static final @Stable java.lang.invoke.MethodHandle[] FILL_ARRAYS = new java.lang.invoke.MethodHandle[FILL_ARRAYS_COUNT];

    private static java.lang.invoke.MethodHandle getFillArray(int count) {
        assert (count > 0 && count < FILL_ARRAYS_COUNT);
        java.lang.invoke.MethodHandle mh = FILL_ARRAYS[count];
        if (mh != null) {
            return mh;
        }
    ...
    static java.lang.invoke.MethodHandle varargsArray(int nargs) {
        java.lang.invoke.MethodHandle mh = ARRAYS[nargs];
        if (mh != null) {
            return mh;
        }
    ...
    private static final @Stable java.lang.invoke.MethodHandle[] FILL_ARRAY_TO_RIGHT = new java.lang.invoke.MethodHandle[MAX_ARITY + 1];
    ...
    private static java.lang.invoke.MethodHandle buildFiller(int nargs) {
        ...
        java.lang.invoke.MethodHandle rightFill = getFillArray(rightLen).bindTo(midLen);  // [midLen..nargs-1]
    ...
    static java.lang.invoke.MethodHandle varargsArray(Class<?> arrayType, int nargs) {
        ...
        java.lang.invoke.MethodHandle cache[] = Makers.TYPED_COLLECTORS.get(elemType);
        ...
        if (nargs == 0) {
            ...
            mh = java.lang.invoke.MethodHandles.constant(arrayType, example);
        } else if (elemType.isPrimitive()) {
            java.lang.invoke.MethodHandle builder = getConstantHandle(MH_fillNewArray);
            java.lang.invoke.MethodHandle producer = buildArrayProducer(arrayType);
            mh = buildVarargsArray(builder, producer, nargs);
        } else {
            Class<? extends Object[]> objArrayType = arrayType.asSubclass(Object[].class);
            Object[] example = Arrays.copyOf(NO_ARGS_ARRAY, 0, objArrayType);
            java.lang.invoke.MethodHandle builder = getConstantHandle(MH_fillNewTypedArray).bindTo(example);
            java.lang.invoke.MethodHandle producer = getConstantHandle(MH_arrayIdentity); // must be weakly typed
            mh = buildVarargsArray(builder, producer, nargs);
        }
        mh = mh.asType(java.lang.invoke.MethodType.methodType(arrayType, Collections.<Class<?>>nCopies(nargs, elemType)));
        mh = makeIntrinsic(mh, Intrinsic.NEW_ARRAY);
        assert(assertCorrectArity(mh, nargs));
    ...
    /*non-public*/ static void assertSame(Object mh1, Object mh2) {
        if (mh1 != mh2) {
            String msg = String.format("mh1 != mh2: mh1 = %s (form: %s); mh2 = %s (form: %s)",
                    ...
                    mh2, ((java.lang.invoke.MethodHandle)mh2).form);
        ...
        try {
            switch (func) {
                ...
                case NF_guardWithCatch:
                    return new NamedFunction(MethodHandleImpl.class
                            .getDeclaredMethod("guardWithCatch", java.lang.invoke.MethodHandle.class, Class.class,
                                    java.lang.invoke.MethodHandle.class, Object[].class));
                case NF_tryFinally:
                    return new NamedFunction(MethodHandleImpl.class
                            .getDeclaredMethod("tryFinally", java.lang.invoke.MethodHandle.class, java.lang.invoke.MethodHandle.class, Object[].class));
                case NF_loop:
                    return new NamedFunction(MethodHandleImpl.class
    ...
    static {
        SharedSecrets.setJavaLangInvokeAccess(new JavaLangInvokeAccess() {
            ...
            public Object newMemberName() {
                return new java.lang.invoke.MemberName();
            }

            @Override
            public String getName(Object mname) {
                java.lang.invoke.MemberName memberName = (java.lang.invoke.MemberName)mname;
            ...
            @Override
            public java.lang.invoke.MethodType getMethodType(Object mname) {
                java.lang.invoke.MemberName memberName = (java.lang.invoke.MemberName)mname;
            ...
            public byte[] generateDirectMethodHandleHolderClassBytes(
                    String className, java.lang.invoke.MethodType[] methodTypes, int[] types) {
            ...
            public byte[] generateDelegatingMethodHandleHolderClassBytes(
                    String className, java.lang.invoke.MethodType[] methodTypes) {
                return GenerateJLIClassesHelper
            ...
            public byte[] generateInvokersHolderClassBytes(final String className,
                    java.lang.invoke.MethodType[] invokerMethodTypes,
                    java.lang.invoke.MethodType[] callSiteMethodTypes) {
                return GenerateJLIClassesHelper
    ...
    private static java.lang.invoke.MethodHandle unboxResultHandle(Class<?> returnType) {
        if (returnType.isPrimitive()) {
            ...
            return java.lang.invoke.MethodHandles.identity(Object.class);
        }
    }
     ...
     */
    static java.lang.invoke.MethodHandle makeLoop(Class<?> tloop, List<Class<?>> targs, List<java.lang.invoke.MethodHandle> init, List<java.lang.invoke.MethodHandle> step,
                                                  List<java.lang.invoke.MethodHandle> pred, List<java.lang.invoke.MethodHandle> fini) {
        java.lang.invoke.MethodType type = java.lang.invoke.MethodType.methodType(tloop, targs);
        BasicType[] initClauseTypes =
                init.stream().map(h -> h.type().returnType()).map(BasicType::basicType).toArray(BasicType[]::new);
        java.lang.invoke.LambdaForm form = makeLoopForm(type.basicType(), initClauseTypes);

        // Prepare auxiliary method handles used during LambdaForm interpretation.
        // Box arguments and wrap them into Object[]: ValueConversions.array().
        java.lang.invoke.MethodType varargsType = type.changeReturnType(Object[].class);
        java.lang.invoke.MethodHandle collectArgs = varargsArray(type.parameterCount()).asType(varargsType);
        java.lang.invoke.MethodHandle unboxResult = unboxResultHandle(tloop);

        LoopClauses clauseData =
                new LoopClauses(new java.lang.invoke.MethodHandle[][]{toArray(init), toArray(step), toArray(pred), toArray(fini)});
    ...
    private static java.lang.invoke.MethodHandle[] toArray(List<java.lang.invoke.MethodHandle> l) {
        return l.toArray(new java.lang.invoke.MethodHandle[0]);
    }
     ...
     * <p>
     * The above template is instantiated by using the {@link java.lang.invoke.LambdaFormEditor} to replace the {@code null} argument to
     ...
     * bytecode generation}.
     */
    private static java.lang.invoke.LambdaForm makeLoopForm(java.lang.invoke.MethodType basicType, BasicType[] localVarTypes) {
        java.lang.invoke.MethodType lambdaType = basicType.invokerType();
        ...
        java.lang.invoke.LambdaForm lform = basicType.form().cachedLambdaForm(java.lang.invoke.MethodTypeForm.LF_LOOP);
        if (lform == null) {
            Name[] names = arguments(nameCursor - ARG_LIMIT, lambdaType);
            ...
            lform = basicType.form().setCachedLambdaForm(java.lang.invoke.MethodTypeForm.LF_LOOP,
                    new java.lang.invoke.LambdaForm(lambdaType.parameterCount(), names, Kind.LOOP));
        }
    ...
    static class LoopClauses {
        @Stable final java.lang.invoke.MethodHandle[][] clauses;
        LoopClauses(java.lang.invoke.MethodHandle[][] clauses) {
        ...
        public String toString() {
            ...
            for (int i = 0; i < 4; ++i) {
                ...
                java.lang.invoke.MethodHandle[] hs = clauses[i];
    ...
    static Object loop(BasicType[] localTypes, LoopClauses clauseData, Object... av) throws Throwable {
        final java.lang.invoke.MethodHandle[] init = clauseData.clauses[0];
        final java.lang.invoke.MethodHandle[] step = clauseData.clauses[1];
        final java.lang.invoke.MethodHandle[] pred = clauseData.clauses[2];
        final java.lang.invoke.MethodHandle[] fini = clauseData.clauses[3];
        ...
        for (int i = 0, v = 0; i < init.length; ++i) {
            java.lang.invoke.MethodHandle ih = init[i];
        ...
        for (; ; ) {
            for (int i = 0, v = 0; i < nSteps; ++i) {
                java.lang.invoke.MethodHandle p = pred[i];
                java.lang.invoke.MethodHandle s = step[i];
                java.lang.invoke.MethodHandle f = fini[i];
    ...
    /**
     * This method is bound as the predicate in {@linkplain java.lang.invoke.MethodHandles#countedLoop(java.lang.invoke.MethodHandle, java.lang.invoke.MethodHandle,
     * java.lang.invoke.MethodHandle) counting loops}.
     *
    ...
    /**
     * This method is bound as the step function in {@linkplain java.lang.invoke.MethodHandles#countedLoop(java.lang.invoke.MethodHandle, java.lang.invoke.MethodHandle,
     * java.lang.invoke.MethodHandle) counting loops} to increment the counter.
     *
    ...
    /**
     * This is bound to initialize the loop-local iterator in {@linkplain java.lang.invoke.MethodHandles#iteratedLoop iterating loops}.
     *
    ...
    /**
     * This method is bound as the predicate in {@linkplain java.lang.invoke.MethodHandles#iteratedLoop iterating loops}.
     *
     ...
     * java.lang.invoke.MethodHandles#iteratedLoop iterating loops}.
     *
     ...
     */
    static java.lang.invoke.MethodHandle makeTryFinally(java.lang.invoke.MethodHandle target, java.lang.invoke.MethodHandle cleanup, Class<?> rtype, List<Class<?>> argTypes) {
        java.lang.invoke.MethodType type = java.lang.invoke.MethodType.methodType(rtype, argTypes);
        java.lang.invoke.LambdaForm form = makeTryFinallyForm(type.basicType());

        // Prepare auxiliary method handles used during LambdaForm interpretation.
        // Box arguments and wrap them into Object[]: ValueConversions.array().
        java.lang.invoke.MethodType varargsType = type.changeReturnType(Object[].class);
        java.lang.invoke.MethodHandle collectArgs = varargsArray(type.parameterCount()).asType(varargsType);
        java.lang.invoke.MethodHandle unboxResult = unboxResultHandle(rtype);
     ...
     */
    private static java.lang.invoke.LambdaForm makeTryFinallyForm(java.lang.invoke.MethodType basicType) {
        java.lang.invoke.MethodType lambdaType = basicType.invokerType();

        java.lang.invoke.LambdaForm lform = basicType.form().cachedLambdaForm(java.lang.invoke.MethodTypeForm.LF_TF);
        if (lform != null) {
            return lform;
        }
        ...
        // t_{i+2}:I=MethodHandle.invokeBasic(unbox:L,t_{i+1}:L);
        java.lang.invoke.MethodHandle invokeBasicUnbox = MethodHandles.basicInvoker(java.lang.invoke.MethodType.methodType(basicType.rtype(), Object.class));
        Object[] unboxArgs  = new Object[] {names[GET_UNBOX_RESULT], names[TRY_FINALLY]};
        names[UNBOX_RESULT] = new Name(invokeBasicUnbox, unboxArgs);

        lform = new java.lang.invoke.LambdaForm(lambdaType.parameterCount(), names, Kind.TRY_FINALLY);

        return basicType.form().setCachedLambdaForm(java.lang.invoke.MethodTypeForm.LF_TF, lform);
    }
     ...
     */
    @java.lang.invoke.LambdaForm.Hidden
    static Object tryFinally(java.lang.invoke.MethodHandle target, java.lang.invoke.MethodHandle cleanup, Object... av) throws Throwable {
        Throwable t = null;
        Object r = null;
        try {
    ...
    static java.lang.invoke.MethodHandle getConstantHandle(int idx) {
        java.lang.invoke.MethodHandle handle = HANDLES[idx];
        if (handle != null) {
            return handle;
        }
    ...
    private static synchronized java.lang.invoke.MethodHandle setCachedHandle(int idx, final java.lang.invoke.MethodHandle method) {
        // Simulate a CAS, to avoid racy duplication of results.
        java.lang.invoke.MethodHandle prev = HANDLES[idx];
        if (prev != null) {
            return prev;
        }
        HANDLES[idx] = method;
    ...
    private static final @Stable java.lang.invoke.MethodHandle[] HANDLES = new java.lang.invoke.MethodHandle[MH_LIMIT];

    private static java.lang.invoke.MethodHandle makeConstantHandle(int idx) {
        try {
            switch (idx) {
                case MH_cast:
                ...
                case MH_selectAlternative:
                    return IMPL_LOOKUP.findStatic(MethodHandleImpl.class, "selectAlternative",
                            java.lang.invoke.MethodType.methodType(java.lang.invoke.MethodHandle.class, boolean.class, java.lang.invoke.MethodHandle.class, MethodHandle.class));
                case MH_countedLoopPred:
                    return IMPL_LOOKUP.findStatic(MethodHandleImpl.class, "countedLoopPredicate",
                            java.lang.invoke.MethodType.methodType(boolean.class, int.class, int.class));
                ...
                case MH_initIterator:
                    return IMPL_LOOKUP.findStatic(MethodHandleImpl.class, "initIterator",
                            java.lang.invoke.MethodType.methodType(Iterator.class, Iterable.class));
                case MH_iteratePred:
                    return IMPL_LOOKUP.findStatic(MethodHandleImpl.class, "iteratePredicate",
                            java.lang.invoke.MethodType.methodType(boolean.class, Iterator.class));
                case MH_iterateNext:
                    return IMPL_LOOKUP.findStatic(MethodHandleImpl.class, "iterateNext",
                            java.lang.invoke.MethodType.methodType(Object.class, Iterator.class));
