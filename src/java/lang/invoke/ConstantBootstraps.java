...
public final class ConstantBootstraps {
    ...
    /*non-public*/
    static Object makeConstant(java.lang.invoke.MethodHandle bootstrapMethod,
                               // Callee information:
        ...
        if (mt.parameterCount() < 2 ||
            !java.lang.invoke.MethodHandles.Lookup.class.isAssignableFrom(mt.parameterType(0))) {
     ...
     */
    public static Object nullConstant(java.lang.invoke.MethodHandles.Lookup lookup, String name, Class<?> type) {
     ...
     */
    public static Class<?> primitiveClass(java.lang.invoke.MethodHandles.Lookup lookup, String name, Class<?> type) {
        requireNonNull(name);
        requireNonNull(type);
        if (type != Class.class) {
     ...
     */
    public static <E extends Enum<E>> E enumConstant(java.lang.invoke.MethodHandles.Lookup lookup, String name, Class<E> type) {
     ...
     * {@code final}
     */
    public static Object getStaticFinal(java.lang.invoke.MethodHandles.Lookup lookup, String name, Class<?> type,
     ...
     * {@link #getStaticFinal(java.lang.invoke.MethodHandles.Lookup, String, Class, Class)}
     ...
     * @throws IncompatibleClassChangeError if the specified field is not
     * {@code final}
     * @see #getStaticFinal(java.lang.invoke.MethodHandles.Lookup, String, Class, Class)
     */
    public static Object getStaticFinal(java.lang.invoke.MethodHandles.Lookup lookup, String name, Class<?> type) {
        requireNonNull(type);
     ...
     * of adapting the given method handle, via {@link java.lang.invoke.MethodHandle#asType}, to
     ...
     * {@link java.lang.invoke.MethodHandle#invokeWithArguments}.  Each argument may be
     * {@code null}.
     ...
     */
    public static Object invoke(java.lang.invoke.MethodHandles.Lookup lookup, String name, Class<?> type,
    ...
    /**
     * Finds a {@link java.lang.invoke.VarHandle} for an instance field.
     *
     * @param lookup the lookup context describing the class performing the
     * operation (normally stacked by the JVM)
     * @param name the name of the field
     ...
     * @return the {@link java.lang.invoke.VarHandle}
     * @throws IllegalAccessError if the declaring class or the field is not
     * accessible to the class performing the operation
     * @throws NoSuchFieldError if the specified field does not exist
     * @throws IllegalArgumentException if the type is not {@code VarHandle}
     */
    public static java.lang.invoke.VarHandle fieldVarHandle(java.lang.invoke.MethodHandles.Lookup lookup, String name, Class<java.lang.invoke.VarHandle> type,
        ...
        if (type != java.lang.invoke.VarHandle.class) {
            throw new IllegalArgumentException();
        }
    ...
    /**
     * Finds a {@link java.lang.invoke.VarHandle} for a static field.
     *
     * @param lookup the lookup context describing the class performing the
     * operation (normally stacked by the JVM)
     * @param name the name of the field
     ...
     * @throws IllegalArgumentException if the type is not {@code VarHandle}
     */
    public static java.lang.invoke.VarHandle staticFieldVarHandle(java.lang.invoke.MethodHandles.Lookup lookup, String name, Class<java.lang.invoke.VarHandle> type,
                                                                  Class<?> declaringClass, Class<?> fieldType) {
        requireNonNull(lookup);
        requireNonNull(name);
        requireNonNull(type);
    ...
    /**
     * Finds a {@link java.lang.invoke.VarHandle} for an array type.
     *
     * @param lookup the lookup context describing the class performing the
     * operation (normally stacked by the JVM)
     * @param name unused
     ...
     * @throws IllegalArgumentException if the type is not {@code VarHandle}
     */
    public static java.lang.invoke.VarHandle arrayVarHandle(java.lang.invoke.MethodHandles.Lookup lookup, String name, Class<java.lang.invoke.VarHandle> type,
                                                            Class<?> arrayClass) {
        requireNonNull(lookup);
        requireNonNull(type);
        ...
        return java.lang.invoke.MethodHandles.arrayElementVarHandle(validateClassAccess(lookup, arrayClass));
    }
