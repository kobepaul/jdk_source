...
public abstract class MethodHandle {
     ...
     *         {@linkplain java.lang.invoke.MethodType#lastParameterType trailing parameter}
...
assertEquals("[A, B, C]", (String) caToString2.invokeExact('A', "BC".toCharArray()));
    ...
    public MethodHandle asSpreader(int spreadArgPos, Class<?> arrayType, int arrayLength) {
        java.lang.invoke.MethodType postSpreadType = asSpreaderChecks(arrayType, spreadArgPos, arrayLength);
        MethodHandle afterSpread = this.asType(postSpreadType);
        BoundMethodHandle mh = afterSpread.rebind();
        java.lang.invoke.LambdaForm lform = mh.editor().spreadArgumentsForm(1 + spreadArgPos, arrayType, arrayLength);
        java.lang.invoke.MethodType preSpreadType = postSpreadType.replaceParameterTypes(spreadArgPos, spreadArgPos + arrayLength, arrayType);
     ...
     */
    private java.lang.invoke.MethodType asSpreaderChecks(Class<?> arrayType, int pos, int arrayLength) {
        ...
        java.lang.invoke.MethodType needType = mtype.asSpreaderType(arrayType, pos, arrayLength);
     ...
     * {@linkplain java.lang.invoke.MethodType#lastParameterType last parameter type}
...
assertEquals("[123]", (String) longsToString.invokeExact((long)123));
    ...
    public MethodHandle asCollector(int collectArgPos, Class<?> arrayType, int arrayLength) {
        ...
        java.lang.invoke.MethodType resultType = type().asCollectorType(arrayType, collectArgPos, arrayLength);
...
assertEquals("[three, thee, tee]", asListFix.invoke((Object)argv).toString());
    ...
    /*non-public*/
    void customize() {
        final java.lang.invoke.LambdaForm form = this.form;
