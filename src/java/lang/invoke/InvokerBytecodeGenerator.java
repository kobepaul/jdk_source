...
class InvokerBytecodeGenerator {
    ...
    InvokerBytecodeGenerator(String className, String invokerName,
                             java.lang.invoke.LambdaForm form, java.lang.invoke.MethodType invokerType) {
    ...
    private static java.lang.invoke.MemberName resolveFrom(String name, java.lang.invoke.MethodType type, Class<?> holder) {
        java.lang.invoke.MemberName member = new java.lang.invoke.MemberName(holder, name, type, REF_invokeStatic);
        java.lang.invoke.MemberName resolvedMember = java.lang.invoke.MemberName.getFactory().resolveOrNull(REF_invokeStatic, member, holder);
        if (TRACE_RESOLVE) {
    ...
    private static java.lang.invoke.MemberName lookupPregenerated(java.lang.invoke.LambdaForm form, java.lang.invoke.MethodType invokerType) {
        ...
        switch (form.kind) {
            case BOUND_REINVOKER: {
                name = name + "_" + java.lang.invoke.BoundMethodHandle.speciesDataFor(form).key();
                return resolveFrom(name, invokerType, java.lang.invoke.DelegatingMethodHandle.Holder.class);
            }
            case DELEGATE:                  return resolveFrom(name, invokerType, java.lang.invoke.DelegatingMethodHandle.Holder.class);
            case ZERO:                      // fall-through
            case IDENTITY: {
                name = name + "_" + form.returnType().basicTypeChar();
                return resolveFrom(name, invokerType, java.lang.invoke.LambdaForm.Holder.class);
            }
            ...
            case GENERIC_LINKER:            return resolveFrom(name, invokerType.basicType(), java.lang.invoke.Invokers.Holder.class);
            ...
            case DIRECT_INVOKE_VIRTUAL:     return resolveFrom(name, invokerType, java.lang.invoke.DirectMethodHandle.Holder.class);
        }
        return null;
    }
    ...
    static java.lang.invoke.MemberName generateCustomizedCode(java.lang.invoke.LambdaForm form, java.lang.invoke.MethodType invokerType) {
        java.lang.invoke.MemberName pregenerated = lookupPregenerated(form, invokerType);
                ...
                case SELECT_ALTERNATIVE:
                    ...
                    if (PROFILE_GWT) {
                        assert(name.arguments[0] instanceof Name &&
                                ((Name)name.arguments[0]).refersTo(java.lang.invoke.MethodHandleImpl.class, "profileBoolean"));
    ...
    static boolean isStaticallyInvocable(java.lang.invoke.MemberName member) {
        ...
        // case
        if (java.lang.invoke.MethodHandle.class.isAssignableFrom(cls) && !member.isPrivate()) {
    ...
    private static boolean isStaticallyInvocableType(java.lang.invoke.MethodType mtype) {
    ...
    static boolean isStaticallyNameable(Class<?> cls) {
        if (cls == Object.class)
            return true;
        if (java.lang.invoke.MethodHandle.class.isAssignableFrom(cls)) {
    ...
    private Name emitTryFinally(int pos) {
        ...
        java.lang.invoke.MethodType type = args.function.resolvedHandle().type()
                .dropParameterTypes(0,1)
                .changeReturnType(returnType);
        java.lang.invoke.MethodType cleanupType = type.insertParameterTypes(0, Throwable.class);
        if (isNonVoid) {
     ...
     * }</pre></blockquote>
     * <p>
     * It is compiled into bytecode equivalent to the code seen in {@link java.lang.invoke.MethodHandleImpl#loop(BasicType[],
     * java.lang.invoke.MethodHandleImpl.LoopClauses, Object...)}, with the difference that no arrays
    ...
    private Name emitLoop(int pos) {
        ...
        localTypes[0] = java.lang.invoke.MethodHandleImpl.LoopClauses.class;
        ...
        Class<?> returnType = result.function.resolvedHandle().type().returnType();
        java.lang.invoke.MethodType loopType = args.function.resolvedHandle().type()
                .dropParameterTypes(0,1)
                .changeReturnType(returnType);
        java.lang.invoke.MethodType loopHandleType = loopType.insertParameterTypes(0, loopLocalStateTypes);
        java.lang.invoke.MethodType predType = loopHandleType.changeReturnType(boolean.class);
        java.lang.invoke.MethodType finiType = loopHandleType;
        ...
        // PREINIT:
        emitPushArgument(java.lang.invoke.MethodHandleImpl.LoopClauses.class, invoker.arguments[1]);
        ...
        for (int c = 0, state = 0; c < nClauses; ++c) {
            java.lang.invoke.MethodType cInitType = loopType.changeReturnType(loopClauseTypes[c].basicTypeClass());
        ...
        for (int c = 0, state = 0; c < nClauses; ++c) {
            ...
            java.lang.invoke.MethodType stepType = loopHandleType.changeReturnType(loopClauseTypes[c].basicTypeClass());
    ...
    private void emitLoopHandleInvoke(Name holder, int handles, int clause, Name args, boolean pushLocalState,
                                      java.lang.invoke.MethodType type, Class<?>[] loopLocalStateTypes, int clauseDataSlot,
    ...
    private void emitPushArguments(Name args, int start) {
        java.lang.invoke.MethodType type = args.function.methodType();
    ...
    static java.lang.invoke.MemberName generateLambdaFormInterpreterEntryPoint(java.lang.invoke.MethodType mt) {
        ...
        java.lang.invoke.MethodType type = mt;  // includes leading argument
