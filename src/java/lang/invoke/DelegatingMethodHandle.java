...
abstract class DelegatingMethodHandle extends java.lang.invoke.MethodHandle {
    ...
    static java.lang.invoke.LambdaForm makeReinvokerForm(java.lang.invoke.MethodHandle target,
        ...
        boolean customized = (whichCache < 0 ||
                mtype.parameterSlotCount() > java.lang.invoke.MethodType.MAX_MH_INVOKER_ARITY);
        ...
        form = new java.lang.invoke.LambdaForm(ARG_LIMIT, names, forceInline, kind);
        if (!customized) {
    ...
    private static Kind whichKind(int whichCache) {
        switch(whichCache) {
            case java.lang.invoke.MethodTypeForm.LF_REBIND:   return BOUND_REINVOKER;
            case java.lang.invoke.MethodTypeForm.LF_DELEGATE: return DELEGATE;
    ...
    static {
        try {
            java.lang.invoke.MemberName member = new java.lang.invoke.MemberName(DelegatingMethodHandle.class, "getTarget",
