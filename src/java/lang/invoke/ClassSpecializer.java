...
abstract class ClassSpecializer<T,K,S extends ClassSpecializer<T,K,S>.SpeciesData> {
    ...
    private final List<java.lang.invoke.MemberName> transformMethods;
     ...
     */
    protected java.lang.invoke.MethodType baseConstructorType() { return baseConstructorType; }
    ...
    protected final List<java.lang.invoke.MemberName> transformMethods() { return transformMethods; }
    ...
    protected ClassSpecializer(Class<T> topClass,
                               Class<K> keyType,
                               Class<S> metaType,
                               java.lang.invoke.MethodType baseConstructorType,
                               java.lang.invoke.MemberName sdAccessor,
                               String sdFieldName,
                               List<java.lang.invoke.MemberName> transformMethods) {
    ...
    protected static <T> Constructor<T> reflectConstructor(Class<T> defc, Class<?>... ptypes) {
        try {
            ...
            throw newIAE(defc.getName()+"("+ java.lang.invoke.MethodType.methodType(void.class, ptypes)+")", ex);
        }
    }
    ...
    public abstract class SpeciesData {
        ...
        @Stable private List<java.lang.invoke.MethodHandle> factories;
        @Stable private List<java.lang.invoke.MethodHandle> getters;
        @Stable private List<java.lang.invoke.LambdaForm.NamedFunction> nominalGetters;
        @Stable private final java.lang.invoke.MethodHandle[] transformHelpers = new java.lang.invoke.MethodHandle[transformMethods.size()];
        ...
        /**
         * Return a {@link java.lang.invoke.MethodHandle} which can get the indexed field of this species.
         ...
         */
        protected java.lang.invoke.MethodHandle getter(int i) {
         ...
         * getter.
         */
        protected java.lang.invoke.LambdaForm.NamedFunction getterFunction(int i) {
            java.lang.invoke.LambdaForm.NamedFunction nf = nominalGetters.get(i);
            assert(nf.memberDeclaringClassOrNull() == speciesCode());
            assert(nf.returnType() == BasicType.basicType(fieldTypes.get(i)));
            return nf;
        }

        protected List<java.lang.invoke.LambdaForm.NamedFunction> getterFunctions() {
            return nominalGetters;
        }

        protected List<java.lang.invoke.MethodHandle> getters() {
            return getters;
        }

        protected java.lang.invoke.MethodHandle factory() {
            return factories.get(0);
        }

        protected java.lang.invoke.MethodHandle transformHelper(int whichtm) {
            java.lang.invoke.MethodHandle mh = transformHelpers[whichtm];
            ...
            final java.lang.invoke.MethodType mt = transformHelperType(whichtm);
            mh = mh.asType(mt);
            return transformHelpers[whichtm] = mh;
        }

        private final java.lang.invoke.MethodType transformHelperType(int whichtm) {
            java.lang.invoke.MemberName tm = transformMethods().get(whichtm);
            ...
            return java.lang.invoke.MethodType.methodType(tm.getReturnType(), helperArgs);
        }
         ...
         */
        protected abstract java.lang.invoke.MethodHandle deriveTransformHelper(java.lang.invoke.MemberName transform, int whichtm);
         ...
         * @return a new list
         */
        protected abstract <X> List<X> deriveTransformHelperArguments(java.lang.invoke.MemberName transform, int whichtm,
        ...
        protected String deriveTypeString() {
            ...
            return java.lang.invoke.LambdaForm.shortenSignature(typeString);
        }
    ...
    public class Factory {
        ...
        private final List<java.lang.invoke.MethodType> TRANSFORM_TYPES;
        private final List<Integer> TRANSFORM_MODS;
        {
            ...
            List<java.lang.invoke.MethodType> tts = new ArrayList<>();
            List<Integer> tms = new ArrayList<>();
            for (int i = 0; i < transformMethods.size(); i++) {
                java.lang.invoke.MemberName tm = transformMethods.get(i);
                tns.add(tm.getName());
                final java.lang.invoke.MethodType tt = tm.getMethodType();
                tts.add(tt);
                tms.add(tm.getModifiers());
            }
            TRANSFORM_NAMES = List.of(tns.toArray(new String[0]));
            TRANSFORM_TYPES = List.of(tts.toArray(new java.lang.invoke.MethodType[0]));
        ...
        /*non-public*/ byte[] generateConcreteSpeciesCodeFile(String className0, SpeciesData speciesData) {
            ...
            java.lang.invoke.MethodType superCtorType = ClassSpecializer.this.baseConstructorType();
            java.lang.invoke.MethodType thisCtorType = superCtorType.appendParameterTypes(fieldTypes);
            ...
            {
                java.lang.invoke.MethodType ftryType = thisCtorType.changeReturnType(topClass());
            ...
            for (int whichtm = 0; whichtm < TRANSFORM_NAMES.size(); whichtm++) {
                ...
                final java.lang.invoke.MethodType TTYPE = TRANSFORM_TYPES.get(whichtm);
                ...
                java.lang.invoke.MethodType invokeBasicType = java.lang.invoke.MethodType.methodType(rbt.basicTypeClass(), helperTypes);
        ...
        private java.lang.invoke.MethodHandle findGetter(Class<?> speciesCode, List<Class<?>> types, int index) {
        ...
        private List<java.lang.invoke.MethodHandle> findGetters(Class<?> speciesCode, List<Class<?>> types) {
            java.lang.invoke.MethodHandle[] mhs = new java.lang.invoke.MethodHandle[types.size()];
        ...
        private List<java.lang.invoke.MethodHandle> findFactories(Class<? extends T> speciesCode, List<Class<?>> types) {
            java.lang.invoke.MethodHandle[] mhs = new java.lang.invoke.MethodHandle[1];
            mhs[0] = findFactory(speciesCode, types);
            return List.of(mhs);
        }

        List<java.lang.invoke.LambdaForm.NamedFunction> makeNominalGetters(List<Class<?>> types, List<java.lang.invoke.MethodHandle> getters) {
            java.lang.invoke.LambdaForm.NamedFunction[] nfs = new java.lang.invoke.LambdaForm.NamedFunction[types.size()];
            for (int i = 0; i < nfs.length; ++i) {
                nfs[i] = new java.lang.invoke.LambdaForm.NamedFunction(getters.get(i));
            }
            return List.of(nfs);
        }
        ...
        private S readSpeciesDataFromCode(Class<? extends T> speciesCode) {
            try {
                java.lang.invoke.MemberName sdField = IMPL_LOOKUP.resolveOrFail(REF_getStatic, speciesCode, sdFieldName, metaType);
        ...
        protected void linkCodeToSpeciesData(Class<? extends T> speciesCode, SpeciesData speciesData, boolean salvage) {
            try {
                ...
                java.lang.invoke.MemberName sdField = IMPL_LOOKUP.resolveOrFail(REF_putStatic, speciesCode, sdFieldName, metaType);
                Object base = MethodHandleNatives.staticFieldBase(sdField);
                long offset = MethodHandleNatives.staticFieldOffset(sdField);
                UNSAFE.storeFence();
        ...
        java.lang.invoke.MethodHandle findFactory(Class<? extends T> speciesCode, List<Class<?>> types) {
            final java.lang.invoke.MethodType type = baseConstructorType().changeReturnType(topClass()).appendParameterTypes(types);
            try {
    ...
    static {
        assert(MH_SIG.equals(classSig(java.lang.invoke.MethodHandle.class)));
