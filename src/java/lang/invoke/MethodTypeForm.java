...
final class MethodTypeForm {
    ...
    @Stable final SoftReference<java.lang.invoke.MethodHandle>[] methodHandles;
    ...
    final @Stable SoftReference<java.lang.invoke.LambdaForm>[] lambdaForms;
    ...
    public synchronized java.lang.invoke.MethodHandle setCachedMethodHandle(int which, java.lang.invoke.MethodHandle mh) {
    ...
    public synchronized java.lang.invoke.LambdaForm setCachedLambdaForm(int which, java.lang.invoke.LambdaForm form) {
        // Simulate a CAS, to avoid racy duplication of results.
        SoftReference<java.lang.invoke.LambdaForm> entry = lambdaForms[which];
        if (entry != null) {
