...
class MethodHandleNatives {
    ...
    static native java.lang.invoke.MemberName resolve(java.lang.invoke.MemberName self, Class<?> caller,
    ...
    static class CallSiteContext implements Runnable {
        ...
        static CallSiteContext make(java.lang.invoke.CallSite cs) {
     ...
     */
    static boolean isPullModeBSM(java.lang.invoke.MethodHandle bsm) {
        return false;
//        return bsm.type().parameterCount() == 2 && !bsm.isVarargsCollector();
    ...
    static java.lang.invoke.MemberName linkMethodImpl(Class<?> callerClass, int refKind,
        ...
        try {
            if (refKind == REF_invokeVirtual) {
                if (defc == java.lang.invoke.MethodHandle.class) {
                    return java.lang.invoke.Invokers.methodHandleInvokeLinkerMethod(
                            name, fixMethodType(callerClass, type), appendixResult);
                } else if (defc == java.lang.invoke.VarHandle.class) {
    ...
    private static java.lang.invoke.MethodType fixMethodType(Class<?> callerClass, Object type) {
        if (type instanceof java.lang.invoke.MethodType)
            ...
            return java.lang.invoke.MethodType.fromDescriptor((String)type, callerClass.getClassLoader());
    }
    // Tracing logic:
     ...
     */
    private static java.lang.invoke.MemberName varHandleOperationLinkerMethod(String name,
                                                                              java.lang.invoke.MethodType mtype,
                                                                              Object[] appendixResult) {
        // Get the signature method type
        final java.lang.invoke.MethodType sigType = mtype.basicType();

        // Get the access kind from the method name
        java.lang.invoke.VarHandle.AccessMode ak;
        try {
            ak = java.lang.invoke.VarHandle.AccessMode.valueFromMethodName(name);
        } catch (IllegalArgumentException e) {
            throw MethodHandleStatics.newInternalError(e);
        }

        // Create the appendix descriptor constant
        java.lang.invoke.VarHandle.AccessDescriptor ad = new java.lang.invoke.VarHandle.AccessDescriptor(mtype, ak.at.ordinal(), ak.ordinal());
        appendixResult[0] = ad;
        ...
        if (MethodHandleStatics.VAR_HANDLE_GUARDS) {
            ...
            // VarHandle at start
            guardParams[0] = java.lang.invoke.VarHandle.class;
            ...
            java.lang.invoke.MethodType guardType = java.lang.invoke.MethodType.makeImpl(guardReturnType, guardParams, true);

            java.lang.invoke.MemberName linker = new java.lang.invoke.MemberName(
                    java.lang.invoke.VarHandleGuards.class, getVarHandleGuardMethodName(guardType),
                    guardType, REF_invokeStatic);

            linker = java.lang.invoke.MemberName.getFactory().resolveOrNull(REF_invokeStatic, linker,
        ...
        return java.lang.invoke.Invokers.varHandleInvokeLinkerMethod(ak, mtype);
    }
