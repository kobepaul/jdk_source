 ...
 * arguments provided on invocation, as if by {@link java.lang.invoke.MethodHandle#invoke(Object...)}.</li>
 * </ol>
 *
 * <p> This class provides two forms of linkage methods: a simple version
 * ({@link #makeConcat(Lookup, String,
 * java.lang.invoke.MethodType)}) using only the dynamic arguments, and an advanced version
 * ({@link #makeConcatWithConstants(Lookup,
 * String, java.lang.invoke.MethodType, String, Object...)} using the advanced forms of capturing
...
public final class StringConcatFactory {
    ...
    private static final ConcurrentMap<Key, java.lang.invoke.MethodHandle> CACHE;
    ...
    static {
        ...
        DUMPER = (dumpPath == null) ? null : java.lang.invoke.ProxyClassesDumper.getInstance(dumpPath);
    }
    ...
    private static final class Key {
        ...
        final java.lang.invoke.MethodType mt;
        final Recipe recipe;

        public Key(String className, java.lang.invoke.MethodType mt, Recipe recipe) {
     ...
     */
    public static java.lang.invoke.CallSite makeConcat(Lookup lookup,
                                                       String name,
                                                       java.lang.invoke.MethodType concatType) throws StringConcatException {
        if (DEBUG) {
     ...
     *   returned {@link java.lang.invoke.MethodHandle}</li>
     *
     ...
     * @jls 15.18.1 String Concatenation Operator +
     */
    public static java.lang.invoke.CallSite makeConcatWithConstants(Lookup lookup,
                                                                    String name,
    ...
    private static CallSite doStringConcat(Lookup lookup,
        ...
        java.lang.invoke.MethodType mt = adaptType(concatType);
     ...
     */
    private static java.lang.invoke.MethodType adaptType(java.lang.invoke.MethodType args) {
        Class<?>[] ptypes = null;
        ...
        return (ptypes != null)
                ? java.lang.invoke.MethodType.methodType(args.returnType(), ptypes)
                : args;
    }
    ...
    private static java.lang.invoke.MethodHandle generate(Lookup lookup, String className, java.lang.invoke.MethodType mt, Recipe recipe) throws StringConcatException {
        try {
            switch (STRATEGY) {
                case BC_SB:
    ...
    private static final class BytecodeStringBuilderStrategy {
        ...
        private static java.lang.invoke.MethodHandle generate(Lookup lookup, String className, java.lang.invoke.MethodType args, Recipe recipe, Mode mode) throws Exception {
    ...
    private static final class MethodHandleStringBuilderStrategy {
        ...
        private static java.lang.invoke.MethodHandle generate(java.lang.invoke.MethodType mt, Recipe recipe, Mode mode) throws Exception {
            int pc = mt.parameterCount();

            Class<?>[] ptypes = mt.parameterArray();
            java.lang.invoke.MethodHandle[] filters = new java.lang.invoke.MethodHandle[ptypes.length];
            ...
            java.lang.invoke.MethodHandle[] lengthers = new java.lang.invoke.MethodHandle[pc];
            ...
            for (RecipeElement el : recipe.getElements()) {
                switch (el.getTag()) {
                    ...
                    case TAG_ARG:
                        ...
                        Class<?> type = ptypes[i];
                        if (type.isPrimitive()) {
                            java.lang.invoke.MethodHandle est = java.lang.invoke.MethodHandles.constant(int.class, estimateSize(type));
                            est = java.lang.invoke.MethodHandles.dropArguments(est, 0, type);
                            lengthers[i] = est;
                        } else {
            ...
            java.lang.invoke.MethodHandle builder = java.lang.invoke.MethodHandles.dropArguments(java.lang.invoke.MethodHandles.identity(StringBuilder.class), 1, ptypes);
            ...
            for (int i = elements.size() - 1; i >= 0; i--) {
                ...
                java.lang.invoke.MethodHandle appender;
                switch (el.getTag()) {
                    case TAG_CONST:
                        java.lang.invoke.MethodHandle mh = appender(adaptToStringBuilder(String.class));
                        appender = java.lang.invoke.MethodHandles.insertArguments(mh, 1, el.getValue());
                        break;
                    case TAG_ARG:
                        int ac = el.getArgPos();
                        ...
                        if (ac != 0) {
                            appender = java.lang.invoke.MethodHandles.dropArguments(appender, 1, Arrays.copyOf(ptypes, ac));
                        }
                        break;
                    default:
                        throw new StringConcatException("Unhandled tag: " + el.getTag());
                }
                builder = java.lang.invoke.MethodHandles.foldArguments(builder, appender);
            }
            ...
            java.lang.invoke.MethodHandle sum = getReducerFor(pc + 1);
            java.lang.invoke.MethodHandle adder = java.lang.invoke.MethodHandles.insertArguments(sum, 0, initial);

            // b) Apply lengthers to transform arguments to lengths, producing (<args>)int
            adder = java.lang.invoke.MethodHandles.filterArguments(adder, 0, lengthers);

            // c) Instantiate StringBuilder (<args>)int -> (<args>)StringBuilder
            java.lang.invoke.MethodHandle newBuilder = java.lang.invoke.MethodHandles.filterReturnValue(adder, NEW_STRING_BUILDER);

            // d) Fold in StringBuilder constructor, this produces (<args>)StringBuilder
            java.lang.invoke.MethodHandle mh = java.lang.invoke.MethodHandles.foldArguments(builder, newBuilder);

            // Convert non-primitive arguments to Strings
            mh = java.lang.invoke.MethodHandles.filterArguments(mh, 0, filters);

            // Convert (<args>)StringBuilder to (<args>)String
            if (DEBUG && mode.isExact()) {
                mh = java.lang.invoke.MethodHandles.filterReturnValue(mh, BUILDER_TO_STRING_CHECKED);
            } else {
                mh = java.lang.invoke.MethodHandles.filterReturnValue(mh, BUILDER_TO_STRING);
            }

            return mh;
        }

        private static java.lang.invoke.MethodHandle getReducerFor(int cnt) {
            return SUMMERS.computeIfAbsent(cnt, SUMMER);
        }

        private static java.lang.invoke.MethodHandle appender(Class<?> appendType) {
            java.lang.invoke.MethodHandle appender = lookupVirtual(java.lang.invoke.MethodHandles.publicLookup(), StringBuilder.class, "append",
            ...
            java.lang.invoke.MethodType nt = java.lang.invoke.MethodType.methodType(void.class, StringBuilder.class, appendType);
        ...
        private static final ConcurrentMap<Integer, java.lang.invoke.MethodHandle> SUMMERS;

        // This one is deliberately non-lambdified to optimize startup time:
        private static final Function<Integer, java.lang.invoke.MethodHandle> SUMMER = new Function<Integer, java.lang.invoke.MethodHandle>() {
            @Override
            public java.lang.invoke.MethodHandle apply(Integer cnt) {
                if (cnt == 1) {
                    return java.lang.invoke.MethodHandles.identity(int.class);
                } else if (cnt <= 8) {
        ...
        private static final java.lang.invoke.MethodHandle NEW_STRING_BUILDER, STRING_LENGTH, BUILDER_TO_STRING, BUILDER_TO_STRING_CHECKED;

        static {
            SUMMERS = new ConcurrentHashMap<>();
            Lookup publicLookup = java.lang.invoke.MethodHandles.publicLookup();
    ...
    private static final class MethodHandleInlineCopyStrategy {
        ...
        static java.lang.invoke.MethodHandle generate(java.lang.invoke.MethodType mt, Recipe recipe) throws Throwable {

            // Create filters and obtain filtered parameter types. Filters would be used in the beginning
            // to convert the incoming arguments into the arguments we can process (e.g. Objects -> Strings).
            // The filtered argument type list is used all over in the combinators below.
            Class<?>[] ptypes = mt.parameterArray();
            java.lang.invoke.MethodHandle[] filters = null;
            for (int i = 0; i < ptypes.length; i++) {
                java.lang.invoke.MethodHandle filter = Stringifiers.forMost(ptypes[i]);
                if (filter != null) {
                    if (filters == null) {
                        filters = new java.lang.invoke.MethodHandle[ptypes.length];
                    }
                    filters[i] = filter;
                    ptypes[i] = filter.type().returnType();
                }
            ...
            mh = java.lang.invoke.MethodHandles.dropArguments(NEW_STRING, 3, ptypes);
            ...
            for (RecipeElement el : recipe.getElements()) {
                ...
                mh = java.lang.invoke.MethodHandles.dropArguments(mh, 2, int.class);
                switch (el.getTag()) {
                    case TAG_CONST: {
                        java.lang.invoke.MethodHandle prepender = java.lang.invoke.MethodHandles.insertArguments(prepender(String.class), 3, el.getValue());
                        mh = java.lang.invoke.MethodHandles.foldArguments(mh, 1, prepender,
                    ...
                    case TAG_ARG: {
                        ...
                        java.lang.invoke.MethodHandle prepender = prepender(ptypes[pos]);
                        mh = java.lang.invoke.MethodHandles.foldArguments(mh, 1, prepender,
                                2, 0, 3, // index, storage, coder
            ...
            mh = java.lang.invoke.MethodHandles.foldArguments(mh, 0, NEW_ARRAY,
                    1, 2 // index, coder
            );
            ...
            for (RecipeElement el : recipe.getElements()) {
                switch (el.getTag()) {
                    ...
                    case TAG_ARG:
                        ...
                        java.lang.invoke.MethodHandle lm = lengthMixer(argClass);
                        java.lang.invoke.MethodHandle cm = coderMixer(argClass);

                        // Read this bottom up:

                        // 4. Drop old index and coder, producing ("new-index", "new-coder", <args>)
                        mh = java.lang.invoke.MethodHandles.dropArguments(mh, 2, int.class, byte.class);
                        ...
                        mh = java.lang.invoke.MethodHandles.foldArguments(mh, 0, lm,
                                2, // old-index
                        ...
                        mh = java.lang.invoke.MethodHandles.foldArguments(mh, 0, cm,
                                2, // old-coder
            ...
            mh = java.lang.invoke.MethodHandles.insertArguments(mh, 0, initialLen, initialCoder);
        ...
        private static java.lang.invoke.MethodHandle prepender(Class<?> cl) {
            return PREPENDERS.computeIfAbsent(cl, PREPEND);
        }

        private static java.lang.invoke.MethodHandle coderMixer(Class<?> cl) {
            return CODER_MIXERS.computeIfAbsent(cl, CODER_MIX);
        }

        private static java.lang.invoke.MethodHandle lengthMixer(Class<?> cl) {
            return LENGTH_MIXERS.computeIfAbsent(cl, LENGTH_MIX);
        }

        // This one is deliberately non-lambdified to optimize startup time:
        private static final Function<Class<?>, java.lang.invoke.MethodHandle> PREPEND = new Function<Class<?>, java.lang.invoke.MethodHandle>() {
            @Override
            public java.lang.invoke.MethodHandle apply(Class<?> c) {
        ...
        // This one is deliberately non-lambdified to optimize startup time:
        private static final Function<Class<?>, java.lang.invoke.MethodHandle> CODER_MIX = new Function<Class<?>, java.lang.invoke.MethodHandle>() {
            @Override
            public java.lang.invoke.MethodHandle apply(Class<?> c) {
        ...
        // This one is deliberately non-lambdified to optimize startup time:
        private static final Function<Class<?>, java.lang.invoke.MethodHandle> LENGTH_MIX = new Function<Class<?>, java.lang.invoke.MethodHandle>() {
            @Override
            public java.lang.invoke.MethodHandle apply(Class<?> c) {
        ...
        private static final java.lang.invoke.MethodHandle NEW_STRING;
        private static final java.lang.invoke.MethodHandle NEW_ARRAY;
        private static final ConcurrentMap<Class<?>, java.lang.invoke.MethodHandle> PREPENDERS;
        private static final ConcurrentMap<Class<?>, java.lang.invoke.MethodHandle> LENGTH_MIXERS;
        private static final ConcurrentMap<Class<?>, java.lang.invoke.MethodHandle> CODER_MIXERS;
        ...
        static {
            try {
                ...
                java.lang.invoke.MethodHandle initCoder = lookupStatic(Lookup.IMPL_LOOKUP, STRING_HELPER, "initialCoder", byte.class);
    ...
    private static final class Stringifiers {
        ...
        private static class StringifierMost extends ClassValue<java.lang.invoke.MethodHandle> {
            @Override
            protected java.lang.invoke.MethodHandle computeValue(Class<?> cl) {
                if (cl == String.class) {
                    return lookupStatic(java.lang.invoke.MethodHandles.publicLookup(), String.class, "valueOf", String.class, Object.class);
                } else if (cl == float.class) {
                    return lookupStatic(java.lang.invoke.MethodHandles.publicLookup(), String.class, "valueOf", String.class, float.class);
                } else if (cl == double.class) {
                    return lookupStatic(java.lang.invoke.MethodHandles.publicLookup(), String.class, "valueOf", String.class, double.class);
                } else if (!cl.isPrimitive()) {
                    java.lang.invoke.MethodHandle mhObject = lookupStatic(java.lang.invoke.MethodHandles.publicLookup(), String.class, "valueOf", String.class, Object.class);
                    ...
                    return java.lang.invoke.MethodHandles.filterReturnValue(mhObject,
                            mhObject.asType(java.lang.invoke.MethodType.methodType(String.class, String.class)));
                }
        ...
        private static class StringifierAny extends ClassValue<java.lang.invoke.MethodHandle> {
            @Override
            protected java.lang.invoke.MethodHandle computeValue(Class<?> cl) {
                if (cl == byte.class || cl == short.class || cl == int.class) {
                    return lookupStatic(java.lang.invoke.MethodHandles.publicLookup(), String.class, "valueOf", String.class, int.class);
                } else if (cl == boolean.class) {
                    return lookupStatic(java.lang.invoke.MethodHandles.publicLookup(), String.class, "valueOf", String.class, boolean.class);
                } else if (cl == char.class) {
                    return lookupStatic(java.lang.invoke.MethodHandles.publicLookup(), String.class, "valueOf", String.class, char.class);
                } else if (cl == long.class) {
                    return lookupStatic(MethodHandles.publicLookup(), String.class, "valueOf", String.class, long.class);
                } else {
                    java.lang.invoke.MethodHandle mh = STRINGIFIERS_MOST.get(cl);
                    if (mh != null) {
                        return mh;
                    } else {
        ...
        private static final ClassValue<java.lang.invoke.MethodHandle> STRINGIFIERS_MOST = new StringifierMost();
        private static final ClassValue<java.lang.invoke.MethodHandle> STRINGIFIERS_ANY = new StringifierAny();
         ...
         */
        static java.lang.invoke.MethodHandle forMost(Class<?> t) {
         ...
         * @return stringifier
         */
        static java.lang.invoke.MethodHandle forAny(Class<?> t) {
    ...
    static java.lang.invoke.MethodHandle lookupStatic(Lookup lookup, Class<?> refc, String name, Class<?> rtype, Class<?>... ptypes) {
        try {
            return lookup.findStatic(refc, name, java.lang.invoke.MethodType.methodType(rtype, ptypes));
        } catch (NoSuchMethodException | IllegalAccessException e) {
            throw new AssertionError(e);
        }
    }

    static java.lang.invoke.MethodHandle lookupVirtual(Lookup lookup, Class<?> refc, String name, Class<?> rtype, Class<?>... ptypes) {
        try {
            return lookup.findVirtual(refc, name, java.lang.invoke.MethodType.methodType(rtype, ptypes));
        } catch (NoSuchMethodException | IllegalAccessException e) {
            throw new AssertionError(e);
        }
    }
