...
class FdLibm {
    ...
    private static int __LO(double x) {
        long transducer = java.lang.Double.doubleToRawLongBits(x);
    ...
    private static double __LO(double x, int low) {
        long transX = java.lang.Double.doubleToRawLongBits(x);
        return java.lang.Double.longBitsToDouble((transX & 0xFFFF_FFFF_0000_0000L) |
    ...
    private static double __HI(double x, int high) {
        long transX = java.lang.Double.doubleToRawLongBits(x);
        return java.lang.Double.longBitsToDouble((transX & 0x0000_0000_FFFF_FFFFL) |
                                       ( ((long)high)) << 32 );
    }
    ...
    public static class Cbrt {
        ...
        public static strictfp double compute(double x) {
            ...
            if (x == 0.0 || !java.lang.Double.isFinite(x))
                return x; // Handles signed zeros properly

            sign = (x < 0.0) ? -1.0:  1.0;

            x = java.lang.Math.abs(x);   // x <- |x|
    ...
    public static class Hypot {
        ...
        public static strictfp double compute(double x, double y) {
            ...
            double b = java.lang.Math.abs(y);

            if (!java.lang.Double.isFinite(a) || !java.lang.Double.isFinite(b)) {
            ...
            if (b < 0x1.0p-500) {   // b < 2**-500
                if (b < java.lang.Double.MIN_NORMAL) {      // subnormal b or 0 */
                    if (b == 0.0)
                        return a;
            ...
            if (w > b) {
                ...
                t1 = __HI(t1, ha);
                t2 = a - t1;
                w  = java.lang.Math.sqrt(t1*t1 - (b*(-b) - t2 * (a + t1)));
            } else {
                double y1, y2;
                a  = a + a;
                y1 = 0;
                ...
                t2 = a - t1;
                w  = java.lang.Math.sqrt(t1*y1 - (w*(-w) - (t1*y2 + t2*b)));
            }
            if (k != 0) {
                return java.lang.Math.powerOfTwoD(k) * w;
            } else
                return w;
        }
    }
    ...
    public static class Pow {
        ...
        public static strictfp double compute(final double x, final double y) {
            ...
            if (y == 2.0) {
                ...
                if (x >= -java.lang.Double.MAX_VALUE) // Handle x == -infinity later
