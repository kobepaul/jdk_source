...
class Character implements java.io.Serializable, Comparable<Character> {
    ...
    * Strong bidirectional character type "AL" in the Unicode specification.
    ...
    public static final class UnicodeBlock extends Subset {
         ...
         */
        private static Map<java.lang.String, UnicodeBlock> map =
        ...
        public static UnicodeBlock of(int codePoint) {
            if (!isValidCodePoint(codePoint)) {
                throw new IllegalArgumentException(
                    java.lang.String.format("Not a valid Unicode code point: 0x%X", codePoint));
            }
    ...
    public static java.lang.String toString(int codePoint) {
        return java.lang.String.valueOfCodePoint(codePoint);
    }
    ...
    public static java.lang.String getName(int codePoint) {
        ...
        java.lang.String name = CharacterName.getInstance().getName(codePoint);
        if (name != null)
            return name;
        ...
        if (block != null)
            return block.toString().replace('_', ' ') + " "
                   + java.lang.Integer.toHexString(codePoint).toUpperCase(Locale.ROOT);
        // should never come here
        return java.lang.Integer.toHexString(codePoint).toUpperCase(Locale.ROOT);
    }
     ...
     * @since 9
     */
    public static int codePointOf(java.lang.String name) {
        ...
        try {
            ...
            if (off != -1) {
                cp = java.lang.Integer.parseInt(name, off + 1, name.length(), 16);
