...
final class PublicMethods {
    ...
    private static final class Key {
        ...
        private final java.lang.String name; // must be interned (as from Method.getName())
        private final java.lang.Class<?>[] ptypes;
        ...
        static boolean matches(Method method,
                               java.lang.String name, // may not be interned
        ...
        @java.lang.Override
        public int hashCode() {
            return java.lang.System.identityHashCode(name) + // guaranteed interned String
    ...
    static final class MethodList {
         ...
         */
        static MethodList filter(Method[] methods, java.lang.String name,
                                 java.lang.Class<?>[] ptypes, boolean includeStatic) {
        ...
        private static MethodList merge(MethodList head, Method method) {
            java.lang.Class<?> dclass = method.getDeclaringClass();
            java.lang.Class<?> rtype = method.getReturnType();
            ...
            for (MethodList l = head; l != null; l = l.next) {
                ...
                if (rtype == xmethod.getReturnType()) {
                    java.lang.Class<?> xdclass = xmethod.getDeclaringClass();
        ...
        Method getMostSpecific() {
            ...
            for (MethodList ml = next; ml != null; ml = ml.next) {
                Method m2 = ml.method;
                java.lang.Class<?> rt2 = m2.getReturnType();
