...
final class WeakPairMap<K1, K2, V> {
    ...
    private final ReferenceQueue<java.lang.Object> queue = new ReferenceQueue<>();
    ...
    private interface Pair<K1, K2> {
        ...
        static <K1, K2> Pair<K1, K2> weak(K1 k1, K2 k2,
                                          ReferenceQueue<java.lang.Object> queue) {
        ...
        static int hashCode(java.lang.Object first, java.lang.Object second) {
            // assert first != null && second != null;
            return java.lang.System.identityHashCode(first) ^
                   java.lang.System.identityHashCode(second);
        }

        static boolean equals(java.lang.Object first, java.lang.Object second, Pair<?, ?> p) {
        ...
        final class Weak<K1, K2> extends WeakRefPeer<K1> implements Pair<K1, K2> {
            ...
            Weak(K1 k1, K2 k2, ReferenceQueue<java.lang.Object> queue) {
                super(k1, queue);
                hash = Pair.hashCode(k1, k2);
                peer = new WeakRefPeer<>(k2, queue) {
                    // link back to <K1> peer
                    @java.lang.Override
                    java.lang.WeakPairMap.Pair.Weak<?, ?> weakPair() { return java.lang.WeakPairMap.Pair.Weak.this; }
                };
            }
         ...
         * {@link java.util.Map#get(java.lang.Object)} or
         * {@link java.util.Map#containsKey(java.lang.Object)}) where
    ...
    private static abstract class WeakRefPeer<K> extends WeakReference<K> {
        ...
        WeakRefPeer(K k, ReferenceQueue<java.lang.Object> queue) {
