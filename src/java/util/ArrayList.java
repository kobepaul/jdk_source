        ...
        implements java.util.List<E>, RandomAccess, Cloneable, java.io.Serializable
{
    ...
    private Object[] grow(int minCapacity) {
        return elementData = java.util.Arrays.copyOf(elementData,
    ...
    public boolean equals(Object o) {
        ...
        boolean equal = (o.getClass() == ArrayList.class)
            ...
            : equalsRange((java.util.List<?>) o, 0, size);

        checkForComodification(expectedModCount);
        return equal;
    }

    boolean equalsRange(java.util.List<?> other, int from, int to) {
        final Object[] es = elementData;
        if (to > es.length) {
        ...
        for (; from < to; from++) {
            if (!oit.hasNext() || !java.util.Objects.equals(es[from], oit.next())) {
                return false;
            }
        }
        return !oit.hasNext();
    ...
    private boolean equalsArrayList(ArrayList<?> other) {
        ...
        if (equal = (s == other.size)) {
            ...
            for (int i = 0; i < s; i++) {
                if (!java.util.Objects.equals(es[i], otherEs[i])) {
                    equal = false;
                    break;
                }
            }
    ...
    private static class SubList<E> extends AbstractList<E> implements RandomAccess {
        ...
        public Object[] toArray() {
            checkForComodification();
            return java.util.Arrays.copyOfRange(root.elementData, offset, offset + size);
        }
        ...
        public <T> T[] toArray(T[] a) {
            checkForComodification();
            if (a.length < size)
                return (T[]) java.util.Arrays.copyOfRange(
        ...
        public boolean equals(Object o) {
            ...
            boolean equal = root.equalsRange((java.util.List<?>)o, offset, offset + size);
            checkForComodification();
            return equal;
        }
