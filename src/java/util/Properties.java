...
class Properties extends java.util.Hashtable<Object,Object> {
    ...
    public synchronized void load(Reader reader) throws IOException {
        java.util.Objects.requireNonNull(reader, "reader parameter is null");
    ...
    public synchronized void load(InputStream inStream) throws IOException {
        java.util.Objects.requireNonNull(inStream, "inStream parameter is null");
    ...
    public void storeToXML(OutputStream os, String comment, Charset charset)
        throws IOException {
        java.util.Objects.requireNonNull(os, "OutputStream");
    ...
    public void list(PrintStream out) {
        ...
        enumerate(h);
        for (java.util.Map.Entry<String, Object> e : h.entrySet()) {
            String key = e.getKey();
            String val = (String)e.getValue();
            if (val.length() > 40) {
     ...
     */
    private void enumerate(java.util.Map<String, Object> h) {
        if (defaults != null) {
     ...
     * @param h the Map
     */
    private void enumerateStringProperties(java.util.Map<String, String> h) {
        if (defaults != null) {
     ...
     */
    private static class EntrySet implements java.util.Set<java.util.Map.Entry<Object, Object>> {
        private java.util.Set<java.util.Map.Entry<Object,Object>> entrySet;

        private EntrySet(Set<java.util.Map.Entry<Object, Object>> entrySet) {
        ...
        @Override
        public boolean addAll(java.util.Collection<? extends java.util.Map.Entry<Object, Object>> c) {
            throw new UnsupportedOperationException();
        }
