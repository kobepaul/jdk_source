...
public class Collections {
     ...
     *
     * @implNote
     * This implementation defers to the {@link java.util.List#sort(java.util.Comparator)}
    ...
    static class UnmodifiableNavigableMap<K,V>
        ...
        private static class EmptyNavigableMap<K,V> extends UnmodifiableNavigableMap<K,V>
            ...
            EmptyNavigableMap()                       { super(new java.util.TreeMap<>()); }
     ...
     * {@code headSet}, or {@code tailSet} views via {@link java.util.Iterator},
     ...
     *
     * It is imperative that the user manually synchronize on the returned
     * list when traversing it via {@link java.util.Iterator}, {@link Spliterator}
     * or {@link Stream}:
     * <pre>
     ...
     *
     * It is imperative that the user manually synchronize on the returned
     * map when traversing any of its collection views via {@link java.util.Iterator},
     * {@link Spliterator} or {@link Stream}:
     * <pre>
     ...
     * {@code tailMap} views, via {@link java.util.Iterator}, {@link Spliterator} or
     * {@link Stream}:
     * <pre>
...
/**
    ...
    private static class EmptyEnumeration<E> implements Enumeration<E> {
        ...
        public java.util.Iterator<E> asIterator() { return emptyIterator(); }
    }
        ...
        implements Serializable
    {
        ...
        @Override
        public int hashCode() {
            return java.util.Objects.hashCode(element);
        }
    }
    ...
    private static class SingletonList<E>
        ...
        @Override
        public int hashCode() {
            return 31 + java.util.Objects.hashCode(element);
        }
    }
    ...
    private static class SingletonMap<K,V>
        ...
        @Override
        public int hashCode() {
            return java.util.Objects.hashCode(k) ^ java.util.Objects.hashCode(v);
        }
    }
     ...
     * {@link java.util.Queue}. Method {@code add} is mapped to {@code push},
