...
public final class Currency implements Serializable {
    ...
    static java.util.List<SpecialCaseEntry> specialCasesList;
    static java.util.List<OtherCurrencyEntry> otherCurrenciesList;
                    ...
                    if (propFile.exists()) {
                        ...
                        Pattern propertiesPattern =
                                Pattern.compile("([A-Z]{3})\\s*,\\s*(\\d{3})\\s*,\\s*" +
                                        ...
                                        "\\d{2}:\\d{2})?");
                        java.util.List<CurrencyProperty> currencyEntries
    ...
    public static Currency getInstance(java.util.Locale locale) {
        ...
        if (override != null) {
            try {
                return getInstance(override.toUpperCase(java.util.Locale.ROOT));
    ...
    public static java.util.Set<Currency> getAvailableCurrencies() {
        ...
        java.util.Set<Currency> result = (java.util.Set<Currency>) available.clone();
        return result;
    }
     ...
     * <p>
     * If the default {@link java.util.Locale.Category#DISPLAY DISPLAY} locale
    ...
    */
    ...
    private static java.util.List<SpecialCaseEntry> readSpecialCases(DataInputStream dis,
                                                                     int count)
            throws IOException {

        java.util.List<SpecialCaseEntry> list = new ArrayList<>(count);
        long cutOverTime;
        String oldCurrency;
        String newCurrency;
    ...
    private static java.util.List<OtherCurrencyEntry> readOtherCurrencies(DataInputStream dis,
                                                                          int count)
            throws IOException {

        java.util.List<OtherCurrencyEntry> list = new ArrayList<>(count);
        String currencyCode;
        int fraction;
        int numericCode;
     ...
     */
    private static java.util.List<CurrencyProperty> getValidCurrencyData(Properties props,
                                                                         Pattern pattern) {

        Set<String> keys = props.stringPropertyNames();
        java.util.List<CurrencyProperty> propertyEntries = new ArrayList<>();
        ...
        Map<String, java.util.List<CurrencyProperty>> currencyCodeGroup = keys.stream()
                .map(k -> CurrencyProperty
                .getValidEntry(k.toUpperCase(java.util.Locale.ROOT),
                        props.getProperty(k).toUpperCase(java.util.Locale.ROOT),
