...
public final class Scanner implements Iterator<String>, Closeable {
    ...
    public Scanner(InputStream source, Charset charset) {
        this(makeReadable(java.util.Objects.requireNonNull(source, "source"), charset),
             WHITESPACE_PATTERN);
    }
    ...
    */
    ...
    public Scanner(File source, Charset charset) throws IOException {
        this(java.util.Objects.requireNonNull(source), charset.newDecoder());
    }
    ...
    public Scanner reset() {
        ...
        useLocale(java.util.Locale.getDefault(Locale.Category.FORMAT));
        useRadix(10);
        clearCaches();
        modCount++;
        return this;
