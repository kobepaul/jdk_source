 ...
 * control.
 *
 * <p>A SubmissionPublisher uses the {@link java.util.concurrent.Executor} supplied in its
 ...
 * default, normally the {@link java.util.concurrent.ForkJoinPool#commonPool}.
 *
 ...
 * java.util.concurrent.Flow#defaultBufferSize()} may provide a useful starting point for
 ...
 * }}</pre>
 *
 * <p>Here is an example of a {@link java.util.concurrent.Flow.Processor} implementation.
...
public class SubmissionPublisher<T> implements Publisher<T>,
     ...
     * positive
     */
    public SubmissionPublisher(java.util.concurrent.Executor executor, int maxBufferCapacity,
     ...
     * java.util.concurrent.ForkJoinPool#commonPool()} for async delivery to subscribers
     * (unless it does not support a parallelism level of at least two,
     * in which case, a new Thread is created to run each task), with
     * maximum buffer capacity of {@link java.util.concurrent.Flow#defaultBufferSize}, and no
     * handler for Subscriber exceptions in method {@link
     * Subscriber#onNext(Object) onNext}.
     */
    public SubmissionPublisher() {
        this(ASYNC_POOL, java.util.concurrent.Flow.defaultBufferSize(), null);
    }
     ...
     */
    public java.util.concurrent.CompletableFuture<Void> consume(Consumer<? super T> consumer) {
        if (consumer == null)
            throw new NullPointerException();
        java.util.concurrent.CompletableFuture<Void> status = new java.util.concurrent.CompletableFuture<>();
    ...
    static final class ConsumerSubscriber<T> implements Subscriber<T> {
        final java.util.concurrent.CompletableFuture<Void> status;
        final Consumer<? super T> consumer;
        Subscription subscription;
        ConsumerSubscriber(java.util.concurrent.CompletableFuture<Void> status,
    ...
    static final class BufferedSubscription<T>
        implements Subscription, java.util.concurrent.ForkJoinPool.ManagedBlocker {
        ...
        final BiConsumer<? super Subscriber<? super T>, ? super Throwable> onNextHandler;
        java.util.concurrent.Executor executor;                 // null on error
        ...
        final void awaitSpace(long nanos) {
            if (!isReleasable()) {
                java.util.concurrent.ForkJoinPool.helpAsyncBlocker(executor, this);
                if (!isReleasable()) {
                    timeout = nanos;
                    try {
