 ...
 * {@linkplain java.util.concurrent.ForkJoinPool#ForkJoinPool(int, ForkJoinWorkerThreadFactory,
...
public class ForkJoinWorkerThread extends Thread {
     ...
     */
    ForkJoinWorkerThread(java.util.concurrent.ForkJoinPool pool, ClassLoader ccl) {
        super("aForkJoinWorkerThread");
    ...
    ForkJoinWorkerThread(java.util.concurrent.ForkJoinPool pool,
        ...
        super.setContextClassLoader(ccl);
        java.util.concurrent.ThreadLocalRandom.setInheritedAccessControlContext(this, acc);
        java.util.concurrent.ThreadLocalRandom.eraseThreadLocals(this); // clear before registering
        this.pool = pool;
        this.workQueue = pool.registerWorker(this);
    }
