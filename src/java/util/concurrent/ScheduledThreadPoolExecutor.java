 ...
 * this class uses {@link java.util.concurrent.Executors#defaultThreadFactory} as the
 * default thread factory, and {@link java.util.concurrent.ThreadPoolExecutor.AbortPolicy}
...
public class ScheduledThreadPoolExecutor
    ...
    private class ScheduledFutureTask<V>
         ...
         * Creates a one-shot action with given nanoTime-based trigger time.
         */
        ScheduledFutureTask(java.util.concurrent.Callable<V> callable, long triggerTime,
                            long sequenceNumber) {
            super(callable);
            this.time = triggerTime;
            this.period = 0;
     ...
     */
    boolean canRunInCurrentRunState(java.util.concurrent.RunnableScheduledFuture<?> task) {
        if (!isShutdown())
            return true;
        if (isStopped())
            return false;
    ...
    @Override void onShutdown() {
        ...
        for (Object e : q.toArray()) {
            if (e instanceof java.util.concurrent.RunnableScheduledFuture) {
                java.util.concurrent.RunnableScheduledFuture<?> t = (java.util.concurrent.RunnableScheduledFuture<?>)e;
                if ((t.isPeriodic()
                     ? !keepPeriodic
    ...
    private long overflowFree(long delay) {
        java.util.concurrent.Delayed head = (Delayed) super.getQueue().peek();
        if (head != null) {
    ...
    public java.util.concurrent.ScheduledFuture<?> schedule(Runnable command,
        ...
        java.util.concurrent.RunnableScheduledFuture<Void> t = decorateTask(command,
     ...
     * {@link java.util.concurrent.ExecutionException}, holding the exception as its cause.
     * </ul>
    ...
    static class DelayedWorkQueue extends AbstractQueue<Runnable>
         ...
         */
        private static void setIndex(java.util.concurrent.RunnableScheduledFuture<?> f, int idx) {
        ...
        public java.util.concurrent.RunnableScheduledFuture<?> poll(long timeout, TimeUnit unit)
        ...
        public int drainTo(Collection<? super Runnable> c, int maxElements) {
            ...
            try {
                int n = 0;
                for (java.util.concurrent.RunnableScheduledFuture<?> first;
                     n < maxElements
                         && (first = queue[0]) != null
