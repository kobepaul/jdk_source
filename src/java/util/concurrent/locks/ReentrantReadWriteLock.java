...
public class ReentrantReadWriteLock
    ...
    abstract static class Sync extends AbstractQueuedSynchronizer {
        ...
        static final class HoldCounter {
            ...
            final long tid = java.util.concurrent.locks.LockSupport.getThreadId(Thread.currentThread());
        }
        ...
        protected final boolean tryReleaseShared(int unused) {
            ...
            if (firstReader == current) {
                ...
                if (rh == null ||
                    rh.tid != java.util.concurrent.locks.LockSupport.getThreadId(current))
                    rh = readHolds.get();
                int count = rh.count;
                if (count <= 1) {
                    readHolds.remove();
