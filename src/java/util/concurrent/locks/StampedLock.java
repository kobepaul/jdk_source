 ...
 * {@link java.util.concurrent.locks.Lock} implementations, StampedLocks have no notion of ownership.
...
public class StampedLock implements java.io.Serializable {
     ...
     * support a {@link java.util.concurrent.locks.Condition}; method {@link java.util.concurrent.locks.Lock#newCondition()}
    ...
    final class ReadLockView implements java.util.concurrent.locks.Lock {
    ...
    final class WriteLockView implements java.util.concurrent.locks.Lock {
    ...
    final class ReadWriteLockView implements ReadWriteLock {
        public java.util.concurrent.locks.Lock readLock() { return asReadLock(); }
    ...
    private long tryIncReaderOverflow(long s) {
        ...
        else if ((java.util.concurrent.locks.LockSupport.nextSecondarySeed() & OVERFLOW_YIELD_RATE) == 0)
            Thread.yield();
        else
            Thread.onSpinWait();
        return 0L;
                ...
                if ((np = node.prev) != p) {
                    ...
                    if (p.status < 0 && (p != h || (state & ABITS) != 0L) &&
                        ...
                        if (time == 0L)
                            ...
                            java.util.concurrent.locks.LockSupport.parkNanos(this, time);
                    }
                    node.thread = null;
                    if (Thread.interrupted()) {
                        if (interruptible)
        ...
        if (node != null && group != null) {
            ...
            if (group == node) {
                for (WNode r = group.cowait; r != null; r = r.cowait) {
                    if ((w = r.thread) != null)
                        java.util.concurrent.locks.LockSupport.unpark(w); // wake up uncancelled co-waiters
                }
