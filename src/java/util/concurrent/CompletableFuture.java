 ...
 * value and status), and may be used as a {@link java.util.concurrent.CompletionStage},
 ...
 * interface {@link java.util.concurrent.CompletionStage} with the following policies: <ul>
 *
 ...
 * argument are performed using the {@link java.util.concurrent.ForkJoinPool#commonPool()}
...
public class CompletableFuture<T> implements java.util.concurrent.Future<T>, java.util.concurrent.CompletionStage<T> {
    ...
    private static final java.util.concurrent.Executor ASYNC_POOL = USE_COMMON_POOL ?
        java.util.concurrent.ForkJoinPool.commonPool() : new ThreadPerTaskExecutor();
    ...
    static java.util.concurrent.Executor screenExecutor(java.util.concurrent.Executor e) {
        if (!USE_COMMON_POOL && e == java.util.concurrent.ForkJoinPool.commonPool())
            return ASYNC_POOL;
    ...
    abstract static class Completion extends java.util.concurrent.ForkJoinTask<Void>
    ...
    abstract static class UniCompletion<T,V> extends Completion {
        java.util.concurrent.Executor executor;                 // executor to use (null if none)
        CompletableFuture<V> dep;          // the dependent to complete
        CompletableFuture<T> src;          // source for action

        UniCompletion(java.util.concurrent.Executor executor, CompletableFuture<V> dep,
    ...
    static final class UniApply<T,V> extends UniCompletion<T,V> {
        ...
        UniApply(java.util.concurrent.Executor executor, CompletableFuture<V> dep,
                 CompletableFuture<T> src,
                 Function<? super T,? extends V> fn) {
    ...
    private <V> CompletableFuture<V> uniApplyStage(
            java.util.concurrent.Executor e, Function<? super T,? extends V> f) {
    ...
    private <V> CompletableFuture<V> uniApplyNow(
            Object r, java.util.concurrent.Executor e, Function<? super T,? extends V> f) {
        Throwable x;
        CompletableFuture<V> d = newIncompleteFuture();
        if (r instanceof AltResult) {
            if ((x = ((AltResult)r).ex) != null) {
    ...
    static final class UniAccept<T> extends UniCompletion<T,Void> {
        Consumer<? super T> fn;
        UniAccept(java.util.concurrent.Executor executor, CompletableFuture<Void> dep,
    ...
    private CompletableFuture<Void> uniAcceptStage(java.util.concurrent.Executor e,
                                                   Consumer<? super T> f) {
        if (f == null) throw new NullPointerException();
        Object r;
        if ((r = result) != null)
    ...
    private CompletableFuture<Void> uniAcceptNow(
            Object r, java.util.concurrent.Executor e, Consumer<? super T> f) {
        Throwable x;
        CompletableFuture<Void> d = newIncompleteFuture();
        if (r instanceof AltResult) {
            if ((x = ((AltResult)r).ex) != null) {
    ...
    static final class UniRun<T> extends UniCompletion<T,Void> {
        Runnable fn;
        UniRun(java.util.concurrent.Executor executor, CompletableFuture<Void> dep,
    ...
    private CompletableFuture<Void> uniRunStage(java.util.concurrent.Executor e, Runnable f) {
        if (f == null) throw new NullPointerException();
        Object r;
        if ((r = result) != null)
    ...
    private CompletableFuture<Void> uniRunNow(Object r, java.util.concurrent.Executor e, Runnable f) {
        Throwable x;
        CompletableFuture<Void> d = newIncompleteFuture();
        if (r instanceof AltResult && (x = ((AltResult)r).ex) != null)
            d.result = encodeThrowable(x, r);
    ...
    static final class UniWhenComplete<T> extends UniCompletion<T,T> {
        ...
        UniWhenComplete(java.util.concurrent.Executor executor, CompletableFuture<T> dep,
                        CompletableFuture<T> src,
                        BiConsumer<? super T, ? super Throwable> fn) {
            super(executor, dep, src); this.fn = fn;
        }
    ...
    private CompletableFuture<T> uniWhenCompleteStage(
            java.util.concurrent.Executor e, BiConsumer<? super T, ? super Throwable> f) {
        if (f == null) throw new NullPointerException();
    ...
    static final class UniHandle<T,V> extends UniCompletion<T,V> {
        ...
        UniHandle(java.util.concurrent.Executor executor, CompletableFuture<V> dep,
                  CompletableFuture<T> src,
                  BiFunction<? super T, Throwable, ? extends V> fn) {
            super(executor, dep, src); this.fn = fn;
        }
    ...
    private <V> CompletableFuture<V> uniHandleStage(
            java.util.concurrent.Executor e, BiFunction<? super T, Throwable, ? extends V> f) {
        if (f == null) throw new NullPointerException();
        CompletableFuture<V> d = newIncompleteFuture();
        Object r;
        if ((r = result) == null)
    ...
    static final class UniCompose<T,V> extends UniCompletion<T,V> {
        Function<? super T, ? extends java.util.concurrent.CompletionStage<V>> fn;
        UniCompose(java.util.concurrent.Executor executor, CompletableFuture<V> dep,
                   CompletableFuture<T> src,
                   Function<? super T, ? extends java.util.concurrent.CompletionStage<V>> fn) {
            super(executor, dep, src); this.fn = fn;
        }
        final CompletableFuture<V> tryFire(int mode) {
            CompletableFuture<V> d; CompletableFuture<T> a;
            Function<? super T, ? extends java.util.concurrent.CompletionStage<V>> f;
    ...
    private <V> CompletableFuture<V> uniComposeStage(
            java.util.concurrent.Executor e, Function<? super T, ? extends java.util.concurrent.CompletionStage<V>> f) {
        if (f == null) throw new NullPointerException();
        CompletableFuture<V> d = newIncompleteFuture();
    ...
    abstract static class BiCompletion<T,U,V> extends UniCompletion<T,V> {
        ...
        BiCompletion(java.util.concurrent.Executor executor, CompletableFuture<V> dep,
    ...
    static final class BiApply<T,U,V> extends BiCompletion<T,U,V> {
        ...
        BiApply(java.util.concurrent.Executor executor, CompletableFuture<V> dep,
                CompletableFuture<T> src, CompletableFuture<U> snd,
                BiFunction<? super T,? super U,? extends V> fn) {
    ...
    private <U,V> CompletableFuture<V> biApplyStage(
            java.util.concurrent.Executor e, java.util.concurrent.CompletionStage<U> o,
    ...
    static final class BiAccept<T,U> extends BiCompletion<T,U,Void> {
        ...
        BiAccept(java.util.concurrent.Executor executor, CompletableFuture<Void> dep,
                 CompletableFuture<T> src, CompletableFuture<U> snd,
                 BiConsumer<? super T,? super U> fn) {
            super(executor, dep, src, snd); this.fn = fn;
        }
    ...
    static final class BiRun<T,U> extends BiCompletion<T,U,Void> {
        Runnable fn;
        BiRun(java.util.concurrent.Executor executor, CompletableFuture<Void> dep,
              CompletableFuture<T> src, CompletableFuture<U> snd,
              Runnable fn) {
            super(executor, dep, src, snd); this.fn = fn;
        }
    ...
    private CompletableFuture<Void> biRunStage(java.util.concurrent.Executor e, java.util.concurrent.CompletionStage<?> o,
                                               Runnable f) {
    ...
    static final class OrApply<T,U extends T,V> extends BiCompletion<T,U,V> {
        Function<? super T,? extends V> fn;
        OrApply(java.util.concurrent.Executor executor, CompletableFuture<V> dep,
                CompletableFuture<T> src, CompletableFuture<U> snd,
                Function<? super T,? extends V> fn) {
            super(executor, dep, src, snd); this.fn = fn;
        }
    ...
    private <U extends T,V> CompletableFuture<V> orApplyStage(
            java.util.concurrent.Executor e, java.util.concurrent.CompletionStage<U> o, Function<? super T, ? extends V> f) {
        CompletableFuture<U> b;
        if (f == null || (b = o.toCompletableFuture()) == null)
            throw new NullPointerException();
    ...
    static final class OrAccept<T,U extends T> extends BiCompletion<T,U,Void> {
        Consumer<? super T> fn;
        OrAccept(java.util.concurrent.Executor executor, CompletableFuture<Void> dep,
                 CompletableFuture<T> src, CompletableFuture<U> snd,
                 Consumer<? super T> fn) {
            super(executor, dep, src, snd); this.fn = fn;
        }
    ...
    private <U extends T> CompletableFuture<Void> orAcceptStage(
            java.util.concurrent.Executor e, java.util.concurrent.CompletionStage<U> o, Consumer<? super T> f) {
        CompletableFuture<U> b;
        if (f == null || (b = o.toCompletableFuture()) == null)
            throw new NullPointerException();
    ...
    static final class OrRun<T,U> extends BiCompletion<T,U,Void> {
        Runnable fn;
        OrRun(java.util.concurrent.Executor executor, CompletableFuture<Void> dep,
              CompletableFuture<T> src, CompletableFuture<U> snd,
              Runnable fn) {
            super(executor, dep, src, snd); this.fn = fn;
        }
    ...
    private CompletableFuture<Void> orRunStage(java.util.concurrent.Executor e, java.util.concurrent.CompletionStage<?> o,
                                               Runnable f) {
        CompletableFuture<?> b;
        if (f == null || (b = o.toCompletableFuture()) == null)
            throw new NullPointerException();
    ...
    @SuppressWarnings("serial")
    static final class AsyncSupply<T> extends java.util.concurrent.ForkJoinTask<Void>
        implements Runnable, AsynchronousCompletionTask {
    ...
    static <U> CompletableFuture<U> asyncSupplyStage(java.util.concurrent.Executor e,
                                                     Supplier<U> f) {
        if (f == null) throw new NullPointerException();
    ...
    static CompletableFuture<Void> asyncRunStage(java.util.concurrent.Executor e, Runnable f) {
        if (f == null) throw new NullPointerException();
        CompletableFuture<Void> d = new CompletableFuture<Void>();
        ...
        while ((r = result) == null) {
            if (q == null) {
                ...
                if (Thread.currentThread() instanceof ForkJoinWorkerThread)
                    java.util.concurrent.ForkJoinPool.helpAsyncBlocker(defaultExecutor(), q);
            }
            else if (!queued)
     ...
     */
    private Object timedGet(long nanos) throws java.util.concurrent.TimeoutException {
        if (Thread.interrupted())
            return null;
        if (nanos > 0L) {
     ...
     * by a task running in the {@link java.util.concurrent.ForkJoinPool#commonPool()} with
    ...
    /**
     * Returns a new CompletableFuture that is asynchronously completed
     * by a task running in the {@link java.util.concurrent.ForkJoinPool#commonPool()} after
    ...
    public <U> CompletableFuture<U> thenApplyAsync(
        Function<? super T,? extends U> fn, java.util.concurrent.Executor executor) {
    ...
    public <U,V> CompletableFuture<V> thenCombineAsync(
        java.util.concurrent.CompletionStage<? extends U> other,
        BiFunction<? super T,? super U,? extends V> fn, java.util.concurrent.Executor executor) {
    ...
    public <U> CompletableFuture<Void> thenAcceptBothAsync(
        java.util.concurrent.CompletionStage<? extends U> other,
        BiConsumer<? super T, ? super U> action, java.util.concurrent.Executor executor) {
        return biAcceptStage(screenExecutor(executor), other, action);
    }

    public CompletableFuture<Void> runAfterBoth(java.util.concurrent.CompletionStage<?> other,
                                                Runnable action) {
        return biRunStage(null, other, action);
    }

    public CompletableFuture<Void> runAfterBothAsync(java.util.concurrent.CompletionStage<?> other,
                                                     Runnable action) {
    ...
    public <U> CompletableFuture<U> applyToEither(
            java.util.concurrent.CompletionStage<? extends T> other, Function<? super T, U> fn) {
    ...
    public CompletableFuture<Void> acceptEither(
            java.util.concurrent.CompletionStage<? extends T> other, Consumer<? super T> action) {
    ...
    public CompletableFuture<Void> runAfterEither(java.util.concurrent.CompletionStage<?> other,
                                                  Runnable action) {
        return orRunStage(null, other, action);
    }

    public CompletableFuture<Void> runAfterEitherAsync(java.util.concurrent.CompletionStage<?> other,
                                                       Runnable action) {
    ...
    public CompletableFuture<T> whenCompleteAsync(
        BiConsumer<? super T, ? super Throwable> action, java.util.concurrent.Executor executor) {
    ...
    public <U> CompletableFuture<U> handleAsync(
        BiFunction<? super T, Throwable, ? extends U> fn, java.util.concurrent.Executor executor) {
     ...
     * java.util.concurrent.CompletionStage}.  If this CompletableFuture completes
     ...
     * a {@link java.util.concurrent.TimeoutException} if not otherwise completed
     ...
     * @since 9
     */
    public static java.util.concurrent.Executor delayedExecutor(long delay, java.util.concurrent.TimeUnit unit,
                                                                java.util.concurrent.Executor executor) {
     ...
     * interface {@link java.util.concurrent.CompletionStage}.
     *
     * @param value the value
     * @param <U> the type of the value
     ...
     * @since 9
     */
    public static <U> java.util.concurrent.CompletionStage<U> completedStage(U value) {
     ...
     * methods in interface {@link java.util.concurrent.CompletionStage}.
     *
     * @param ex the exception
     * @param <U> the type of the value
    ...
    static final class DelayedExecutor implements java.util.concurrent.Executor {
        final long delay;
    ...
    static final class TaskSubmitter implements Runnable {
        ...
        TaskSubmitter(java.util.concurrent.Executor executor, Runnable action) {
    ...
    static final class MinimalStage<T> extends CompletableFuture<T> {
        ...
        @Override public <U> CompletableFuture<U> newIncompleteFuture() {
            return new java.util.concurrent.CompletableFuture.MinimalStage<U>(); }
        ...
        @Override public CompletableFuture<T> toCompletableFuture() {
            ...
            if ((r = result) != null)
                ...
                unipush(new java.util.concurrent.CompletableFuture.UniRelay<T,T>(d, this));
                return d;
            }
        }
    }
