...
/**
 * A specialized {@link java.util.Map} implementation for use with enum type keys.  All
    ...
    implements java.io.Serializable, Cloneable
{
     ...
     * {@link java.util.Map#keySet()}.  The set's iterator will return the keys
     ...
     * {@link java.util.Map#values()}.  The collection's iterator will return the
     ...
     * The returned set obeys the general contract outlined in
     * {@link java.util.Map#keySet()}.  The set's iterator will return the
     ...
     * java.util.Map#equals(Object)} contract.
     *
