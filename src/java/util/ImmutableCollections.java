...
class ImmutableCollections {
    ...
    static abstract class AbstractImmutableCollection<E> extends AbstractCollection<E> {
        ...
        @Override public boolean addAll(java.util.Collection<? extends E> c) { throw uoe(); }
        @Override public void    clear() { throw uoe(); }
        @Override public boolean remove(Object o) { throw uoe(); }
        @Override public boolean removeAll(java.util.Collection<?> c) { throw uoe(); }
        @Override public boolean removeIf(Predicate<? super E> filter) { throw uoe(); }
        @Override public boolean retainAll(java.util.Collection<?> c) { throw uoe(); }
    }
    ...
    static <E> java.util.List<E> listCopy(java.util.Collection<? extends E> coll) {
        if (coll instanceof AbstractImmutableList && coll.getClass() != SubList.class) {
            return (java.util.List<E>)coll;
        } else {
    ...
    static abstract class AbstractImmutableList<E> extends AbstractImmutableCollection<E>
        ...
        @Override public boolean addAll(int index, java.util.Collection<? extends E> c) { throw uoe(); }
    ...
    static final class ListItr<E> implements java.util.ListIterator<E> {
    ...
    static final class List12<E> extends AbstractImmutableList<E>
        ...
        List12(E e0) {
            this.e0 = java.util.Objects.requireNonNull(e0);
            this.e1 = null;
        }

        List12(E e0, E e1) {
            this.e0 = java.util.Objects.requireNonNull(e0);
            this.e1 = java.util.Objects.requireNonNull(e1);
        }
    ...
    static final class ListN<E> extends AbstractImmutableList<E>
        ...
        static final java.util.List<?> EMPTY_LIST = new ListN<>();
        ...
        ListN(E... input) {
            ...
            for (int i = 0; i < input.length; i++) {
                tmp[i] = java.util.Objects.requireNonNull(input[i]);
            }
            elements = tmp;
        }
    ...
    static final class Set12<E> extends AbstractImmutableSet<E>
        ...
        Set12(E e0, E e1) {
            if (e0.equals(java.util.Objects.requireNonNull(e1))) { // implicit nullcheck of e0
    ...
    static final class SetN<E> extends AbstractImmutableSet<E>
        ...
        static final java.util.Set<?> EMPTY_SET = new SetN<>();
    ...
    @SuppressWarnings("unchecked")
    static <K,V> java.util.Map<K,V> emptyMap() {
    ...
    abstract static class AbstractImmutableMap<K,V> extends AbstractMap<K,V> implements Serializable {
        ...
        @Override public void putAll(java.util.Map<? extends K,? extends V> m) { throw uoe(); }
    ...
    static final class Map1<K,V> extends AbstractImmutableMap<K,V> {
        ...
        Map1(K k0, V v0) {
            this.k0 = java.util.Objects.requireNonNull(k0);
            this.v0 = java.util.Objects.requireNonNull(v0);
        }

        @Override
        public java.util.Set<Entry<K,V>> entrySet() {
            return java.util.Set.of(new java.util.KeyValueHolder<>(k0, v0));
        }
    ...
    static final class MapN<K,V> extends AbstractImmutableMap<K,V> {
        ...
        static final java.util.Map<?,?> EMPTY_MAP = new MapN<>();
        ...
        MapN(Object... input) {
            ...
            for (int i = 0; i < input.length; i += 2) {
                @SuppressWarnings("unchecked")
                    K k = java.util.Objects.requireNonNull((K)input[i]);
                @SuppressWarnings("unchecked")
                    V v = java.util.Objects.requireNonNull((V)input[i+1]);
                int idx = probe(k);
                if (idx >= 0) {
        ...
        class MapNIterator implements java.util.Iterator<Entry<K,V>> {
            ...
            public Entry<K,V> next() {
                if (hasNext()) {
                    ...
                    @SuppressWarnings("unchecked")
                    Entry<K,V> e =
                            new java.util.KeyValueHolder<>((K)table[idx], (V)table[idx+1]);
                    remaining--;
                    return e;
                } else {
                    throw new NoSuchElementException();
