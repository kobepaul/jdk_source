 ...
 * {@link java.util.Spliterator} and its primitive specializations
 * {@link java.util.Spliterator.OfInt}, {@link java.util.Spliterator.OfLong}, and
...
public final class Spliterators {
    ...
    public static <T> java.util.Spliterator<T> emptySpliterator() {
        return (java.util.Spliterator<T>) EMPTY_SPLITERATOR;
    }

    private static final java.util.Spliterator<Object> EMPTY_SPLITERATOR =
     ...
     * {@link java.util.Arrays#spliterator(Object[])}.
     *
     ...
     */
    public static <T> java.util.Spliterator<T> spliterator(Object[] array,
                                                           int additionalCharacteristics) {
        return new ArraySpliterator<>(java.util.Objects.requireNonNull(array),
     ...
     */
    public static <T> java.util.Spliterator<T> spliterator(Object[] array, int fromIndex, int toIndex,
                                                           int additionalCharacteristics) {
        checkFromToBounds(java.util.Objects.requireNonNull(array).length, fromIndex, toIndex);
    ...
    public static java.util.Spliterator.OfInt spliterator(int[] array,
                                                          int additionalCharacteristics) {
        return new IntArraySpliterator(java.util.Objects.requireNonNull(array), additionalCharacteristics);
    }
     ...
     */
    public static java.util.Spliterator.OfInt spliterator(int[] array, int fromIndex, int toIndex,
                                                          int additionalCharacteristics) {
        checkFromToBounds(java.util.Objects.requireNonNull(array).length, fromIndex, toIndex);
     ...
     * fine control over Spliterator characteristics.  Most other situations in
     * which a Spliterator for an array is needed should use
     * {@link java.util.Arrays#spliterator(long[])}.
     *
     * <p>The returned spliterator always reports the characteristics
     * {@code SIZED} and {@code SUBSIZED}.  The caller may provide additional
     * characteristics for the spliterator to report; it is common to
    ...
    public static java.util.Spliterator.OfLong spliterator(long[] array,
                                                           int additionalCharacteristics) {
        return new LongArraySpliterator(java.util.Objects.requireNonNull(array), additionalCharacteristics);
    }
     ...
     * fine control over Spliterator characteristics.  Most other situations in
     * which a Spliterator for an array is needed should use
     * {@link java.util.Arrays#spliterator(long[], int, int)}.
     *
     * <p>The returned spliterator always reports the characteristics
     * {@code SIZED} and {@code SUBSIZED}.  The caller may provide additional
     ...
     */
    public static java.util.Spliterator.OfLong spliterator(long[] array, int fromIndex, int toIndex,
                                                           int additionalCharacteristics) {
        checkFromToBounds(java.util.Objects.requireNonNull(array).length, fromIndex, toIndex);
    ...
    public static java.util.Spliterator.OfDouble spliterator(double[] array,
                                                             int additionalCharacteristics) {
        return new DoubleArraySpliterator(java.util.Objects.requireNonNull(array), additionalCharacteristics);
    }
     ...
     */
    public static java.util.Spliterator.OfDouble spliterator(double[] array, int fromIndex, int toIndex,
                                                             int additionalCharacteristics) {
        checkFromToBounds(java.util.Objects.requireNonNull(array).length, fromIndex, toIndex);
     ...
     */
    public static <T> java.util.Spliterator<T> spliterator(java.util.Collection<? extends T> c,
                                                           int characteristics) {
        return new IteratorSpliterator<>(java.util.Objects.requireNonNull(c),
                                         characteristics);
    }
     ...
     */
    public static <T> java.util.Spliterator<T> spliterator(java.util.Iterator<? extends T> iterator,
                                                           long size,
                                                           int characteristics) {
        return new IteratorSpliterator<>(java.util.Objects.requireNonNull(iterator), size,
                                         characteristics);
    }
     ...
     * @throws NullPointerException if the given iterator is {@code null}
     */
    public static <T> java.util.Spliterator<T> spliteratorUnknownSize(java.util.Iterator<? extends T> iterator,
                                                                      int characteristics) {
        return new IteratorSpliterator<>(java.util.Objects.requireNonNull(iterator), characteristics);
    }
     ...
     * @throws NullPointerException if the given iterator is {@code null}
     */
    public static java.util.Spliterator.OfInt spliterator(PrimitiveIterator.OfInt iterator,
                                                          long size,
                                                          int characteristics) {
        return new IntIteratorSpliterator(java.util.Objects.requireNonNull(iterator),
     ...
     * @throws NullPointerException if the given iterator is {@code null}
     */
    public static java.util.Spliterator.OfInt spliteratorUnknownSize(PrimitiveIterator.OfInt iterator,
                                                                     int characteristics) {
        return new IntIteratorSpliterator(java.util.Objects.requireNonNull(iterator), characteristics);
    }
     ...
     * @throws NullPointerException if the given iterator is {@code null}
     */
    public static java.util.Spliterator.OfLong spliterator(PrimitiveIterator.OfLong iterator,
                                                           long size,
                                                           int characteristics) {
        return new LongIteratorSpliterator(java.util.Objects.requireNonNull(iterator),
                                           size, characteristics);
    }
     ...
     * @throws NullPointerException if the given iterator is {@code null}
     */
    public static java.util.Spliterator.OfLong spliteratorUnknownSize(PrimitiveIterator.OfLong iterator,
                                                                      int characteristics) {
        return new LongIteratorSpliterator(java.util.Objects.requireNonNull(iterator), characteristics);
    }
     ...
     * @throws NullPointerException if the given iterator is {@code null}
     */
    public static java.util.Spliterator.OfDouble spliterator(PrimitiveIterator.OfDouble iterator,
                                                             long size,
                                                             int characteristics) {
        return new DoubleIteratorSpliterator(java.util.Objects.requireNonNull(iterator),
                                             size, characteristics);
    }
     ...
     * @throws NullPointerException if the given iterator is {@code null}
     */
    public static java.util.Spliterator.OfDouble spliteratorUnknownSize(PrimitiveIterator.OfDouble iterator,
                                                                        int characteristics) {
        return new DoubleIteratorSpliterator(java.util.Objects.requireNonNull(iterator), characteristics);
    }
     ...
     */
    public static<T> java.util.Iterator<T> iterator(java.util.Spliterator<? extends T> spliterator) {
        java.util.Objects.requireNonNull(spliterator);
        class Adapter implements java.util.Iterator<T>, Consumer<T> {
     ...
     * @throws NullPointerException if the given spliterator is {@code null}
     */
    public static PrimitiveIterator.OfInt iterator(java.util.Spliterator.OfInt spliterator) {
        java.util.Objects.requireNonNull(spliterator);
     ...
     * @throws NullPointerException if the given spliterator is {@code null}
     */
    public static PrimitiveIterator.OfLong iterator(java.util.Spliterator.OfLong spliterator) {
        java.util.Objects.requireNonNull(spliterator);
     ...
     * @throws NullPointerException if the given spliterator is {@code null}
     */
    public static PrimitiveIterator.OfDouble iterator(java.util.Spliterator.OfDouble spliterator) {
        java.util.Objects.requireNonNull(spliterator);
    ...
    private abstract static class EmptySpliterator<T, S extends java.util.Spliterator<T>, C> {
        ...
        public int characteristics() {
            return java.util.Spliterator.SIZED | java.util.Spliterator.SUBSIZED;
        }

        private static final class OfRef<T>
                extends EmptySpliterator<T, java.util.Spliterator<T>, Consumer<? super T>>
                implements java.util.Spliterator<T> {
            OfRef() { }
        }

        private static final class OfInt
                extends EmptySpliterator<Integer, java.util.Spliterator.OfInt, IntConsumer>
                implements java.util.Spliterator.OfInt {
            OfInt() { }
        }

        private static final class OfLong
                extends EmptySpliterator<Long, java.util.Spliterator.OfLong, LongConsumer>
                implements java.util.Spliterator.OfLong {
            OfLong() { }
        }

        private static final class OfDouble
                extends EmptySpliterator<Double, java.util.Spliterator.OfDouble, DoubleConsumer>
     ...
     */
    static final class ArraySpliterator<T> implements java.util.Spliterator<T> {
        /**
        ...
        public ArraySpliterator(Object[] array, int origin, int fence, int additionalCharacteristics) {
            ...
            this.index = origin;
            this.fence = fence;
            this.characteristics = additionalCharacteristics | java.util.Spliterator.SIZED | java.util.Spliterator.SUBSIZED;
        }
        ...
        public java.util.Comparator<? super T> getComparator() {
            if (hasCharacteristics(java.util.Spliterator.SORTED))
                return null;
     ...
     */
    static final class IntArraySpliterator implements java.util.Spliterator.OfInt {
     ...
     * elements maintained in an unmodifiable {@code int[]} array.
     */
    static final class LongArraySpliterator implements java.util.Spliterator.OfLong {
     ...
     * elements maintained in an unmodifiable {@code int[]} array.
     */
    static final class DoubleArraySpliterator implements java.util.Spliterator.OfDouble {
     ...
     * available to use.
     *
     * @see #spliterator(java.util.Iterator, long, int)
     * @since 1.8
     */
    public abstract static class AbstractSpliterator<T> implements java.util.Spliterator<T> {
        ...
        protected AbstractSpliterator(long est, int additionalCharacteristics) {
            this.est = est;
            this.characteristics = ((additionalCharacteristics & java.util.Spliterator.SIZED) != 0)
                                   ? additionalCharacteristics | java.util.Spliterator.SUBSIZED
                                   : additionalCharacteristics;
        }
     ...
     * {@link #forEachRemaining(IntConsumer) forEachRemaining}
     * if it can provide a more performant implementation.
     *
     * @apiNote
     * This class is a useful aid for creating a spliterator when it is not
     ...
     * tryAdvance}.  The extending class should override
     * {@link #forEachRemaining(LongConsumer) forEachRemaining}
     * if it can provide a more performant implementation.
     *
     * @apiNote
     * This class is a useful aid for creating a spliterator when it is not
     ...
     * permit limited parallelism.
     */
    static class IteratorSpliterator<T> implements java.util.Spliterator<T> {
        static final int BATCH_UNIT = 1 << 10;  // batch array size increment
        static final int MAX_BATCH = 1 << 25;  // max batch array size;
        private final java.util.Collection<? extends T> collection; // null OK
        ...
        public IteratorSpliterator(Collection<? extends T> collection, int characteristics) {
            ...
            this.characteristics = (characteristics & java.util.Spliterator.CONCURRENT) == 0
                                   ? characteristics | java.util.Spliterator.SIZED | java.util.Spliterator.SUBSIZED
                                   : characteristics;
        }
        ...
        public IteratorSpliterator(java.util.Iterator<? extends T> iterator, int characteristics) {
            ...
            this.characteristics = characteristics & ~(java.util.Spliterator.SIZED | java.util.Spliterator.SUBSIZED);
        }
     ...
     * permit limited parallelism.
     */
    static final class IntIteratorSpliterator implements java.util.Spliterator.OfInt {
    ...
    static final class LongIteratorSpliterator implements java.util.Spliterator.OfLong {
        static final int BATCH_UNIT = IteratorSpliterator.BATCH_UNIT;
        static final int MAX_BATCH = IteratorSpliterator.MAX_BATCH;
    ...
    static final class DoubleIteratorSpliterator implements java.util.Spliterator.OfDouble {
        static final int BATCH_UNIT = IteratorSpliterator.BATCH_UNIT;
        static final int MAX_BATCH = IteratorSpliterator.MAX_BATCH;
