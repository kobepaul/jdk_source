 ...
 * or {@link #getBundle(String, java.util.Locale)} method.
 *
 ...
 * and they can be located using {@link java.util.ServiceLoader}.
...
public abstract class ResourceBundle {
    ...
    static {
        SharedSecrets.setJavaUtilResourceBundleAccess(
            new JavaUtilResourceBundleAccess() {
                ...
                @Override
                public void setLocale(ResourceBundle bundle, java.util.Locale locale) {
                ...
                @Override
                public ResourceBundle getBundle(String baseName, java.util.Locale locale, Module module) {
    ...
    private static final class CacheKey {
        ...
        private volatile java.util.ServiceLoader<ResourceBundleProvider> providers;
        ...
        CacheKey(String baseName, java.util.Locale locale, Module module, Module caller) {
        ...
        CacheKey(CacheKey src) {
            ...
            this.moduleRef = new KeyElementReference<>(
                java.util.Objects.requireNonNull(src.getModule()), referenceQueue, this);
            this.callerRef = new KeyElementReference<>(
                java.util.Objects.requireNonNull(src.getCallerModule()), referenceQueue, this);
        ...
        java.util.ServiceLoader<ResourceBundleProvider> getProviders() {
            if (!providersChecked) {
    ...
    public static final ResourceBundle getBundle(String baseName,
                                                 Control control) {
        Class<?> caller = Reflection.getCallerClass();
        java.util.Locale targetLocale = java.util.Locale.getDefault();
     ...
     * equivalent to calling {@link #getBundle(String, java.util.Locale, ClassLoader)
     ...
     */
    @CallerSensitive
    public static ResourceBundle getBundle(String baseName, java.util.Locale targetLocale, Module module) {
     ...
     * Use {@link #getBundle(String, java.util.Locale, Module)} to load resource bundles
     ...
     * #getBundle(String, java.util.Locale, ClassLoader) getBundle}
    ...
    private static class ResourceBundleControlProviderHolder {
        private static final PrivilegedAction<java.util.List<ResourceBundleControlProvider>> pa =
            () -> {
                return Collections.unmodifiableList(
                    java.util.ServiceLoader.load(ResourceBundleControlProvider.class,
                                       ClassLoader.getSystemClassLoader()).stream()
                        .map(java.util.ServiceLoader.Provider::get)
                        .collect(Collectors.toList()));
            };

        private static final java.util.List<ResourceBundleControlProvider> CONTROL_PROVIDERS =
     ...
     */
    private static java.util.ServiceLoader<ResourceBundleProvider> getServiceLoader(Module module,
                                                                                    String baseName)
    {
        if (!module.isNamed()) {
            return null;
        ...
        if (service != null && Reflection.verifyModuleAccess(module, service)) {
            try {
                ...
                return java.util.ServiceLoader.load(service, loader, module);
    ...
    public static class Control {
        ...
        public static final java.util.List<String> FORMAT_DEFAULT
            = java.util.List.of("java.class", "java.properties");
        ...
        public static final java.util.List<String> FORMAT_PROPERTIES
            = java.util.List.of("java.properties");
         ...
         *        any I/O operations
         * @see ResourceBundleProvider#getBundle(String, java.util.Locale)
         * @revised 9
         * @spec JPMS
         */
         ...
         *        if <code>baseName</code> or <code>locale</code>
         *        is <code>null</code>
         * @see java.util.spi.AbstractResourceBundleProvider#toBundleName(String, java.util.Locale)
         */
