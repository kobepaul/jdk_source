...
public abstract class Calendar implements Serializable, Cloneable, Comparable<Calendar> {
     ...
     *
     * @since 1.8
     * @see Calendar#getInstance(TimeZone, java.util.Locale)
     * @see Calendar#fields
     */
    public static class Builder {
         ...
         *                               already been set
         * @see Calendar#setTime(java.util.Date)
         ...
         * {@link java.util.Date}. This method is equivalent to a call to
         ...
         * @see Calendar#time
         */
        public Builder setInstant(java.util.Date instant) {
         ...
         * java.util.Locale#getDefault(java.util.Locale.Category) default <code>Locale</code>}
         * for {@link java.util.Locale.Category#FORMAT} will be used.
         *
         ...
         * {@linkplain GregorianCalendar#setGregorianChange(java.util.Date) Gregorian change date}
        ...
        public Calendar build() {
            ...
            case "iso8601":
                ...
                gcal.setGregorianChange(new java.util.Date(Long.MIN_VALUE));
    ...
    protected Calendar()
    {
        this(TimeZone.getDefaultRef(), java.util.Locale.getDefault(java.util.Locale.Category.FORMAT));
        sharedZone = true;
    }
    ...
    {
        java.util.Locale aLocale = java.util.Locale.getDefault(java.util.Locale.Category.FORMAT);
    ...
    private static TimeZone defaultTimeZone(java.util.Locale l) {
    ...
    private static class AvailableCalendarTypes {
        private static final java.util.Set<String> SET;
        static {
     ...
     * @see java.util.Locale.Builder#setLocale(java.util.Locale)
