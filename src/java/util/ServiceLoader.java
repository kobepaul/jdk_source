 ...
 * java.util.Iterator#hasNext() hasNext} and {@link java.util.Iterator#next() next} methods will
    ...
    implements Iterable<S>
{
    ...
    private java.util.Iterator<Provider<S>> lookupIterator1;
    private final java.util.List<S> instantiatedProviders = new java.util.ArrayList<>();

    // The lazy-lookup iterator for stream operations
    private java.util.Iterator<Provider<S>> lookupIterator2;
    private final java.util.List<Provider<S>> loadedProviders = new java.util.ArrayList<>();
    ...
    private ServiceLoader(Class<?> caller, ModuleLayer layer, Class<S> svc) {
        java.util.Objects.requireNonNull(caller);
        java.util.Objects.requireNonNull(layer);
        java.util.Objects.requireNonNull(svc);
    ...
    private ServiceLoader(Module callerModule, Class<S> svc, ClassLoader cl) {
        ...
        this.service = java.util.Objects.requireNonNull(svc);
        this.serviceName = svc.getName();
        this.layer = null;
        this.loader = cl;
        this.acc = (System.getSecurityManager() != null)
    ...
    private Method findStaticProviderMethod(Class<?> clazz) {
        java.util.List<Method> methods = null;
        try {
    ...
    private static class ProviderImpl<S> implements Provider<S> {
        ...
        @Override
        public int hashCode() {
            return java.util.Objects.hash(service, type, acc);
        }
    ...
    private final class LayerLookupIterator<T>
        implements java.util.Iterator<Provider<T>>
    {
        Deque<ModuleLayer> stack = new ArrayDeque<>();
        java.util.Set<ModuleLayer> visited = new java.util.HashSet<>();
        java.util.Iterator<ServiceProvider> iterator;
        ...
        private java.util.Iterator<ServiceProvider> providers(ModuleLayer layer) {
        ...
        public boolean hasNext() {
            while (nextProvider == null && nextError == null) {
                ...
                while (iterator == null || !iterator.hasNext()) {
                    ...
                    java.util.List<ModuleLayer> parents = layer.parents();
        ...
        implements java.util.Iterator<Provider<T>>
    {
         ...
         */
        private java.util.List<ServiceProvider> providers(ModuleLayer layer) {
            ServicesCatalog catalog = LANG_ACCESS.getServicesCatalog(layer);
         ...
         */
        private java.util.Iterator<ServiceProvider> iteratorFor(ClassLoader loader) {
            ...
            java.util.List<ServiceProvider> providers;
            if (catalog == null) {
            ...
            if (loader == null || loader == platformClassLoader) {
                ...
                java.util.Iterator<ModuleLayer> iterator = LANG_ACCESS.layers(loader).iterator();
        ...
        implements java.util.Iterator<Provider<T>>
    {
        ...
        java.util.Set<String> providerNames = new HashSet<>();  // to avoid duplicates
        Enumeration<URL> configs;
        java.util.Iterator<String> pending;
         ...
         */
        private int parseLine(URL u, BufferedReader r, int lc, java.util.Set<String> names)
            throws IOException
        {
         ...
         */
        private java.util.Iterator<String> parse(URL u) {
     ...
     */
    private java.util.Iterator<Provider<S>> newLookupIterator() {
        assert layer == null || loader == null;
        if (layer != null) {
            return new LayerLookupIterator<>();
        } else {
            java.util.Iterator<Provider<S>> first = new ModuleServicesLookupIterator<>();
            java.util.Iterator<Provider<S>> second = new LazyClassPathLookupIterator<>();
            return new java.util.Iterator<Provider<S>>() {
                @Override
                public boolean hasNext() {
     ...
     * providers is done by the iterator itself. Its {@link java.util.Iterator#hasNext
     * hasNext} and {@link java.util.Iterator#next next} methods can therefore throw a
    ...
    public Stream<Provider<S>> stream() {
        ...
        java.util.Spliterator<Provider<S>> s = new ProviderSpliterator<>(lookupIterator2);
        return StreamSupport.stream(s, false);
    }

    private class ProviderSpliterator<T> implements java.util.Spliterator<Provider<T>> {
        final int expectedReloadCount = ServiceLoader.this.reloadCount;
        final java.util.Iterator<Provider<T>> iterator;
        int index;

        ProviderSpliterator(java.util.Iterator<Provider<T>> iterator) {
            this.iterator = iterator;
        }

        @Override
        public java.util.Spliterator<Provider<T>> trySplit() {
            return null;
        }
    ...
    public java.util.Optional<S> findFirst() {
        ...
        if (iterator.hasNext()) {
            return java.util.Optional.of(iterator.next());
        } else {
