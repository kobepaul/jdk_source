...
public abstract class AbstractList<E> extends AbstractCollection<E> implements java.util.List<E> {
     ...
     */
    static final class RandomAccessSpliterator<E> implements java.util.Spliterator<E> {
        ...
        RandomAccessSpliterator(java.util.List<E> list) {
    ...
    private static class SubList<E> extends AbstractList<E> {
         ...
         */
        protected SubList(java.util.AbstractList.SubList<E> parent, int fromIndex, int toIndex) {
        ...
        public java.util.List<E> subList(int fromIndex, int toIndex) {
            subListRangeCheck(fromIndex, toIndex, size);
            return new java.util.AbstractList.SubList<>(this, fromIndex, toIndex);
        }
        ...
        private void updateSizeAndModCount(int sizeChange) {
            java.util.AbstractList.SubList<E> slist = this;
            do {
    ...
    private static class RandomAccessSubList<E>
         ...
         */
        RandomAccessSubList(java.util.AbstractList.RandomAccessSubList<E> parent,
                            int fromIndex, int toIndex) {
        ...
        public List<E> subList(int fromIndex, int toIndex) {
            subListRangeCheck(fromIndex, toIndex, size);
            return new java.util.AbstractList.RandomAccessSubList<>(this, fromIndex, toIndex);
        }
    }
}
