 ...
 * {@code byte}, {@link BigDecimal BigDecimal}, and {@link java.util.Calendar}
 ...
 * encoding a date or time: {@code long}, {@link Long}, {@link java.util.Calendar},
 * {@link java.util.Date} and {@link TemporalAccessor TemporalAccessor}
 *
 ...
 * java.util.Calendar}, {@link java.util.Date} and {@link TemporalAccessor TemporalAccessor}
 *
 * <table class="striped">
...
public final class Formatter implements Closeable, Flushable {
     ...
     * java.util.Locale#getDefault(java.util.Locale.Category) default locale} for
     ...
     */
    public Formatter(String fileName, Charset charset, java.util.Locale l) throws IOException {
     ...
     */
    public Formatter(File file, Charset charset, java.util.Locale l) throws IOException {
     ...
     */
    public Formatter(OutputStream os, Charset charset, java.util.Locale l) {
    ...
    public Formatter format(java.util.Locale l, String format, Object ... args) {
        ...
        java.util.List<FormatString> fsa = parse(format);
    ...
    private List<FormatString> parse(String s) {
        java.util.ArrayList<FormatString> al = new ArrayList<>();
    ...
    private class FormatSpecifier implements FormatString {
        ...
        private void printCharacter(Object arg, java.util.Locale l) throws IOException {
            if (arg == null) {
                print("null", l);
                return;
            }
        ...
        private void printBoolean(Object arg, java.util.Locale l) throws IOException {
            String s;
            if (arg != null)
        ...
        private void printHashCode(Object arg, java.util.Locale l) throws IOException {
            String s = (arg == null
                        ? "null"
        ...
        private void print(String s, java.util.Locale l) throws IOException {
        ...
        private String toUpperCaseWithLocale(String s, java.util.Locale l) {
            ...
            throws IOException
        {
            if (c == Conversion.SCIENTIFIC) {
                ...
                if (upper) {
                    ...
                    // don't localize hex
                    tmp = tmp.toUpperCase(java.util.Locale.ROOT);
                    va.append(tmp);
                } else {
                    va.append(s, 0, idx);
                }
        ...
        private Appendable print(StringBuilder sb, java.util.Calendar t, char c, java.util.Locale l)
                throws IOException {
            if (sb == null)
            ...
            case DateTime.ZONE:        { // 'Z' (symbol)
                ...
                sb.append(tz.getDisplayName((t.get(java.util.Calendar.DST_OFFSET) != 0),
                                           ...
                                           Objects.requireNonNullElse(l, java.util.Locale.US)));
                break;
            }
            ...
            case DateTime.NAME_OF_DAY:          { // 'A'
                ...
                java.util.Locale lt = Objects.requireNonNullElse(l, java.util.Locale.US);
        ...
        private void print(TemporalAccessor t, char c, java.util.Locale l)  throws IOException {
            StringBuilder sb = new StringBuilder();
            print(sb, t, c, l);
            // justify based on width
            if (f.contains(Flags.UPPERCASE)) {
        ...
        private Appendable print(StringBuilder sb, TemporalAccessor t, char c,
                                 java.util.Locale l) throws IOException {
            if (sb == null)
                sb = new StringBuilder();
            try {
                switch (c) {
                ...
                case DateTime.ZONE:        { // 'Z' (symbol)
                    ...
                    if (!(zid instanceof ZoneOffset) &&
                        ...
                        sb.append(java.util.TimeZone.getTimeZone(zid.getId())
        ...
        private StringBuilder localizedMagnitude(StringBuilder sb,
                long value, Flags f, int width, java.util.Locale l) {
