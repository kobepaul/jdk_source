...
public final class Locale implements Cloneable, Serializable {
    ...
    public static enum IsoCountryCode {
        ...
        PART1_ALPHA2 {
            @Override
            java.util.Set<String> createCountryCodeSet() {
                return java.util.Set.of(Locale.getISOCountries());
            }
        },
        ...
        PART3 {
            @Override
            java.util.Set<String> createCountryCodeSet() {
                return java.util.Set.of(LocaleISOData.ISO3166_3);
            }
        };
         ...
         */
        abstract java.util.Set<String> createCountryCodeSet();

        /**
         * Map to hold country codes for each ISO3166 part.
         */
        private static java.util.Map<IsoCountryCode, java.util.Set<String>> iso3166CodesMap = new ConcurrentHashMap<>();

        /**
         * This method is called from Locale class to retrieve country code set
         * for getISOCountries(type)
         */
        static java.util.Set<String> retrieveISOCountryCodes(IsoCountryCode type) {
     ...
     * @since 9
     */
    public static java.util.Set<String> getISOCountries(IsoCountryCode type) {
    ...
    private static String formatList(String[] stringList, String pattern) {
        ...
        // non-localized way.
        if (pattern == null) {
            return java.util.Arrays.stream(stringList).collect(Collectors.joining(","));
        }
