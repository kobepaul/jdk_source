...
abstract class LongPipeline<E_IN>
    ...
    @Override
    final boolean forEachWithCancel(Spliterator<Long> spliterator, java.util.stream.Sink<Long> sink) {
    ...
    private <U> java.util.stream.Stream<U> mapToObj(LongFunction<? extends U> mapper, int opFlags) {
        return new ReferencePipeline.StatelessOp<Long, U>(this, java.util.stream.StreamShape.LONG_VALUE, opFlags) {
            @Override
    ...
    public final java.util.stream.DoubleStream asDoubleStream() {
        return new DoublePipeline.StatelessOp<Long>(this, java.util.stream.StreamShape.LONG_VALUE, StreamOpFlag.NOT_DISTINCT) {
            @Override
    ...
    @Override
    public final java.util.stream.LongStream takeWhile(LongPredicate predicate) {
        return java.util.stream.WhileOps.makeTakeWhileLong(this, predicate);
    }

    @Override
    public final java.util.stream.LongStream dropWhile(LongPredicate predicate) {
        return java.util.stream.WhileOps.makeDropWhileLong(this, predicate);
    }
    ...
    public final long count() {
        return evaluate(java.util.stream.ReduceOps.makeLongCounting());
    }
