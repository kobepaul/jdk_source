...
abstract class DoublePipeline<E_IN>
    ...
    @Override
    final boolean forEachWithCancel(Spliterator<Double> spliterator, java.util.stream.Sink<Double> sink) {
    ...
    private <U> java.util.stream.Stream<U> mapToObj(DoubleFunction<? extends U> mapper, int opFlags) {
        return new ReferencePipeline.StatelessOp<Double, U>(this, java.util.stream.StreamShape.DOUBLE_VALUE, opFlags) {
            @Override
    ...
    public final <U> Stream<U> mapToObj(DoubleFunction<? extends U> mapper) {
        Objects.requireNonNull(mapper);
        return mapToObj(mapper, java.util.stream.StreamOpFlag.NOT_SORTED | java.util.stream.StreamOpFlag.NOT_DISTINCT);
    }
    ...
    @Override
    public final java.util.stream.DoubleStream takeWhile(DoublePredicate predicate) {
        return java.util.stream.WhileOps.makeTakeWhileDouble(this, predicate);
    }

    @Override
    public final java.util.stream.DoubleStream dropWhile(DoublePredicate predicate) {
        return java.util.stream.WhileOps.makeDropWhileDouble(this, predicate);
    }
    ...
    public final long count() {
        return evaluate(java.util.stream.ReduceOps.makeDoubleCounting());
    }
