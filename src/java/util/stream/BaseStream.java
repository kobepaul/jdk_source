 ...
 * illustrates an aggregate operation using the stream types {@link java.util.stream.Stream}
 * and {@link java.util.stream.IntStream}, computing the sum of the weights of the red widgets:
 *
 * <pre>{@code
