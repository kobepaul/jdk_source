 ...
 * {@link java.util.stream.TerminalOp#evaluateParallel(PipelineHelper, Spliterator)},
 * {@link java.util.stream.TerminalOp#evaluateSequential(PipelineHelper, Spliterator)},
 ...
 * such as {@link #wrapAndCopyInto(java.util.stream.Sink, Spliterator)},
 * {@link #copyInto(java.util.stream.Sink, Spliterator)}, and {@link #wrapSink(java.util.stream.Sink)} to execute
 * pipeline operations.
 *
...
abstract class PipelineHelper<P_OUT> {
     ...
     * {@link java.util.stream.StreamOpFlag#SIZED} is known on the combined stream and operation
     * flags.
     *
     ...
     * stages in it (see {@link java.util.stream.StreamOpFlag#SHORT_CIRCUIT}), the
     * {@link java.util.stream.Sink#cancellationRequested()} is checked after each
    ...
    /**
     * Pushes elements obtained from the {@code Spliterator} into the provided
     * {@code Sink}, checking {@link java.util.stream.Sink#cancellationRequested()} after each
     ...
     */
    abstract <P_IN> boolean copyIntoWithCancel(java.util.stream.Sink<P_IN> wrappedSink, Spliterator<P_IN> spliterator);
