...
final class ReduceOps {
    ...
    makeRef(java.util.stream.Collector<? super T, I, ?> collector) {
    ...
    makeInt(int identity, IntBinaryOperator operator) {
        Objects.requireNonNull(operator);
        class ReducingSink
                implements AccumulatingSink<Integer, Integer, ReducingSink>, java.util.stream.Sink.OfInt {
            private int state;
    ...
    makeInt(IntBinaryOperator operator) {
        Objects.requireNonNull(operator);
        class ReducingSink
                implements AccumulatingSink<Integer, OptionalInt, ReducingSink>, java.util.stream.Sink.OfInt {
            private boolean empty;
            private int state;
    ...
    makeInt(Supplier<R> supplier,
        ...
        Objects.requireNonNull(combiner);
        class ReducingSink extends Box<R>
                implements AccumulatingSink<Integer, R, ReducingSink>, java.util.stream.Sink.OfInt {
            @Override
            public void begin(long size) {
                state = supplier.get();
            }
    ...
    makeLong(long identity, LongBinaryOperator operator) {
        Objects.requireNonNull(operator);
        class ReducingSink
                implements AccumulatingSink<Long, Long, ReducingSink>, java.util.stream.Sink.OfLong {
            private long state;
    ...
    makeLong(LongBinaryOperator operator) {
        Objects.requireNonNull(operator);
        class ReducingSink
                implements AccumulatingSink<Long, OptionalLong, ReducingSink>, java.util.stream.Sink.OfLong {
            private boolean empty;
            private long state;
    ...
    makeLong(Supplier<R> supplier,
        ...
        Objects.requireNonNull(combiner);
        class ReducingSink extends Box<R>
                implements AccumulatingSink<Long, R, ReducingSink>, java.util.stream.Sink.OfLong {
            @Override
            public void begin(long size) {
                state = supplier.get();
            }
    ...
    makeDouble(double identity, DoubleBinaryOperator operator) {
        Objects.requireNonNull(operator);
        class ReducingSink
                implements AccumulatingSink<Double, Double, ReducingSink>, java.util.stream.Sink.OfDouble {
    ...
    makeDouble(DoubleBinaryOperator operator) {
        Objects.requireNonNull(operator);
        class ReducingSink
                implements AccumulatingSink<Double, OptionalDouble, ReducingSink>, java.util.stream.Sink.OfDouble {
            private boolean empty;
            private double state;
    ...
    makeDouble(Supplier<R> supplier,
        ...
        Objects.requireNonNull(combiner);
        class ReducingSink extends Box<R>
                implements AccumulatingSink<Double, R, ReducingSink>, java.util.stream.Sink.OfDouble {
            @Override
            public void begin(long size) {
                state = supplier.get();
            }
    ...
    abstract static class CountingSink<T>
        ...
        static final class OfInt extends CountingSink<Integer> implements java.util.stream.Sink.OfInt {
            @Override
            public void accept(int t) {
                count++;
            }
        ...
        static final class OfLong extends CountingSink<Long> implements java.util.stream.Sink.OfLong {
            @Override
            public void accept(long t) {
                count++;
            }
        ...
        static final class OfDouble extends CountingSink<Double> implements java.util.stream.Sink.OfDouble {
            @Override
            public void accept(double t) {
                count++;
            }
