...
final class SliceOps {
        ...
        return new ReferencePipeline.StatefulOp<T, T>(upstream, StreamShape.REFERENCE,
            ...
            <P_IN> Spliterator<T> opEvaluateParallelLazy(PipelineHelper<T> helper, Spliterator<P_IN> spliterator) {
                ...
                if (size > 0 && spliterator.hasCharacteristics(Spliterator.SUBSIZED)) {
                    ...
                    return new SliceTask<>(this, helper, spliterator, java.util.stream.Nodes.castingArray(), skip, limit).
                            invoke().spliterator();
                }
            }
    ...
    private static final class SliceTask<P_IN, P_OUT>
            extends AbstractShortCircuitTask<P_IN, P_OUT, java.util.stream.Node<P_OUT>, SliceTask<P_IN, P_OUT>> {
        ...
        protected final java.util.stream.Node<P_OUT> doLeaf() {
            if (isRoot()) {
                ...
                final java.util.stream.Node.Builder<P_OUT> nb = op.makeNodeBuilder(-1, generator);
                ...
                java.util.stream.Node<P_OUT> node = nb.build();
