 ...
 * {@link java.util.stream.Stream} and {@link LongStream}, computing the sum of the weights of the
 * red widgets:
 *
 * <pre>{@code
...
public interface LongStream extends BaseStream<Long, LongStream> {
     ...
     * @return the new stream
     */
    <U> java.util.stream.Stream<U> mapToObj(LongFunction<? extends U> mapper);
    ...
    default LongStream takeWhile(LongPredicate predicate) {
        ...
        return StreamSupport.longStream(
                new java.util.stream.WhileOps.UnorderedWhileSpliterator.OfLong.Taking(spliterator(), true, predicate),
    ...
    default LongStream dropWhile(LongPredicate predicate) {
        ...
        // is safe to use as long as it configured not to split
        return StreamSupport.longStream(
                new java.util.stream.WhileOps.UnorderedWhileSpliterator.OfLong.Dropping(spliterator(), true, predicate),
                isParallel()).onClose(this::close);
    }
