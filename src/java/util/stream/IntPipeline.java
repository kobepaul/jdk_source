...
abstract class IntPipeline<E_IN>
    ...
    @Override
    final boolean forEachWithCancel(Spliterator<Integer> spliterator, java.util.stream.Sink<Integer> sink) {
    ...
    private <U> java.util.stream.Stream<U> mapToObj(IntFunction<? extends U> mapper, int opFlags) {
    ...
    @Override
    public final java.util.stream.IntStream takeWhile(IntPredicate predicate) {
        return java.util.stream.WhileOps.makeTakeWhileInt(this, predicate);
    }

    @Override
    public final java.util.stream.IntStream dropWhile(IntPredicate predicate) {
        return java.util.stream.WhileOps.makeDropWhileInt(this, predicate);
    }
    ...
    public final long count() {
        return evaluate(java.util.stream.ReduceOps.makeIntCounting());
    }
