...
public final class StreamSupport {
     ...
     */
    public static <T> java.util.stream.Stream<T> stream(Spliterator<T> spliterator, boolean parallel) {
     ...
     */
    public static java.util.stream.LongStream longStream(Spliterator.OfLong spliterator,
                                                         boolean parallel) {
     ...
     */
    public static java.util.stream.DoubleStream doubleStream(Spliterator.OfDouble spliterator,
                                                             boolean parallel) {
