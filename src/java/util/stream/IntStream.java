 ...
 * {@link java.util.stream.Stream} and {@link IntStream}, computing the sum of the weights of the
 * red widgets:
 *
 * <pre>{@code
...
public interface IntStream extends BaseStream<Integer, IntStream> {
     ...
     * @return the new stream
     */
    <U> java.util.stream.Stream<U> mapToObj(IntFunction<? extends U> mapper);
    ...
    default IntStream takeWhile(IntPredicate predicate) {
        ...
        return StreamSupport.intStream(
                new java.util.stream.WhileOps.UnorderedWhileSpliterator.OfInt.Taking(spliterator(), true, predicate),
    ...
    default IntStream dropWhile(IntPredicate predicate) {
        ...
        // is safe to use as long as it configured not to split
        return StreamSupport.intStream(
                new java.util.stream.WhileOps.UnorderedWhileSpliterator.OfInt.Dropping(spliterator(), true, predicate),
                isParallel()).onClose(this::close);
    }
