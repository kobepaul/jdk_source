...
final class MatchOps {
    ...
    public static TerminalOp<Integer, Boolean> makeInt(IntPredicate predicate,
        ...
        Objects.requireNonNull(predicate);
        Objects.requireNonNull(matchKind);
        class MatchSink extends BooleanTerminalSink<Integer> implements java.util.stream.Sink.OfInt {
            MatchSink() {
                super(matchKind);
            }
    ...
    public static TerminalOp<Long, Boolean> makeLong(LongPredicate predicate,
        ...
        Objects.requireNonNull(predicate);
        Objects.requireNonNull(matchKind);
        class MatchSink extends BooleanTerminalSink<Long> implements java.util.stream.Sink.OfLong {
    ...
    public static TerminalOp<Double, Boolean> makeDouble(DoublePredicate predicate,
        ...
        Objects.requireNonNull(predicate);
        Objects.requireNonNull(matchKind);
        class MatchSink extends BooleanTerminalSink<Double> implements java.util.stream.Sink.OfDouble {
     ...
     * @param <T> The output type of the stream pipeline
     */
    private abstract static class BooleanTerminalSink<T> implements java.util.stream.Sink<T> {
        boolean stop;
        boolean value;
