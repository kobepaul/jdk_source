 ...
 * {@link java.util.stream.Stream} and {@link DoubleStream}, computing the sum of the weights of the
 * red widgets:
 *
 * <pre>{@code
 ...
 * }</pre>
 *
 * See the class documentation for {@link java.util.stream.Stream} and the package documentation
...
public interface DoubleStream extends BaseStream<Double, DoubleStream> {
     ...
     * @return the new stream
     */
    <U> java.util.stream.Stream<U> mapToObj(DoubleFunction<? extends U> mapper);
    ...
    default DoubleStream takeWhile(DoublePredicate predicate) {
        ...
        return StreamSupport.doubleStream(
                new java.util.stream.WhileOps.UnorderedWhileSpliterator.OfDouble.Taking(spliterator(), true, predicate),
    ...
    default DoubleStream dropWhile(DoublePredicate predicate) {
        ...
        // is safe to use as long as it configured not to split
        return StreamSupport.doubleStream(
                new java.util.stream.WhileOps.UnorderedWhileSpliterator.OfDouble.Dropping(spliterator(), true, predicate),
                isParallel()).onClose(this::close);
    }
