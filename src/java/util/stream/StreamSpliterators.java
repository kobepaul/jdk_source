...
class StreamSpliterators {
    ...
    private abstract static class AbstractWrappingSpliterator<P_IN, P_OUT,
        ...
        final java.util.stream.PipelineHelper<P_OUT> ph;
         ...
         */
        java.util.stream.Sink<P_IN> bufferSink;
         ...
         */
        AbstractWrappingSpliterator(java.util.stream.PipelineHelper<P_OUT> ph,
        ...
        public final long getExactSizeIfKnown() {
            init();
            return java.util.stream.StreamOpFlag.SIZED.isKnown(ph.getStreamAndOpFlags())
        ...
        public final int characteristics() {
            ...
            int c = java.util.stream.StreamOpFlag.toCharacteristics(java.util.stream.StreamOpFlag.toStreamFlags(ph.getStreamAndOpFlags()));
    ...
    static final class WrappingSpliterator<P_IN, P_OUT>
            extends AbstractWrappingSpliterator<P_IN, P_OUT, java.util.stream.SpinedBuffer<P_OUT>> {

        WrappingSpliterator(java.util.stream.PipelineHelper<P_OUT> ph,
        ...
        void initPartialTraversalState() {
            java.util.stream.SpinedBuffer<P_OUT> b = new java.util.stream.SpinedBuffer<>();
            buffer = b;
        ...
        public void forEachRemaining(Consumer<? super P_OUT> consumer) {
            if (buffer == null && !finished) {
                ...
                ph.wrapAndCopyInto((java.util.stream.Sink<P_OUT>) consumer::accept, spliterator);
                finished = true;
            }
            else {
    ...
    static final class IntWrappingSpliterator<P_IN>
            extends AbstractWrappingSpliterator<P_IN, Integer, java.util.stream.SpinedBuffer.OfInt>
            implements Spliterator.OfInt {

        IntWrappingSpliterator(java.util.stream.PipelineHelper<Integer> ph,
                               Supplier<Spliterator<P_IN>> supplier,
                               boolean parallel) {
            super(ph, supplier, parallel);
        }
        ...
        @Override
        void initPartialTraversalState() {
            java.util.stream.SpinedBuffer.OfInt b = new java.util.stream.SpinedBuffer.OfInt();
            buffer = b;
            bufferSink = ph.wrapSink((java.util.stream.Sink.OfInt) b::accept);
            pusher = () -> spliterator.tryAdvance(bufferSink);
        }
        ...
        public void forEachRemaining(IntConsumer consumer) {
            if (buffer == null && !finished) {
                ...
                ph.wrapAndCopyInto((java.util.stream.Sink.OfInt) consumer::accept, spliterator);
                finished = true;
            }
            else {
                do { } while (tryAdvance(consumer));
    ...
    static final class LongWrappingSpliterator<P_IN>
            extends AbstractWrappingSpliterator<P_IN, Long, java.util.stream.SpinedBuffer.OfLong>
            implements Spliterator.OfLong {

        LongWrappingSpliterator(java.util.stream.PipelineHelper<Long> ph,
                                Supplier<Spliterator<P_IN>> supplier,
                                boolean parallel) {
            super(ph, supplier, parallel);
        }
        ...
        @Override
        void initPartialTraversalState() {
            java.util.stream.SpinedBuffer.OfLong b = new java.util.stream.SpinedBuffer.OfLong();
            buffer = b;
            bufferSink = ph.wrapSink((java.util.stream.Sink.OfLong) b::accept);
            pusher = () -> spliterator.tryAdvance(bufferSink);
        }
        ...
        public void forEachRemaining(LongConsumer consumer) {
            if (buffer == null && !finished) {
                ...
                ph.wrapAndCopyInto((java.util.stream.Sink.OfLong) consumer::accept, spliterator);
                finished = true;
            }
            else {
                do { } while (tryAdvance(consumer));
    ...
    static final class DoubleWrappingSpliterator<P_IN>
            extends AbstractWrappingSpliterator<P_IN, Double, java.util.stream.SpinedBuffer.OfDouble>
            implements Spliterator.OfDouble {

        DoubleWrappingSpliterator(java.util.stream.PipelineHelper<Double> ph,
                                  Supplier<Spliterator<P_IN>> supplier,
                                  boolean parallel) {
            super(ph, supplier, parallel);
        }
        ...
        @Override
        void initPartialTraversalState() {
            java.util.stream.SpinedBuffer.OfDouble b = new java.util.stream.SpinedBuffer.OfDouble();
            buffer = b;
            bufferSink = ph.wrapSink((java.util.stream.Sink.OfDouble) b::accept);
            pusher = () -> spliterator.tryAdvance(bufferSink);
        }
        ...
        public void forEachRemaining(DoubleConsumer consumer) {
            if (buffer == null && !finished) {
                ...
                ph.wrapAndCopyInto((java.util.stream.Sink.OfDouble) consumer::accept, spliterator);
                finished = true;
            }
            else {
                do { } while (tryAdvance(consumer));
    ...
    abstract static class SliceSpliterator<T, T_SPLITR extends Spliterator<T>> {
        ...
        static final class OfRef<T>
            ...
            protected Spliterator<T> makeSpliterator(Spliterator<T> s,
                ...
                return new java.util.stream.StreamSpliterators.SliceSpliterator.OfRef<>(s, sliceOrigin, sliceFence, origin, fence);
            }
    ...
    abstract static class UnorderedSliceSpliterator<T, T_SPLITR extends Spliterator<T>> {
        ...
        UnorderedSliceSpliterator(T_SPLITR s, long skip, long limit) {
            ...
            this.chunkSize = limit >= 0 ? (int)Math.min(CHUNK_SIZE,
                                                        ((skip + limit) / java.util.stream.AbstractTask.getLeafTarget()) + 1) : CHUNK_SIZE;
        ...
        static final class OfRef<T> extends UnorderedSliceSpliterator<T, Spliterator<T>>
            ...
            OfRef(Spliterator<T> s, java.util.stream.StreamSpliterators.UnorderedSliceSpliterator.OfRef<T> parent) {
                super(s, parent);
            }
            ...
            public boolean tryAdvance(Consumer<? super T> action) {
                ...
                while (permitStatus() != java.util.stream.StreamSpliterators.UnorderedSliceSpliterator.PermitStatus.NO_MORE) {
            ...
            public void forEachRemaining(Consumer<? super T> action) {
                ...
                while ((permitStatus = permitStatus()) != java.util.stream.StreamSpliterators.UnorderedSliceSpliterator.PermitStatus.NO_MORE) {
                    if (permitStatus == java.util.stream.StreamSpliterators.UnorderedSliceSpliterator.PermitStatus.MAYBE_MORE) {
