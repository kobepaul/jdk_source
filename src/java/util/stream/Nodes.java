...
/**
 * Factory methods for constructing implementations of {@link java.util.stream.Node} and
 * {@link java.util.stream.Node.Builder} and their primitive specializations.  Fork/Join tasks
 * for collecting output from a {@link PipelineHelper} to a {@link java.util.stream.Node} and
 * flattening {@link java.util.stream.Node}s.
 *
 * @since 1.8
 */
final class Nodes {
    ...
    private static final java.util.stream.Node EMPTY_NODE = new EmptyNode.OfRef();
    private static final java.util.stream.Node.OfInt EMPTY_INT_NODE = new EmptyNode.OfInt();
    private static final java.util.stream.Node.OfLong EMPTY_LONG_NODE = new EmptyNode.OfLong();
    private static final java.util.stream.Node.OfDouble EMPTY_DOUBLE_NODE = new EmptyNode.OfDouble();
     ...
     */
    @SuppressWarnings("unchecked")
    static <T> java.util.stream.Node<T> emptyNode(StreamShape shape) {
        switch (shape) {
            case REFERENCE:    return (java.util.stream.Node<T>) EMPTY_NODE;
            case INT_VALUE:    return (java.util.stream.Node<T>) EMPTY_INT_NODE;
            case LONG_VALUE:   return (java.util.stream.Node<T>) EMPTY_LONG_NODE;
            case DOUBLE_VALUE: return (java.util.stream.Node<T>) EMPTY_DOUBLE_NODE;
            default:
    ...
    /**
     * Produces a concatenated {@link java.util.stream.Node} that has two or more children.
     ...
     * @throws IllegalStateException if all {@link java.util.stream.Node} elements of the list
     * are an not instance of type supported by this factory.
     */
    @SuppressWarnings("unchecked")
    static <T> java.util.stream.Node<T> conc(StreamShape shape, java.util.stream.Node<T> left, java.util.stream.Node<T> right) {
        switch (shape) {
            case REFERENCE:
                return new ConcNode<>(left, right);
            case INT_VALUE:
                return (java.util.stream.Node<T>) new ConcNode.OfInt((java.util.stream.Node.OfInt) left, (java.util.stream.Node.OfInt) right);
            case LONG_VALUE:
                return (java.util.stream.Node<T>) new ConcNode.OfLong((java.util.stream.Node.OfLong) left, (java.util.stream.Node.OfLong) right);
            case DOUBLE_VALUE:
                return (java.util.stream.Node<T>) new ConcNode.OfDouble((java.util.stream.Node.OfDouble) left, (java.util.stream.Node.OfDouble) right);
            default:
                throw new IllegalStateException("Unknown shape " + shape);
        }
    }
    ...
    /**
     * Produces a {@link java.util.stream.Node} describing an array.
     *
     ...
     */
    static <T> java.util.stream.Node<T> node(T[] array) {
        return new ArrayNode<>(array);
    }

    /**
     * Produces a {@link java.util.stream.Node} describing a {@link Collection}.
     * <p>
     ...
     */
    static <T> java.util.stream.Node<T> node(Collection<T> c) {
        return new CollectionNode<>(c);
    }

    /**
     * Produces a {@link java.util.stream.Node.Builder}.
     *
     ...
     */
    static <T> java.util.stream.Node.Builder<T> builder(long exactSizeIfKnown, IntFunction<T[]> generator) {
    ...
    /**
     * Produces a {@link java.util.stream.Node.OfInt} describing an int[] array.
     *
     * <p>The node will hold a reference to the array and will not make a copy.
     *
     * @param array the array
     * @return a node holding an array
     */
    static java.util.stream.Node.OfInt node(int[] array) {
        return new IntArrayNode(array);
    }

    /**
     * Produces a {@link java.util.stream.Node.Builder.OfInt}.
     *
     * @param exactSizeIfKnown -1 if a variable size builder is requested,
     * otherwise the exact capacity desired.  A fixed capacity builder will
     * fail if the wrong number of elements are added to the builder.
     ...
     */
    static java.util.stream.Node.Builder.OfInt intBuilder(long exactSizeIfKnown) {
        return (exactSizeIfKnown >= 0 && exactSizeIfKnown < MAX_ARRAY_SIZE)
    ...
    /**
     * Produces a {@link java.util.stream.Node.OfLong} describing a long[] array.
     * <p>
     ...
     * @return a node holding an array
     */
    static java.util.stream.Node.OfLong node(final long[] array) {
        return new LongArrayNode(array);
    }

    /**
     * Produces a {@link java.util.stream.Node.Builder.OfLong}.
     *
     * @param exactSizeIfKnown -1 if a variable size builder is requested,
     * otherwise the exact capacity desired.  A fixed capacity builder will
     * fail if the wrong number of elements are added to the builder.
     ...
     */
    static java.util.stream.Node.Builder.OfLong longBuilder(long exactSizeIfKnown) {
        return (exactSizeIfKnown >= 0 && exactSizeIfKnown < MAX_ARRAY_SIZE)
    ...
    /**
     * Produces a {@link java.util.stream.Node.OfDouble} describing a double[] array.
     *
     * <p>The node will hold a reference to the array and will not make a copy.
     *
     * @param array the array
     * @return a node holding an array
     */
    static java.util.stream.Node.OfDouble node(final double[] array) {
        return new DoubleArrayNode(array);
    }

    /**
     * Produces a {@link java.util.stream.Node.Builder.OfDouble}.
     *
     * @param exactSizeIfKnown -1 if a variable size builder is requested,
     * otherwise the exact capacity desired.  A fixed capacity builder will
     * fail if the wrong number of elements are added to the builder.
     ...
     */
    static java.util.stream.Node.Builder.OfDouble doubleBuilder(long exactSizeIfKnown) {
        return (exactSizeIfKnown >= 0 && exactSizeIfKnown < MAX_ARRAY_SIZE)
     ...
     * elements with a {@link java.util.stream.Node}.
     *
     * @implSpec
     ...
     * then a flat {@link java.util.stream.Node} will be returned whose content is an array,
     ...
     * @return a {@link java.util.stream.Node} describing the output elements
     */
     ...
     * describe those elements with a {@link java.util.stream.Node.OfInt}.
     *
     * @implSpec
     * If the exact size of the output from the pipeline is known and the source
     * {@link Spliterator} has the {@link Spliterator#SUBSIZED} characteristic,
     ...
     * @param flattenTree whether a conc node should be flattened into a node
     *                    describing an array before returning
     * @return a {@link java.util.stream.Node.OfInt} describing the output elements
     */
     ...
     * describe those elements with a {@link java.util.stream.Node.OfLong}.
     *
     * @implSpec
     * If the exact size of the output from the pipeline is known and the source
     * {@link Spliterator} has the {@link Spliterator#SUBSIZED} characteristic,
     ...
     * @param flattenTree whether a conc node should be flattened into a node
     *                    describing an array before returning
     * @return a {@link java.util.stream.Node.OfLong} describing the output elements
     */
     ...
     * describe those elements with a {@link java.util.stream.Node.OfDouble}.
     *
     * @implSpec
     * If the exact size of the output from the pipeline is known and the source
     * {@link Spliterator} has the {@link Spliterator#SUBSIZED} characteristic,
     ...
     * @param flattenTree whether a conc node should be flattened into a node
     *                    describing an array before returning
     * @return a {@link java.util.stream.Node.OfDouble} describing the output elements
     */
    ...
    /**
     * Flatten, in parallel, a {@link java.util.stream.Node}.  A flattened node is one that has
     ...
     * whose length is {@link java.util.stream.Node#count()}.  Then the node tree is traversed
     ...
     */
    public static <T> java.util.stream.Node<T> flatten(java.util.stream.Node<T> node, IntFunction<T[]> generator) {
    ...
    /**
     * Flatten, in parallel, a {@link java.util.stream.Node.OfInt}.  A flattened node is one that
     ...
     * is {@link java.util.stream.Node#count()}.  Then the node tree is traversed and leaf node
     ...
     */
    public static java.util.stream.Node.OfInt flattenInt(java.util.stream.Node.OfInt node) {
        if (node.getChildCount() > 0) {
            long size = node.count();
            if (size >= MAX_ARRAY_SIZE)
                throw new IllegalArgumentException(BAD_SIZE);
    ...
    /**
     * Flatten, in parallel, a {@link java.util.stream.Node.OfLong}.  A flattened node is one that
     * has no children.  If the node is already flat, it is simply returned.
     *
     * @implSpec
     ...
     */
    public static java.util.stream.Node.OfLong flattenLong(java.util.stream.Node.OfLong node) {
        if (node.getChildCount() > 0) {
            long size = node.count();
            if (size >= MAX_ARRAY_SIZE)
                throw new IllegalArgumentException(BAD_SIZE);
    ...
    /**
     * Flatten, in parallel, a {@link java.util.stream.Node.OfDouble}.  A flattened node is one that
     * has no children.  If the node is already flat, it is simply returned.
     *
     * @implSpec
     ...
     */
    public static java.util.stream.Node.OfDouble flattenDouble(java.util.stream.Node.OfDouble node) {
        if (node.getChildCount() > 0) {
            long size = node.count();
            if (size >= MAX_ARRAY_SIZE)
                throw new IllegalArgumentException(BAD_SIZE);
    ...
    private abstract static class EmptyNode<T, T_ARR, T_CONS> implements java.util.stream.Node<T> {
        EmptyNode() { }
    ...
    private static class ArrayNode<T> implements java.util.stream.Node<T> {
        final T[] array;
        int curSize;
    ...
    private static final class CollectionNode<T> implements java.util.stream.Node<T> {
     ...
     */
    private abstract static class AbstractConcNode<T, T_NODE extends java.util.stream.Node<T>> implements java.util.stream.Node<T> {
    ...
    static final class ConcNode<T>
            extends AbstractConcNode<T, java.util.stream.Node<T>>
            implements java.util.stream.Node<T> {

        ConcNode(java.util.stream.Node<T> left, java.util.stream.Node<T> right) {
            super(left, right);
        }
        ...
        @Override
        public java.util.stream.Node<T> truncate(long from, long to, IntFunction<T[]> generator) {
            if (from == 0 && to == count())
                return this;
        ...
        private abstract static class OfPrimitive<E, T_CONS, T_ARR,
                                                  ...
                                                  T_NODE extends java.util.stream.Node.OfPrimitive<E, T_CONS, T_ARR, T_SPLITR, T_NODE>>
                extends AbstractConcNode<E, T_NODE>
                implements java.util.stream.Node.OfPrimitive<E, T_CONS, T_ARR, T_SPLITR, T_NODE> {
        ...
        static final class OfInt
                extends OfPrimitive<Integer, IntConsumer, int[], Spliterator.OfInt, java.util.stream.Node.OfInt>
                implements java.util.stream.Node.OfInt {
        ...
        static final class OfLong
                extends OfPrimitive<Long, LongConsumer, long[], Spliterator.OfLong, java.util.stream.Node.OfLong>
                implements java.util.stream.Node.OfLong {
        ...
        static final class OfDouble
                extends OfPrimitive<Double, DoubleConsumer, double[], Spliterator.OfDouble, java.util.stream.Node.OfDouble>
                implements java.util.stream.Node.OfDouble {
    ...
    private abstract static class InternalNodeSpliterator<T,
                                                          ...
                                                          N extends java.util.stream.Node<T>>
        ...
        private static final class OfRef<T>
                extends InternalNodeSpliterator<T, Spliterator<T>, java.util.stream.Node<T>> {

            OfRef(java.util.stream.Node<T> curNode) {
                super(curNode);
            }
            ...
            public boolean tryAdvance(Consumer<? super T> consumer) {
                ...
                if (!hasNext) {
                    if (lastNodeSpliterator == null) {
                        ...
                        java.util.stream.Node<T> leaf = findNextLeafNode(tryAdvanceStack);
                        if (leaf != null) {
        ...
        private abstract static class OfPrimitive<T, T_CONS, T_ARR,
                                                  ...
                                                  N extends java.util.stream.Node.OfPrimitive<T, T_CONS, T_ARR, T_SPLITR, N>>
    ...
    private static final class FixedNodeBuilder<T>
            extends ArrayNode<T>
            implements java.util.stream.Node.Builder<T> {
    ...
    private static final class SpinedNodeBuilder<T>
            ...
            implements java.util.stream.Node<T>, java.util.stream.Node.Builder<T> {
    ...
    private static class IntArrayNode implements java.util.stream.Node.OfInt {
        final int[] array;
        int curSize;
    ...
    private static class LongArrayNode implements java.util.stream.Node.OfLong {
        final long[] array;
        int curSize;
    ...
    private static class DoubleArrayNode implements java.util.stream.Node.OfDouble {
        final double[] array;
        int curSize;
    ...
    private abstract static class SizedCollectorTask<P_IN, P_OUT, T_SINK extends java.util.stream.Sink<P_OUT>,
                                                     K extends SizedCollectorTask<P_IN, P_OUT, T_SINK, K>>
            extends CountedCompleter<Void>
            implements java.util.stream.Sink<P_OUT> {
        ...
        static final class OfRef<P_IN, P_OUT>
                extends SizedCollectorTask<P_IN, P_OUT, java.util.stream.Sink<P_OUT>, OfRef<P_IN, P_OUT>>
                implements java.util.stream.Sink<P_OUT> {
            ...
            OfRef(java.util.stream.Nodes.SizedCollectorTask.OfRef<P_IN, P_OUT> parent, Spliterator<P_IN> spliterator,
            ...
            @Override
            java.util.stream.Nodes.SizedCollectorTask.OfRef<P_IN, P_OUT> makeChild(Spliterator<P_IN> spliterator,
                                                                                   long offset, long size) {
                return new java.util.stream.Nodes.SizedCollectorTask.OfRef<>(this, spliterator, offset, size);
            }
        ...
        static final class OfInt<P_IN>
                extends SizedCollectorTask<P_IN, Integer, java.util.stream.Sink.OfInt, OfInt<P_IN>>
        ...
        static final class OfLong<P_IN>
                extends SizedCollectorTask<P_IN, Long, java.util.stream.Sink.OfLong, OfLong<P_IN>>
        ...
        static final class OfDouble<P_IN>
                extends SizedCollectorTask<P_IN, Double, java.util.stream.Sink.OfDouble, OfDouble<P_IN>>
    ...
    @SuppressWarnings("serial")
    private abstract static class ToArrayTask<T, T_NODE extends java.util.stream.Node<T>,
        ...
        @SuppressWarnings("serial")
        private static final class OfRef<T>
                extends ToArrayTask<T, java.util.stream.Node<T>, OfRef<T>> {
            private final T[] array;

            private OfRef(java.util.stream.Node<T> node, T[] array, int offset) {
                super(node, offset);
                this.array = array;
            }

            private OfRef(java.util.stream.Nodes.ToArrayTask.OfRef<T> parent, java.util.stream.Node<T> node, int offset) {
                super(parent, node, offset);
                this.array = parent.array;
            }

            @Override
            java.util.stream.Nodes.ToArrayTask.OfRef<T> makeChild(int childIndex, int offset) {
                return new java.util.stream.Nodes.ToArrayTask.OfRef<>(this, node.getChild(childIndex), offset);
            }
        ...
        private static class OfPrimitive<T, T_CONS, T_ARR,
                                         T_SPLITR extends Spliterator.OfPrimitive<T, T_CONS, T_SPLITR>,
                                         T_NODE extends java.util.stream.Node.OfPrimitive<T, T_CONS, T_ARR, T_SPLITR, T_NODE>>
            ...
            private OfPrimitive(java.util.stream.Nodes.ToArrayTask.OfPrimitive<T, T_CONS, T_ARR, T_SPLITR, T_NODE> parent, T_NODE node, int offset) {
                super(parent, node, offset);
                this.array = parent.array;
            }

            @Override
            java.util.stream.Nodes.ToArrayTask.OfPrimitive<T, T_CONS, T_ARR, T_SPLITR, T_NODE> makeChild(int childIndex, int offset) {
                return new java.util.stream.Nodes.ToArrayTask.OfPrimitive<>(this, node.getChild(childIndex), offset);
            }
    ...
    @SuppressWarnings("serial")
    private static class CollectorTask<P_IN, P_OUT, T_NODE extends java.util.stream.Node<P_OUT>, T_BUILDER extends java.util.stream.Node.Builder<P_OUT>>
        ...
        private static final class OfInt<P_IN>
                extends CollectorTask<P_IN, Integer, java.util.stream.Node.OfInt, java.util.stream.Node.Builder.OfInt> {
        ...
        private static final class OfLong<P_IN>
                extends CollectorTask<P_IN, Long, java.util.stream.Node.OfLong, java.util.stream.Node.Builder.OfLong> {
        ...
        private static final class OfDouble<P_IN>
                extends CollectorTask<P_IN, Double, java.util.stream.Node.OfDouble, java.util.stream.Node.Builder.OfDouble> {
