...
///////////////
    ...
    public GregorianCalendar(java.util.TimeZone zone) {
        this(zone, java.util.Locale.getDefault(java.util.Locale.Category.FORMAT));
    }
     ...
     */
    GregorianCalendar(java.util.TimeZone zone, Locale locale, boolean flag) {
        super(zone, locale);
        gdate = (BaseCalendar.Date) gcal.newCalendarDate(getZone());
    }
...
/////////////////
    ...
    private void setGregorianChange(long cutoverTime) {
        ...
        d = (BaseCalendar.Date) julianCal.newCalendarDate(java.util.TimeZone.NO_TIMEZONE);
...
/////////////////////////////
     ...
     * which has {@code MONDAY} as the {@link java.util.Calendar#getFirstDayOfWeek()
