 ...
 * {@link java.util.GregorianCalendar}, the Julian to Gregorian transition is not
...
class JapaneseImperialCalendar extends java.util.Calendar {
    ...
    static {
        ...
        for (Era e : es) {
            if(e.getSince(java.util.TimeZone.NO_TIMEZONE) < System.currentTimeMillis()) {
                current = index;
            }
     ...
     */
    JapaneseImperialCalendar(java.util.TimeZone zone, java.util.Locale aLocale) {
        super(zone, aLocale);
     ...
     */
    JapaneseImperialCalendar(java.util.TimeZone zone, java.util.Locale aLocale, boolean flag) {
        super(zone, aLocale);
        jdate = jcal.newCalendarDate(zone);
    }
     ...
     * {@link java.util.Calendar#get(int) get} method for any possible time value,
     ...
     *
     * @see java.util.GregorianCalendar#isLeapYear(int)
     */
    ...
    private int monthLength(int month) {
        ...
        return jdate.isLeapYear() ?
            java.util.GregorianCalendar.LEAP_MONTH_LENGTH[month] : GregorianCalendar.MONTH_LENGTH[month];
    }
