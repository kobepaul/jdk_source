...
class DeflaterOutputStream extends FilterOutputStream {
     ...
     */
    public DeflaterOutputStream(OutputStream out, java.util.zip.Deflater def, int size) {
     ...
     * @param def the compressor ("deflater")
     */
    public DeflaterOutputStream(OutputStream out, java.util.zip.Deflater def) {
    ...
    public DeflaterOutputStream(OutputStream out, boolean syncFlush) {
        this(out, new java.util.zip.Deflater(), 512, syncFlush);
     ...
     *
     * If {@link #DeflaterOutputStream(OutputStream, java.util.zip.Deflater, int, boolean)
     ...
     * with the flush mode {@link java.util.zip.Deflater#SYNC_FLUSH} to force
