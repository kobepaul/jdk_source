 ...
 */
public
class ZipInputStream extends InflaterInputStream implements java.util.zip.ZipConstants {
    ...
    private static final int STORED = java.util.zip.ZipEntry.STORED;
    private static final int DEFLATED = java.util.zip.ZipEntry.DEFLATED;
     ...
     */
    private java.util.zip.ZipEntry readLOC() throws IOException {
        try {
        ...
        java.util.zip.ZipEntry e = createZipEntry(((flag & USE_UTF8) != 0)
