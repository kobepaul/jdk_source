 ...
 */
public
class ZipOutputStream extends DeflaterOutputStream implements java.util.zip.ZipConstants {
    ...
    private static int version(java.util.zip.ZipEntry e) throws java.util.zip.ZipException {
        ...
        default: throw new java.util.zip.ZipException("unsupported compression method");
        }
    }
    ...
    public ZipOutputStream(OutputStream out, Charset charset) {
        super(out, new java.util.zip.Deflater(Deflater.DEFAULT_COMPRESSION, true));
        if (charset == null)
    ...
    public void closeEntry() throws IOException {
        ensureOpen();
        if (current != null) {
            java.util.zip.ZipEntry e = current.entry;
            switch (e.method) {
            case DEFLATED:
                def.finish();
                while (!def.finished()) {
        ...
        throws IOException
    {
        ...
        java.util.zip.ZipEntry entry = current.entry;
        switch (entry.method) {
        case DEFLATED:
    ...
    private void writeLOC(XEntry xentry) throws IOException {
        java.util.zip.ZipEntry e = xentry.entry;
        int flag = e.flag;
     ...
     */
    private void writeEXT(java.util.zip.ZipEntry e) throws IOException {
