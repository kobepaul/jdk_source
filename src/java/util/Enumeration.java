 ...
 *
 * @apiNote
 * The functionality of this interface is duplicated by the {@link java.util.Iterator}
...
public interface Enumeration<E> {
    ...
    /**
     * Returns an {@link java.util.Iterator} that traverses the remaining elements
     ...
     * {@link java.util.Iterator#hasNext hasNext} method calls this Enumeration's
     * {@code hasMoreElements} method, whose {@link java.util.Iterator#next next}
     * method calls this Enumeration's {@code nextElement} method, and
     * whose {@link java.util.Iterator#remove remove} method throws
