...
public class PriorityQueue<E> extends AbstractQueue<E>
    ...
    private void initElementsFromCollection(java.util.Collection<? extends E> c) {
        ...
        if (es.getClass() != Object[].class)
            es = java.util.Arrays.copyOf(es, len, Object[].class);
    ...
    public E poll() {
        ...
        if ((result = (E) ((es = queue)[0])) != null) {
            ...
            es[n] = null;
            if (n > 0) {
                final java.util.Comparator<? super E> cmp;
    ...
    private static <T> void siftUpUsingComparator(
        int k, T x, Object[] es, java.util.Comparator<? super T> cmp) {
        while (k > 0) {
            int parent = (k - 1) >>> 1;
            Object e = es[parent];
    ...
    private static <T> void siftDownUsingComparator(
        int k, T x, Object[] es, int n, java.util.Comparator<? super T> cmp) {
        // assert n > 0;
        int half = n >>> 1;
        while (k < half) {
            int child = (k << 1) + 1;
     ...
     * (the {@link java.util.Spliterator#ORDERED ORDERED} characteristic is not reported).
     *
    ...
    final class PriorityQueueSpliterator implements java.util.Spliterator<E> {
