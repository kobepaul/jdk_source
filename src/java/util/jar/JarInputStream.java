...
class JarInputStream extends ZipInputStream {
    ...
    public JarInputStream(InputStream in, boolean verify) throws IOException {
        ...
        java.util.jar.JarEntry e = (java.util.jar.JarEntry)super.getNextEntry();
        if (e != null && e.getName().equalsIgnoreCase("META-INF/"))
            e = (java.util.jar.JarEntry)super.getNextEntry();
        first = checkManifest(e);
    }

    private java.util.jar.JarEntry checkManifest(java.util.jar.JarEntry e)
        throws IOException
    {
        if (e != null && JarFile.MANIFEST_NAME.equalsIgnoreCase(e.getName())) {
            man = new java.util.jar.Manifest();
            byte bytes[] = getBytes(new BufferedInputStream(this));
            man.read(new ByteArrayInputStream(bytes));
            closeEntry();
            if (doVerify) {
                jv = new java.util.jar.JarVerifier(bytes);
                mev = new ManifestEntryVerifier(man);
            }
            return (java.util.jar.JarEntry)super.getNextEntry();
        }
        return e;
    }
     ...
     *         are incorrectly signed.
     */
    public java.util.jar.JarEntry getNextJarEntry() throws IOException {
        return (java.util.jar.JarEntry)getNextEntry();
    }
    ...
    protected ZipEntry createZipEntry(String name) {
        java.util.jar.JarEntry e = new JarEntry(name);
        if (man != null) {
