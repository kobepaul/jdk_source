...
class JarVerifier {
     ...
     */
    public Enumeration<java.util.jar.JarEntry> entries2(final java.util.jar.JarFile jar, Enumeration<java.util.jar.JarEntry> e) {
        final Map<String, CodeSigner[]> map = new HashMap<>();
        map.putAll(signerMap());
        final Enumeration<java.util.jar.JarEntry> enum_ = e;
        return new Enumeration<>() {
            ...
            public boolean hasMoreElements() {
                ...
                while (enum_.hasMoreElements()) {
                    java.util.jar.JarEntry je = enum_.nextElement();
