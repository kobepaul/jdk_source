...
public interface Spliterator<T> {
    ...
    /**
     * If this Spliterator's source is {@link #SORTED} by a {@link java.util.Comparator},
     ...
     *
     * <p>A {@link java.util.Collection} has an encounter order if the corresponding
     ...
     * such as {@link java.util.HashSet}. Clients of a Spliterator that reports
        ...
        default boolean tryAdvance(Consumer<? super Integer> action) {
            if (action instanceof IntConsumer) {
                ...
                if (java.util.Tripwire.ENABLED)
                    java.util.Tripwire.trip(getClass(),
