...
public abstract class TimeZone implements Serializable, Cloneable {
     ...
     *                Locale.getDefault({@link java.util.Locale.Category#DISPLAY}))
     * </pre></blockquote>
     *
     * @return the human-readable name of this time zone in the default locale.
     * @since 1.2
     * @see #getDisplayName(boolean, int, java.util.Locale)
     ...
     * ResourceBundle.Control#getCandidateLocales(String, java.util.Locale) default
     * <code>Locale</code> search path of <code>ResourceBundle</code>} derived
     * from the specified {@code locale} is used. (No {@linkplain
     * ResourceBundle.Control#getFallbackLocale(String, java.util.Locale) fallback
     * <code>Locale</code>} search is performed.) If a time zone name in any
     * {@code Locale} of the search path, including {@link java.util.Locale#ROOT}, is
